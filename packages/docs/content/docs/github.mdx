...
Connect your GitHub account and Pichamber can pull in issues and pull requests, start a session straight from one, and open or update PRs for you.

## Connect GitHub

1. Open **Settings → Git**.
2. Under GitHub, choose **Connect**. Pichamber shows a link and a short code.
3. Open the link, enter the code, and approve. GitHub names the Pichamber OAuth app on that page.
