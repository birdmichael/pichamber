...
Verbinde dein GitHub-Konto und Pichamber kann Issues und Pull Requests einlesen, direkt daraus eine Sitzung starten und PRs für dich öffnen oder aktualisieren.

## GitHub verbinden

1. Öffne **Einstellungen → Git**.
2. Wähle unter GitHub **Connect**. Pichamber zeigt einen Link und einen kurzen Code an.
