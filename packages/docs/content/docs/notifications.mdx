...
- on **iPhone**, a waiting question still notifies even if Desktop is open. Confirm prompts can be answered from the lock-screen notification. Tapping a question notification opens that chat on the waiting card.

Sessions set to auto-accept won't nag you with permission notifications. Walking away from a locked Mac still delivers waiting-question notifications to the phone.
