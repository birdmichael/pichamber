...
1. Abra **Settings → Remote Instances** e escolha **Add SSH connection**.
2. Escolha um host em **From SSH config**, ou mude para **Type it myself** e digite o comando SSH mais um apelido.
