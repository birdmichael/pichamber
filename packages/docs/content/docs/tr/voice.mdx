---
title: Ses Modu
description: Pichamber ile konuşun ve yanıtları sesli dinleyin.
---

# Ses Modu

Ses modu, mesajları dikte etmenizi ve yanıtları size geri okutmanızı sağlar. Bunu **Settings → Pichamber → Voice** bölümünden açın.
