...
GitHub hesabınızı bağlayın. Pichamber issue'ları ve pull request'leri içeri çekebilir, birinden doğrudan oturum başlatabilir ve sizin yerinize PR açıp güncelleyebilir.

## GitHub'ı bağlayın

1. **Settings → Git** bölümünü açın.
2. GitHub altında **Connect** seçin. Pichamber bir bağlantı ve kısa bir kod gösterir.
...
- bir **issue** seçin. Pichamber branch'i onun adına göre adlandırır ve oturumu, issue ve yorumları ilk mesaj olarak açar
...
[git view](/git/) içindeki **PR** sekmesinden pull request oluşturabilir, güncelleyebilir, taslağı hazır diye işaretleyebilir ya da merge edebilirsiniz. Pichamber PR başlığını ve açıklamasını değişikliklerinizden oluşturabilir.
