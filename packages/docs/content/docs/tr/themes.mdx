---
title: Temalar
description: Pichamber'ı yerleşik ve kullanıcı tanımlı temalarla özelleştirin.
---

# Temalar

Pichamber yerleşik temaları ve özel tema JSON dosyalarını destekler.
...
3. Pichamber'ı açın, sonra **Settings -> Theme -> Reload themes** yoluna gidin.
