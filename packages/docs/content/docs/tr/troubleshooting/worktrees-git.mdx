...
Pichamber, bir şey yolunda olmadığında worktree'yi işaretler:

- **folder missing** — worktree'nin klasörü Pichamber dışında silinmiş ya da taşınmış. Oturumu kaldırın ve yeni bir worktree oluşturun
...
- Windows'ta git Unix tarzı yollar kullanır. Örneğin `/c/Users/...`. Pichamber bunu ele alır, ama özel SSH anahtarı yolları da aynı biçimi izlemelidir
