...
description: Pichamber'dan çıkmadan branch'leri hazırlayın, commit edin ve yönetin.
---

# Git ve GitHub İş Akışları

Pichamber'da yerleşik bir git görünümü vardır. Böylece terminale geçmeden değişiklikleri gözden geçirebilir, commit edebilir ve branch'leri yönetebilirsiniz. Sağ kenar çubuğundaki **Git** sekmesinden açın.
...
Sonra bir commit mesajı yazıp commit edin. Pichamber'a staged değişikliklerinizden bir commit mesajı **generate** ettirebilirsiniz. Mevcut oturumun modelini kullanır, bu yüzden açık bir oturum gerekir.
...
Bir merge, rebase ya da integrate çakışmaya takılırsa, Pichamber neyin sıkıştığını gösterir ve bunu çözmenize izin verir. Bunu agent'a devretmek de dahil.
