...
Walkthrough'lar varsayılan olarak arayüz dilinizde yazılır. Panel başlığındaki dil seçici buradan başlar. Pichamber'ın çevrildiği başka bir dili tek bir inceleme için seçebilirsiniz. Rehberli açıklama, rahat okuduğunuz bir dildeyse faydalıdır.
...
Üretim tarayıcı sekmenizde değil, Pichamber sunucusunda çalışır. Sayfayı yenileyin ya da paneli kapatın, işlem sürer. Geri döndüğünüzde sonuç hazırdır. Onu durduran tek şey **Cancel** düğmesidir.
