...
description: Pichamber'ı hızlıca başlatın ve iş için doğru uygulamayı seçin.
---
...
2. Pichamber CLI'yı yükleyin. Tek satırlık komut için [Install](/install/) sayfasına bakın.
...
Tarayıcınızda Pichamber oturum listesini görmelisiniz. Yüklendiyse çalışıyordur.
