...
2. Bir sunucu ekleyin ve türünü seçin:
   - **local** — Pichamber makinenizde bir komut çalıştırır. Çalıştırılacak komutu ve gerekirse ortam değişkenlerini siz verirsiniz.
   - **remote** — Pichamber başkası tarafından barındırılan bir URL'ye bağlanır. URL'yi ve ihtiyaç duyduğu başlıkları verirsiniz, örneğin bir kimlik doğrulama belirteci.
