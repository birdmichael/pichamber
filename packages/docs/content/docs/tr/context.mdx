...
Her model bir konuşmanın ancak belirli bir kısmını aynı anda tutabilir. Buna context denir. Pichamber bunun ne kadar dolduğunu gösterir. Böylece bir oturum sınırına yaklaşırken bunu fark eder ve yanıtta eski ayrıntıların düşmeye başlayabileceğini anlarsınız.
