...
**Clear cookies** ve **Clear cached data** yalnızca bu panele uygulanır. Pichamber oturumunuza ve diğer pencerelere dokunulmaz.
...
Tarayıcı eylemleri **Pichamber Web tool**'dur. Bunu **Settings → General → Pichamber Tools** altında ayrı ayrı açıp kapatabilirsiniz.
