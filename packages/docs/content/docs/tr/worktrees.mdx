...
3. Worktree klasörünü onaylayın. Pichamber klasör adını branch isminden önerir.
4. Oluşturun.

Pichamber branch'i oluşturur, klasörü hazırlar ve içinde bir oturum başlatır. Bunu bir [todo](/notes-todos-plans/) ya da [GitHub issue veya PR](/github/) üzerinden de başlatabilirsiniz.
...
Klasörü kaybolduysa, branch'i detached durumdaysa ya da bir merge veya rebase yarım kaldıysa worktree'nin bakıma ihtiyacı olabilir. Pichamber bunları işaretler, böylece düzeltebilirsiniz. Bkz. [Worktrees & Git](/troubleshooting/worktrees-git/).

## İlgili

- [Multi-run](/multi-run/) — birçok worktree oturumunu aynı anda başlatın
- [Git & GitHub Workflows](/git/) — Pichamber içinden commit edin ve integrate edin
