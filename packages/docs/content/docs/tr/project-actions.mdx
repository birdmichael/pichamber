...
Eylemler uygulama başlığındaki bir menüde görünür. Birine tıklayın ve Pichamber onu proje klasörünüzde bir terminalde çalıştırsın. Çıkışı izleyebilmeniz için sizi terminal görünümüne geçirir. Aynı menüden durdurabilirsiniz.

## Bir geliştirme sunucusunu otomatik açın

Sunucu başlatan bir eylem için **auto-open URL** seçeneğini açın. Pichamber çıktıda yerel bir adres arar ve açmayı önerir. Ayrıntılar için [Preview & Dev Servers](/preview/) sayfasına bakın. Masaüstünde bunu bir SSH port yönlendirmesi üzerinden de geçirebilirsiniz.

## İlgili

- [Preview & Dev Servers](/preview/) — çalışan bir geliştirme sunucusunu Pichamber içinde açın
