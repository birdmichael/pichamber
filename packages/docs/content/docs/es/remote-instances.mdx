...
1. Abre **Settings → Remote Instances** y elige **Add SSH connection**.
2. Elige un host en **From SSH config**, o pasa a **Type it myself** y escribe el comando SSH más un apodo.
