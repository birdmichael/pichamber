...
1. Otwórz **Settings → Remote Instances** i wybierz **Add SSH connection**.
2. Wybierz host z **From SSH config** albo przełącz na **Type it myself** i wpisz polecenie SSH oraz przydomek.
