...
- potwierdź, że serwer działa, za pomocą `pichamber status`
...
- przy parowaniu **Wszędzie** sprawdź **Settings → Remote Instances → Pichamber Relay** na serwerze: status powinien brzmieć **Połączono**; jeśli nie, wyłącz i włącz relay ponownie
