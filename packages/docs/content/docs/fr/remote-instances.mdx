...
1. Ouvrez **Paramètres → Instances distantes** et choisissez **Add SSH connection**.
2. Choisissez un hôte dans **From SSH config**, ou passez à **Type it myself** et saisissez la commande SSH plus un surnom.
