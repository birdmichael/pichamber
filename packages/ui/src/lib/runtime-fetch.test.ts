  ...
  test('rewrites current-origin absolute API URLs only', () => {
    ...
    try {
      ...
      Object.defineProperty(globalThis, 'window', {
        configurable: true,
        value: { location: { origin: 'pichamber-ui://app', href: 'pichamber-ui://app/index.html' } },
      });

      expect(buildRuntimeFetchUrl('pichamber-ui://app/api/config/settings')).toBe('https://api.example/api/config/settings');
