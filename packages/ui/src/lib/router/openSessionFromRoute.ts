...
/**
 * Select a session named by `/?session=` in the current window only.
 *
 * Extra Desktop windows keep their own session UI store (#431); this helper
 * never writes another window's selection. Cold loads often do not know the
