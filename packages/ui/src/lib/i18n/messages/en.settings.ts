...
export const settingsDict = {
  'settings.providers.page.openCodeGo.title': 'Usage tracking',
  'settings.providers.page.openCodeGo.description': 'Connect this leftover quota dashboard to show rolling, weekly, and monthly quota.',
  ...
  'settings.providers.page.openCodeGo.saveFailed': 'Could not validate usage-tracking credentials.',
  'settings.providers.page.openCodeGo.valid': 'Usage-tracking credentials are valid.',
  'settings.providers.page.openCodeGo.invalid': 'Usage-tracking credentials are invalid or expired.',
  'settings.providers.page.openCodeGo.deleted': 'Usage-tracking credentials deleted.',
  'settings.providers.page.openCodeGo.deleteFailed': 'Could not delete usage-tracking credentials.',
  ...
  'settings.view.home.cards.plugins.description': 'Manage plugins',
  ...
  'settings.view.pendingRestart.manualRestartRequired': 'Saved on disk. Restart Pi to apply the changes.',
  ...
  'settings.page.extensions.description': 'Review installed Pi extensions and packages.',
  ...
  'settings.extensions.page.extensions.empty': 'Extensions appear here after you install them with `pi install`.',
  ...
  'settings.extensions.page.packages.currentVersion': 'Current version {version}',
  'settings.extensions.page.packages.actions.update': 'Update',
  'settings.extensions.page.packages.actions.updateAria': 'Update {name}',
  'settings.extensions.page.packages.actions.updateToVersion': 'Update to {version}',
  'settings.extensions.page.packages.actions.updateAll': 'Update all',
  'settings.extensions.page.packages.actions.updateAllAria': 'Update all packages',
  'settings.extensions.page.packages.actions.updating': 'Updating…',
  'settings.extensions.page.packages.toast.updateSuccess': 'Updated {name}.',
  'settings.extensions.page.packages.toast.updateAllSuccess': 'Updated {count} packages.',
  'settings.extensions.page.packages.toast.updateAllSuccessOne': 'Updated 1 package.',
  'settings.extensions.page.packages.toast.updateFailed': 'Could not update {name}.',
  'settings.extensions.page.packages.toast.updateAllFailed': 'Could not update packages.',
  'settings.extensions.page.packages.toast.updateBusy': 'An update is already running.',
  'settings.extensions.page.packages.actions.uninstall': 'Uninstall',
  'settings.extensions.page.packages.actions.uninstallAria': 'Uninstall {name}',
  'settings.extensions.page.packages.actions.uninstalling': 'Uninstalling…',
  'settings.extensions.page.packages.dialog.uninstall.title': 'Uninstall {name}?',
  'settings.extensions.page.packages.dialog.uninstall.description': 'This removes {name} from Pi packages.',
  'settings.extensions.page.packages.toast.uninstallSuccess': 'Uninstalled {name}.',
  'settings.extensions.page.packages.toast.uninstallFailed': 'Could not uninstall {name}.',
  'settings.extensions.page.packages.toast.uninstallBusy': 'An uninstall is already running.',
  'settings.extensions.page.loading': 'Loading...',
  'settings.page.featurePlugins.title': 'Feature Plugins',
  'settings.featurePlugins.page.warning': 'Installing a package is an explicit action. Installed packages run with full system permissions.',
  'settings.featurePlugins.page.loading': 'Loading feature plugins…',
  'settings.featurePlugins.page.loadFailed': 'Could not load feature plugins. Existing settings were left unchanged.',
  'settings.featurePlugins.slot.goal.title': 'Goal',
  'settings.featurePlugins.slot.goal.info': 'Installs the Goal package. After install, the composer shows a Goal button. This page never auto-installs.',
  'settings.featurePlugins.slot.plan.title': 'Plan',
  'settings.featurePlugins.slot.plan.info': 'Installs the Plan package. After install, Agent/Plan, View Plan, and Build become available. This page does not start /plan.',
  ...
  'settings.featurePlugins.slot.xai.title': 'Grok Usage',
  'settings.featurePlugins.slot.xai.info': 'Installs pi-xai. Providers gain xAI, and Work Status shows Grok usage.',
  'settings.featurePlugins.slot.xai.infoHint': 'Does not install pi-xai-oauth, which conflicts with pi-xai. Does not change the default model.',
  'settings.featurePlugins.slot.kimi.title': 'Kimi Usage',
  ...
  'settings.featurePlugins.slot.kimi.info': 'Sign-in stays on Providers. After install, Work Status and Providers show Kimi Code weekly quota and 5-hour window.',
  'settings.featurePlugins.slot.kimi.infoHint': 'This page never auto-installs and does not change the default model.',
  ...
  'settings.featurePlugins.slot.kimi.region.empty': 'Connect a Kimi account in Providers to set International or China per row.',
  'settings.featurePlugins.slot.kimi.region.rowLabel': 'Region · {name}',
  'settings.featurePlugins.slot.kimi.region.ariaNamed': 'Kimi region for {name}',
  'settings.featurePlugins.impact.aria': 'Chrome that appears after install',
  'settings.featurePlugins.surface.composer': 'Composer',
  'settings.featurePlugins.surface.commands': 'Commands',
  'settings.featurePlugins.surface.workStatus': 'Work Status',
  'settings.featurePlugins.surface.sidebar': 'Sidebar',
  'settings.featurePlugins.surface.settings': 'Settings',
  'settings.featurePlugins.surface.session': 'Session',
  'settings.featurePlugins.slot.goal.surface.composer.tooltip': 'Composer Goal button',
  ...
  'settings.featurePlugins.slot.plan.surface.session.tooltip': 'Plan question cards',
  'settings.featurePlugins.slot.mcp.surface.workStatus.tooltip': 'Work Status MCP section',
  'settings.featurePlugins.slot.mcp.surface.settings.tooltip': 'Settings → MCP',
  'settings.featurePlugins.slot.subagents.surface.workStatus.tooltip': 'Work Status Subagents section',
  'settings.featurePlugins.slot.subagents.surface.commands.tooltip': '/run',
  'settings.featurePlugins.slot.subagents.surface.session.tooltip': 'subagent transcript cards; opening a writable child session from Work Status',
  'settings.featurePlugins.slot.btw.surface.commands.tooltip': '/btw',
  'settings.featurePlugins.slot.btw.surface.session.tooltip': 'Temporary side-ask / fork panel',
  'settings.featurePlugins.slot.todo.surface.workStatus.tooltip': 'Work Status Tasks section',
  'settings.featurePlugins.slot.xai.surface.workStatus.tooltip': 'Work Status Usage section',
  'settings.featurePlugins.slot.xai.surface.settings.tooltip': 'Providers xAI allowance',
  'settings.featurePlugins.slot.xai.surface.commands.tooltip': '/xai-usage',
  'settings.featurePlugins.slot.kimi.surface.workStatus.tooltip': 'Work Status Usage',
  'settings.featurePlugins.slot.zai.surface.workStatus.tooltip': 'Work Status Z.AI usage',
  'settings.featurePlugins.slot.zai.surface.settings.tooltip': 'Providers Z.AI allowance',
  'settings.featurePlugins.slot.zai.surface.commands.tooltip': '/zai-usage',
  'settings.featurePlugins.slot.kimi.surface.settings.tooltip': 'Providers Kimi Code allowance',
  ...
  'settings.featurePlugins.actions.uninstall': 'Uninstall',
  'settings.featurePlugins.actions.installing': 'Installing…',
  'settings.featurePlugins.actions.uninstalling': 'Uninstalling…',
  'settings.featurePlugins.dialog.install.title': 'Install this package?',
  'settings.featurePlugins.dialog.install.description': 'This installs a Pi package with full system permissions. Nothing is installed until you confirm.',
  'settings.featurePlugins.dialog.uninstall.title': 'Uninstall this package?',
  'settings.featurePlugins.dialog.uninstall.description': 'This removes the package from Pi packages. Desktop chrome for this slot turns off.',
  'settings.featurePlugins.toast.installFailed': 'Could not install the package.',
  'settings.featurePlugins.toast.uninstallFailed': 'Could not uninstall the package.',
  'settings.featurePlugins.toast.reloadPartial': 'The package changed, but a busy session was not reloaded.',
  ...
  'settings.page.skillsCatalog.description': 'Browse catalogs and install skills.',
  'settings.page.git.title': 'Git',
  'settings.page.git.description': 'Manage GitHub access and commit identities.',
  ...
  'settings.page.snippets.description': 'Create reusable snippets for prompts.',
  ...
  'settings.snippets.page.empty.descriptionCreate': 'Create a snippet in the sidebar to get started.',
  ...
  'settings.snippets.page.hint': 'Use #name in prompts. Supports aliases and prepend/append blocks compatible with Pi snippets.',
  ...
  'settings.openchamber.tunnel.tooltip.tokensSavedPath': 'Tokens are saved in ~/.config/pichamber/cloudflare-managed-remote-tunnels.json.',
  ...
  'settings.remoteInstances.clientAuth.addDevice.transport.lanUnavailable': 'Unavailable — this host has no LAN address Pichamber can advertise.',
  'settings.remoteInstances.clientAuth.addDevice.transport.relayUnavailable': 'Unavailable — Private Relay is not enabled on this host.',
  'settings.remoteInstances.clientAuth.addDevice.transport.localUnavailable': 'Unavailable — this host has no local address to advertise.',
  ...
  'settings.agents.page.empty.title.pi': 'Select the Pi agent from the sidebar',
  'settings.agents.page.empty.description.pi': 'Pi includes one built-in agent.',
  ...
  'settings.agents.page.subtitle.piNative': 'Native Pi agent. Extra agents are not supported.',
  ...
  'settings.gitIdentities.editor.field.tokenPlaceholder': 'Personal access token or password',
  'settings.gitIdentities.editor.field.tokenTooltip': 'Used with this host for HTTPS authentication. Stored with the identity on this device.',
  ...
  'settings.skills.sidebar.untrustedHint': 'Untrusted skills stay listed here and are not injected into Pi sessions.',
  ...
  'settings.skills.location.option.userPi.label': 'User / Pi',
  'settings.skills.location.option.userPi.description': 'Global ~/.pi/agent/skills location',
  'settings.skills.location.option.projectPi.label': 'Project / Pi',
  'settings.skills.location.option.projectPi.description': 'Current project .pi/skills location',
  ...
  'settings.skills.catalog.installSkill.descriptionSuffix': 'into one of {count} target locations.',
  ...
  'settings.skills.catalog.page.foundCountLoading': 'Loading…',
  ...
  'settings.openchamber.sessionRetention.manualCleanup.info': 'Runs once with the current retention and expire settings. Auto-cleanup does not have to be on.',
  ...
  'settings.openchamber.piAgent.field.directory': 'Pi agent directory',
  'settings.openchamber.piAgent.field.directoryAria': 'Pi agent directory',
  'settings.openchamber.piAgent.field.directoryPlaceholder': '~/.pi/agent',
  'settings.openchamber.piAgent.field.directoryInfo': 'Leave empty to use PI_CODING_AGENT_DIR if set, otherwise ~/.pi/agent. Pichamber stores this override in ~/.config/pichamber/settings.json, not inside the agent directory.',
  'settings.openchamber.piAgent.field.directoryInfoWithPath': 'Leave empty to use PI_CODING_AGENT_DIR if set, otherwise ~/.pi/agent. The live path is {path}. Pichamber stores this override in ~/.config/pichamber/settings.json, not inside the agent directory.',
  'settings.openchamber.piAgent.field.showUpdateNotifications': 'Show Pi update notifications',
  'settings.openchamber.piAgent.field.showUpdateNotificationsAria': 'Show Pi update notifications',
  'settings.openchamber.piAgent.field.showUpdateNotificationsInfo': 'When a newer in-process @earendil-works/pi-coding-agent is available, show an informational notice. This is not the Pichamber app updater on About.',
  'settings.openchamber.piAgent.dialog.selectDirectory': 'Select Pi agent directory',
  'settings.openchamber.piAgent.actions.browse': 'Browse',
  'settings.openchamber.piAgent.actions.browseAria': 'Browse for a Pi agent directory',
  'settings.openchamber.piAgent.actions.reloading': 'Reloading Pi…',
  'settings.openchamber.piAgent.error.loadFailed': 'Could not load the Pi agent directory setting.',
  'settings.openchamber.piAgent.toast.saveFailed': 'Could not save the Pi agent directory.',
  'settings.openchamber.piAgent.toast.reloadFailed': 'Saved, but Pi could not reload.',
  ...
  'settings.openchamber.piAgent.field.updateAvailableHint': 'Can upgrade to the latest version',
  ...
  'settings.openchamber.piAgent.actions.updating': 'Updating…',
  'settings.openchamber.piAgent.toast.updateSuccess': 'Pi updated to {version}.',
  'settings.openchamber.piAgent.toast.updateSuccessNoVersion': 'Pi updated.',
  'settings.openchamber.piAgent.toast.updateFailed': 'Could not update Pi.',
  'settings.openchamber.piAgent.toast.updateBusy': 'An update is already running.',
  ...
  'settings.openchamber.tools.field.agentControlToolInfo': 'Let agents orchestrate your work from chat: spin up sessions and worktrees, delegate prompts to other agents, and manage scheduled tasks. Off by default — enabling adds a large tool schema to every turn (~2k+ input tokens). Applies after Pi reloads.',
  ...
  'settings.openchamber.tools.field.agentWebToolInfo': 'Let agents look at and interact with the page in Pichamber\'s browser panel: open a URL, read the page, click, type, scroll, and switch between mobile and desktop layouts. Off by default — enabling adds a large tool schema to every turn (~1k+ input tokens). Applies after Pi reloads.',
  ...
  'settings.openchamber.opencodeCli.actions.restartingOpenCode': 'Reloading Pi…',
  'settings.openchamber.opencodeCli.toast.savedReloaded': 'Saved. Pi reloaded.',
  'settings.openchamber.opencodeCli.dialog.selectBinaryTitle': 'Select pi binary',
  'settings.openchamber.opencodeCli.tipPrefix': 'Leave empty to use pi on PATH (default ~/.local/bin/pi). You can also set',
  ...
  'settings.plugins.toast.reloadFailed': 'Pi reload failed — restart required',
  ...
  'settings.projects.page.section.trust': 'Project trust',
  'settings.projects.page.field.trustThisProject': 'Trust this project',
  'settings.projects.page.field.trustThisProjectAria': 'Trust this project',
  'settings.projects.page.field.trustThisProjectInfo': 'Trusting a folder lets Pi load .pi/settings.json, project extensions, and project packages.',
  'settings.projects.page.field.defaultProjectTrust': 'Default project trust',
  'settings.projects.page.field.defaultProjectTrustAria': 'Default project trust',
  'settings.projects.page.field.defaultProjectTrustInfo': 'Used when a project has no saved decision. Ask prompts, Always trusts new projects, Never blocks project-local Pi resources.',
  'settings.projects.page.option.trustAsk': 'Ask',
  'settings.projects.page.option.trustAlways': 'Always',
  'settings.projects.page.option.trustNever': 'Never',
  'settings.projects.shared.title': 'Repository config',
  'settings.projects.shared.description': 'Setup stored in the repository itself (`.pichamber/project.json`), so everyone who pulls it gets the same actions, setup commands, starters, and plans folder. Nothing is written there until you move an item into it or set a plans folder.',
  ...
  'settings.projects.shared.plansDirInfo': 'Where repository plans live, relative to the repository. Empty means .pichamber/plans. A custom folder such as docs/plans replaces the default entirely: only that folder is read and written. Move existing files yourself when you change it.',
  ...
  'settings.remoteInstances.page.section.connections': 'SSH connections',
  'settings.remoteInstances.page.empty.selectInstance': 'Select an instance to view and edit its settings.',
  'settings.remoteInstances.page.empty.noConnections': 'No SSH connections yet.',
  ...
  'settings.remoteInstances.page.error.hint.noKernel': 'Pichamber is not installed on the remote machine. Install it there, then connect again.',
  ...
  'settings.providers.sidebar.empty.description': 'Check {path}/models.json and auth.json',
  ...
  'settings.providers.page.empty.checkOpenCodeConfiguration': 'Check {path}/models.json and auth.json',
  ...
  'settings.providers.page.connect.emptyCatalog': 'No catalog providers are available. You can still add a custom provider.',
  'settings.providers.page.connect.allCatalogConnected': 'Every catalog provider is already connected. Use Other / Custom to add another.',
  ...
  'settings.providers.page.custom.description': 'Add a provider with a base URL, credentials, model list, and supported API protocol. Saved so it works in chat like any other provider.',
  ...
  'settings.providers.page.custom.field.providerID.info': 'Lowercase letters, numbers, hyphens, and underscores. Used as the provider id.',
  ...
  'settings.providers.page.custom.field.apiKey.info': 'Stored in Pi auth (~/.pi/agent), not by Pichamber. Use {env:VAR_NAME} to read a key from the environment instead.',
  ...
  'settings.providers.page.custom.models.fetch': 'Fetch models',
  'settings.providers.page.custom.models.fetching': 'Fetching models…',
  'settings.providers.page.custom.models.fetchCancel': 'Cancel fetch',
  'settings.providers.page.custom.models.fetchInfo': 'Calls the provider’s OpenAI-compatible /models endpoint with this base URL and API key, then opens a list. Add only the models you want; you can still type IDs by hand.',
  'settings.providers.page.custom.models.picker.title': 'Remote models',
  'settings.providers.page.custom.models.picker.region': 'Remote model list',
  'settings.providers.page.custom.models.picker.description': '{count} models from this endpoint. Add only the ones you want.',
  'settings.providers.page.custom.models.picker.family.label': 'Filter by family',
  'settings.providers.page.custom.models.picker.family.all': 'All',
  ...
  'settings.providers.page.custom.models.picker.family.other': 'Other',
  ...
  'settings.providers.page.custom.models.picker.family.otherCount': 'Other ({count})',
  'settings.providers.page.custom.models.picker.search': 'Filter models…',
  'settings.providers.page.custom.models.picker.empty': 'No models match this filter.',
  'settings.providers.page.custom.models.picker.familyEmpty': 'This family has no models on this endpoint.',
  'settings.providers.page.custom.models.picker.aliases': '{count} aliases',
  'settings.providers.page.custom.models.picker.descriptionCollapsed': '{shown} unique models ({count} IDs from this endpoint). Add only the ones you want.',
  'settings.providers.page.custom.models.picker.add': 'Add',
  'settings.providers.page.custom.models.picker.added': 'Added',
  'settings.providers.page.custom.models.picker.addAria': 'Add {name}',
  'settings.providers.page.custom.models.picker.done': 'Done',
  ...
  'settings.providers.page.custom.models.visionInfo': 'Allow image input for this model. Saved as Pi input including image. Turn on for unknown ids that models.dev does not list.',
  'settings.providers.page.custom.models.reasoningLabel': 'Reasoning',
  'settings.providers.page.custom.models.reasoningInfo': 'Mark this model as supporting thinking / reasoning. Saved as Pi reasoning: true.',
  ...
  'settings.providers.page.custom.error.providerID.reserved': 'This provider ID is reserved',
  ...
  'settings.providers.page.custom.error.fetch.baseURL': 'Enter a base URL first',
  ...
  'settings.providers.page.auth.apiKeyTooltip': 'Keys are sent to Pi and never stored by Pichamber.',
  ...
  'settings.providers.page.subscription.displayName.section': 'Display name',
  'settings.providers.page.subscription.displayName.label': 'Display name',
  'settings.providers.page.subscription.displayName.info': 'Shown in the provider list and model picker. Does not change the provider id.',
  'settings.providers.page.subscription.displayName.placeholder': 'Work',
  'settings.providers.page.subscription.displayName.failed': 'Could not save display name',
  'settings.providers.page.subscription.clone.failed': 'Could not add another subscription',
  ...
  'settings.providers.page.subscription.zaiRegion.info': 'International uses api.z.ai/api/coding/paas/v4. China uses open.bigmodel.cn/api/coding/paas/v4. No URL field.',
  ...
  'settings.providers.page.subscription.zaiRegion.failed': 'Could not save Z.AI region',
  'settings.providers.page.subscription.region.failed': 'Could not save Kimi region',
  'settings.providers.page.auth.connected': 'Connected',
  'settings.providers.page.auth.oauthConnected': 'OAuth connected',
  'settings.providers.page.auth.apiKeyConnected': 'API key connected',
  'settings.providers.page.auth.oauthAndApiKeyConnected': 'OAuth and API key connected',
  'settings.providers.page.auth.dualHint': 'OAuth login and an API key can stay connected at the same time. Saving one does not replace the other.',
  ...
  'settings.providers.page.xaiUsage.title': 'Subscription usage',
  'settings.providers.page.xaiUsage.loading': 'Loading usage…',
  'settings.providers.page.xaiUsage.error': 'Could not load usage',
  'settings.providers.page.xaiUsage.notConfigured': 'Sign in with SuperGrok or X Premium to see usage',
  'settings.providers.page.xaiUsage.expires': 'Token expires {time}',
  'settings.providers.page.xaiUsage.refreshFailed': 'Refresh failed. Sign in again.',
  'settings.providers.page.kimiUsage.title': 'Subscription usage',
  ...
  'settings.providers.page.kimiUsage.loading': 'Loading usage…',
  'settings.providers.page.kimiUsage.error': 'Could not load usage',
  'settings.providers.page.kimiUsage.notConfigured': 'Sign in with Kimi Code to see usage',
  'settings.providers.page.kimiUsage.expires': 'Token expires {time}',
  'settings.providers.page.kimiUsage.refreshFailed': 'Refresh failed. Sign in with Kimi Code again for usage.',
  ...
  'settings.providers.page.actions.disconnectOAuth': 'Disconnect OAuth',
  'settings.providers.page.actions.disconnectApiKey': 'Disconnect API key',
  'settings.providers.page.actions.syncModels': 'Sync models',
  'settings.providers.page.actions.syncingModels': 'Syncing…',
  ...
  'settings.providers.page.toast.catalogLoadFailed': 'Failed to load the provider catalog',
  ...
  'settings.providers.page.custom.toast.modelsSynced': 'Synced {count} new models',
  'settings.providers.page.custom.toast.modelsFetched': 'Pulled {count} models',
  'settings.providers.page.custom.toast.modelsEmpty': 'The endpoint returned no models. Enter a model ID by hand.',
  'settings.providers.page.custom.toast.modelsNoneAddable': 'The endpoint listed only wildcard or unusable IDs. Enter a model ID by hand.',
  ...
  'settings.openchamber.defaults.summaryOpenCodeDefault': 'Pi default',
  ...
  'settings.openchamber.defaults.section.enabledModels': 'Enabled models',
  'settings.openchamber.defaults.field.enabledModelsInfo': 'When at least one model is unchecked, the composer picker only shows the remaining models. Leave all checked to keep every model available.',
  'settings.openchamber.defaults.field.enabledModelsAria': 'Enabled models',
  ...
  'settings.notifications.page.events.questionHint': 'A waiting prompt still notifies your phone even if Desktop is open or focused.',
  ...
  'settings.voice.page.field.voicesUnavailable': 'No voices available',
  ...
  'settings.voice.page.toast.previewFailed': 'Could not play a voice preview.',
  'settings.voice.page.toast.previewUnavailable': 'No voice is available to preview.',
  ...
  'settings.openchamber.visual.field.themeImportInfoTooltip': 'Import custom Pichamber themes from ~/.config/pichamber/themes/',
  ...
  'settings.openchamber.visual.field.queueMessagesByDefaultTooltip': 'When enabled, Enter queues messages and {modifier}+Enter sends. When disabled, Enter sends. In the expanded composer, Enter always adds a new line and {modifier}+Enter sends.',
  ...
  'settings.openchamber.visual.field.largeTextPasteHint': 'When pasting more than about 2,000 characters or 25 lines: attach as a .txt file (keeps the composer light), paste inline, or ask each time.',
  ...
  'settings.openchamber.visual.field.followUpBehaviorDescription': 'Choose what happens when you press Enter on a follow-up while the agent is still responding. Queue holds messages until the turn finishes; Steer interrupts. In the expanded composer, Enter always adds a new line and Ctrl/Cmd+Enter sends.',
