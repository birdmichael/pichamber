...
export const settingsDict = {
  ...
  'settings.featurePlugins.slot.goal.info': 'Installs the Goal package. Enable it to show the composer Goal button. This page never auto-installs.',
  'settings.featurePlugins.slot.plan.title': 'Plan',
  'settings.featurePlugins.slot.plan.info': 'Installs the Plan package. Enabling it is for later Agent/Plan, View Plan, and Build controls. This page does not start /plan.',
  'settings.featurePlugins.slot.mcp.title': 'MCP',
  'settings.featurePlugins.slot.mcp.info': 'Installs the MCP adapter package. Enabling it is for later Work Status MCP and Settings → MCP. This page does not start /mcp.',
  'settings.featurePlugins.slot.subagents.title': 'Subagents',
  'settings.featurePlugins.slot.subagents.info': 'Installs the Subagents package. Enabling it is for later Work Status and writable child sessions. This page does not start /subagents-fleet.',
  'settings.featurePlugins.enabled.label': 'Enabled',
  'settings.featurePlugins.enabled.info': 'Keep the package installed but hide later Desktop controls for this slot.',
  ...
  'settings.featurePlugins.dialog.uninstall.description': 'This removes the package from Pi packages. Enable/disable settings are kept.',
