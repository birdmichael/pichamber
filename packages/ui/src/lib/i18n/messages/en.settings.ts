...
export const settingsDict = {
  ...
  'settings.featurePlugins.field.command.info': 'Slash command the composer Goal button runs. Default is goal. Plan, MCP, and Subagents have no start command here.',
