...
export const settingsDict = {
  ...
  'settings.featurePlugins.slot.xai.info': 'Sign-in stays on Providers. After install, Work Status and Providers show Grok allowance and cycle.',
  'settings.featurePlugins.slot.xai.infoHint': 'This page never auto-installs and does not change the default model.',
  ...
  'settings.openchamber.tools.field.agentControlToolInfo': 'Let agents orchestrate your work from chat: spin up sessions and worktrees, delegate prompts to other agents, and manage scheduled tasks. Adds a small tool description to each session. Applies after Pi reloads.',
  ...
  'settings.openchamber.tools.field.agentWebToolInfo': 'Let agents look at and interact with the page in Pichamber\'s browser panel: open a URL, read the page, click, type, scroll, and switch between mobile and desktop layouts. Adds a small tool description to each session. Applies after Pi reloads.',
