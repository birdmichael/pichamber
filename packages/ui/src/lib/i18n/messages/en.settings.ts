...
export const settingsDict = {
  ...
  'settings.extensions.page.error.loadFailed': 'Could not load extensions.',
  'settings.extensions.page.skipped.title': 'Skipped extensions',
  'settings.extensions.page.skipped.info': 'User packages Desktop could not load, usually because a native module was built for a different Node than this app.',
  'settings.extensions.page.skipped.item': 'Skipped in {tree}.',
  'settings.extensions.page.skipped.itemWithAbi': 'Skipped in {tree} (Node ABI {abi}).',
  'settings.extensions.page.nativeTree.error': 'Desktop could not rebuild a user extension for Electron: {message}',
  ...
  'settings.openchamber.piAgent.field.showUpdateNotificationsInfo': 'When npm has a newer @earendil-works/pi-coding-agent than this Pichamber, show a notice. That is not an in-app Pi update, and it is not the Pichamber app updater on About.',
  ...
  'settings.openchamber.piAgent.field.versionInfo': 'This is the @earendil-works/pi-coding-agent bundled in Pichamber. Desktop does not run your PATH pi. A newer npm version is informational until you install a newer Pichamber.',
  'settings.openchamber.piAgent.field.bundledNotice': 'This version ships with Pichamber. Update the app to get a newer Pi kernel.',
  ...
  'settings.openchamber.piAgent.toast.updateUnsupported': 'The bundled Pi kernel cannot be updated in-app. Install a newer Pichamber.',
