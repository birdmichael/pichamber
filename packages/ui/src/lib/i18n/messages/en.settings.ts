...
export const settingsDict = {
  ...
  'settings.featurePlugins.slot.xai.info': 'Installs the usage package so Work Status and Providers can show Grok allowance, cycle, and expiry. Sign-in stays on Providers. This page never auto-installs and does not change the default model.',
