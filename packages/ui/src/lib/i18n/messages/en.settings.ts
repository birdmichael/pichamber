...
export const settingsDict = {
  ...
  'settings.projects.shared.description': 'Setup stored in the repository itself (`.pichamber/project.json`), so everyone who pulls it can share the same plans folder — and, later, the same actions, setup commands, and starters. Nothing is written there until you set a plans folder or move an item into it.',
