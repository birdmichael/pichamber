...
export const settingsDict = {
  ...
  'settings.featurePlugins.slot.kimi.region.info': 'Chooses the Moonshot OpenAI-compatible host for the Kimi API key. International is api.moonshot.ai. China is api.moonshot.cn. You never type a URL.',
