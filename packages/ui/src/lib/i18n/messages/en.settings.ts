...
export const settingsDict = {
  ...
  'settings.featurePlugins.slot.goal.info': 'Installs the Goal package. Enabling it is for later Desktop Goal controls. This page does not add a composer Goal button.',
  ...
  'settings.featurePlugins.field.source': 'Source',
  'settings.featurePlugins.field.source.info': 'npm, git, or a local path. Preset chips only fill this field. They do not install the package.',
  'settings.featurePlugins.field.source.placeholder': 'npm:package, git:…, or a local path',
  'settings.featurePlugins.field.source.aria': '{slot} source',
  'settings.featurePlugins.field.command': 'Start command',
  'settings.featurePlugins.field.command.info': 'Slash command used later to start Goal. Default is goal. Plan, MCP, and Subagents have no start command here.',
  'settings.featurePlugins.field.command.placeholder': 'goal',
  'settings.featurePlugins.field.command.aria': 'Goal start command',
  'settings.featurePlugins.presets.aria': '{slot} source presets',
  ...
  'settings.featurePlugins.status.installed': 'Installed in Pi packages.',
  'settings.featurePlugins.status.notInstalled': 'Not installed. Opening this page never installs a package.',
  ...
  'settings.providers.sidebar.empty.description': 'Check ~/.pi/agent/models.json and auth.json',
  ...
  'settings.providers.page.empty.checkOpenCodeConfiguration': 'Check ~/.pi/agent/models.json and auth.json',
