...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.message.context.previewConsole': 'Logs do servidor de desenvolvimento ({file})',
  ...
  "mobile.changes.diffDetail.missingDescription": "Volte para Git e atualize a lista.",
  "mobile.changes.diffDetail.imageUnavailable": "Diffs de imagem ainda não estão disponíveis no Git móvel.",
  ...
  "multirun.compare.title": "Comparar execuções",
  "multirun.compare.subtitleSingle": "{count} execução",
  "multirun.compare.subtitlePlural": "{count} execuções",
  "multirun.compare.actions.openRun": "Abrir",
  "multirun.compare.actions.close": "Fechar",
  "multirun.compare.empty": "Ainda não há execuções neste grupo.",
  "multirun.compare.run.loading": "Carregando esta execução…",
  "multirun.compare.run.empty": "Ainda não há mensagens.",
  "multirun.compare.run.missingDirectory": "Esta execução não tem diretório, então o histórico não pode ser carregado.",
  "multirun.compare.status.running": "Em andamento",
  "multirun.compare.status.idle": "Ociosa",
  "multirun.compare.role.user": "Você",
  "multirun.compare.role.assistant": "Assistente",
  "multirun.launcher.attachments.label": "Arquivos",
  "multirun.launcher.actions.startWithRunCount": "Iniciar ({count} execuções)",
  "multirun.launcher.actions.startWithRunCountSingle": "Iniciar ({count} execução)",
  "multirun.launcher.actions.startWithRunCountPlural": "Iniciar ({count} execuções)",
  ...
  "sessions.sidebar.footer.actions.refresh": "Atualizar",
  "sessions.sidebar.footer.refresh.tooltip": "Recarregar a lista de sessões e a conversa aberta",
  "sessions.sidebar.footer.refresh.aria": "Recarregar a lista de sessões e a conversa aberta",
  "sessions.sidebar.footer.refresh.disabledBusy": "Não é possível atualizar enquanto a sessão responde",
  "sessions.sidebar.footer.refresh.disabledCompacting": "Não é possível atualizar durante a compactação",
  "sessions.sidebar.footer.refresh.disabledInFlight": "Recarregando a lista de sessões e a conversa aberta",
  "sessions.sidebar.footer.refresh.success": "Lista de sessões e conversa aberta recarregadas",
  "sessions.sidebar.footer.refresh.failed": "Falha ao recarregar as sessões",
  ...
  "header.sessionReload.tooltip": "Recarregar skills, prompts e extensões",
  "header.sessionReload.aria": "Recarregar skills, prompts e extensões",
  "header.sessionReload.disabledBusy": "Recarregar indisponível enquanto a sessão está respondendo",
  "header.sessionReload.disabledCompacting": "Recarregar indisponível enquanto a compactação está em andamento",
  "header.sessionReload.disabledInFlight": "Recarregando skills, prompts e extensões",
  "header.sessionReload.failed": "Falha ao recarregar skills, prompts e extensões",
  "header.sessionReload.success": "Skills, prompts e extensões recarregados",
  ...
  "sessions.sidebar.session.menu.exportJsonl": "Exportar JSONL",
  "sessions.sidebar.session.menu.exportHtml": "Exportar HTML",
  "sessions.sidebar.header.actions.importSession": "Importar sessão",
  "sessions.sidebar.session.import.success": "Sessão importada",
  "sessions.sidebar.session.import.failed": "Falha ao importar a sessão",
  "sessions.sidebar.session.export.failed": "Falha ao exportar a sessão",
  ...
  "sessions.sidebar.session.menu.moveToWorktreeTargets": "Mover para um worktree",
  ...
  "sessions.sidebar.session.moveToWorktree.tooltipTargets": "Mostra worktrees existentes e a opção de criar um novo para esta sessão.",
  "sessions.sidebar.session.moveToWorktree.confirm.title": "A origem tem alterações não commitadas",
  "sessions.sidebar.session.moveToWorktree.confirm.changedFiles": "Arquivos alterados neste worktree: {count}.",
  "sessions.sidebar.session.moveToWorktree.confirm.ownership": "O Pichamber rastreia essas alterações por diretório, não por sessão.",
  "sessions.sidebar.session.moveToWorktree.confirm.sessionOnlyHelp": "Move esta sessão e suas subsessões sem alterar os arquivos de origem.",
  "sessions.sidebar.session.moveToWorktree.confirm.allChangesHelp": "Transfere as alterações do diretório da sessão. Após o sucesso, arquivos não preparados e não rastreados saem da origem.",
  "sessions.sidebar.session.moveToWorktree.confirm.stagedWarning": "As alterações no stage permanecem na origem e são copiadas para o destino.",
  "sessions.sidebar.session.moveToWorktree.confirm.baseWarning": "A transferência pode falhar se o destino usar outra base Git.",
  "sessions.sidebar.session.moveToWorktree.confirm.sessionOnly": "Mover só a sessão",
  "sessions.sidebar.session.moveToWorktree.confirm.allChanges": "Mover todas as alterações de origem",
  "sessions.sidebar.session.moveToWorktree.confirm.cancel": "Cancelar",
  "sessions.sidebar.session.moveToWorktree.sourceVerificationFailed": "Não foi possível verificar as alterações de origem. Nenhum worktree ou sessão foi alterado.",
  "sessions.sidebar.session.moveToWorktree.applyChangesFailed": "O destino não aceitou as alterações de origem. A sessão e as alterações não foram movidas. Tente de novo e escolha Mover só a sessão.",
  "sessions.sidebar.session.moveToWorktree.changesMayBeInDestination": "A conexão caiu antes de o destino confirmar a movimentação. A sessão pode não ter sido movida, e as alterações não commitadas já podem estar no worktree de destino. Confira antes de tentar de novo.",
  "sessions.sidebar.session.menu.compareRuns": "Comparar execuções",
  ...
  "sessions.sidebar.group.actions.compareRuns": "Comparar execuções",
  "sessions.sidebar.group.actions.compareRunsAria": "Comparar execuções em {label}",
  ...
  "gitView.changes.revertFileDialogTitle": "Reverter alterações do arquivo?",
  "gitView.changes.revertFileDescription": "Reverter as alterações locais em {path}? Isso não pode ser desfeito.",
  "gitView.changes.revertFile": "Reverter",
  ...
  "gitView.header.createPullRequest": "Criar pull request",
  ...
  "gitView.stashes.toast.applyFailed": "Falha ao aplicar o stash",
  "gitView.stashes.toast.localChangesOverwrite": "Alterações locais seriam sobrescritas ({paths}); faça commit ou stash primeiro",
  "gitView.stashes.toast.localChangesOverwriteWithMore": "Alterações locais seriam sobrescritas ({paths}, +{count} mais); faça commit ou stash primeiro",
  ...
  "gitView.empty.notGitRepositoryDescription": "O status do Git fica disponível quando esta pasta é um repositório Git.",
  ...
  "contextRail.configure.dialogDescription": "Escolha quais painéis a barra mostra. Painéis ocultos mantêm seus dados e saem apenas da barra.",
  ...
  "planView.state.noPlanYet": "Ainda não há um plano",
  ...
  "diffView.state.notGitRepository": "Não é um repositório Git. Os diffs ficam disponíveis quando esta pasta é um repositório Git.",
  ...
  "diffView.branch.empty": "Nenhuma alteração commitada neste branch em relação a {base}",
  "diffView.branch.emptyExcludesWorkingTree": "Esta visualização não inclui a árvore de trabalho. Arquivos não commitados permanecem em Alteradas.",
  ...
  'chat.dictation.unsupported': 'A ditação não é suportada neste ambiente',
  'chat.dictation.disabled': 'A ditação está desativada em Configurações',
  'chat.dictation.microphonePermissionDenied': 'Permissão do microfone negada',
  'chat.dictation.microphoneNotFound': 'Nenhum microfone encontrado',
  'chat.dictation.microphoneUnavailable': 'Não foi possível acessar o microfone',
  'chat.dictation.startFailed': 'Não foi possível iniciar a ditação',
  ...
  "rightSidebar.contextNotesTodo.notes.titlePlain": "Notas rápidas",
  ...
  "header.services.openWithCurrentPi": "Alternar instância local ou remota (atual: {current})",
  "header.services.open": "Abrir serviços, uso e MCP",
  "header.services.openPi": "Abrir serviços",
  "header.services.openPiWithMcp": "Abrir serviços e MCP",
  ...
  "chat.emptyState.draftTitle": "No que estamos trabalhando?",
  "chat.emptyState.draftTitleWithProject": "No que estamos trabalhando em {project}?",
  ...
  "chat.promptNavigator.openTimeline": "Linha do tempo da sessão",
  ...
  "chat.toast.opencodeRestartInterrupted.description": "O Pi reiniciou enquanto uma resposta ainda estava sendo gerada. Envie uma mensagem para continuar.",
  ...
  "chat.commandAutocomplete.command.btwDescription": "Faça uma pergunta paralela em uma sessão temporária filha sem desviar este chat.",
  ...
  "chat.commandAutocomplete.keyboardHintEmpty": "Esc fechar",
  ...
  "chat.fileMentionAutocomplete.empty": "Nenhum arquivo ou agente encontrado",
  ...
  "chat.btw.destroyAria": "Descartar esta sessão btw",
  ...
  "chat.btw.toast.emptyArgument": "Digite uma pergunta após /btw",
  "chat.btw.toast.createFailed": "Falha ao iniciar a sessão btw",
  "chat.btw.toast.destroyFailed": "Falha ao descartar a sessão btw. Ela permanecerá na barra lateral.",
  "chat.btw.working": "Trabalhando…",
  "chat.btw.collapseAria": "Recolher o painel btw",
  "chat.btw.expandAria": "Expandir o painel btw",
  "chat.btw.promoteAria": "Manter como sessão normal",
  "chat.btw.toast.promoteFailed": "Falha ao manter a sessão btw como sessão normal",
  ...
  "chat.piExtensionUi.inputNeeded": "Resposta necessária",
  "chat.piExtensionUi.selectMultiple": "Seleção múltipla",
  "chat.piExtensionUi.other": "Outro…",
  "chat.piExtensionUi.yourAnswer": "Sua resposta",
  "chat.piExtensionUi.submit": "Enviar",
  "chat.piExtensionUi.dismiss": "Dispensar",
  "chat.piExtensionUi.confirm": "Confirmar",
  "chat.piExtensionUi.cancel": "Cancelar",
  "chat.piExtensionUi.submitFailed": "Falha ao enviar a resposta",
  "chat.piExtensionUi.dismissFailed": "Falha ao dispensar a pergunta",
  "chat.piExtensionUi.noLongerPending": "Esta pergunta não está mais aguardando resposta.",
  "chat.piExtensionUi.tryAgain": "Tente novamente em instantes.",
  "chat.piExtensionUi.answered": "Respondida",
  "chat.piExtensionUi.cancelled": "Cancelada",
  "chat.piExtensionUi.questionFallback": "Pergunta",
  "chat.piExtensionUi.confirmAria": "Confirmação da extensão",
  "chat.piExtensionUi.chooseOption": "Escolha uma opção para ativar Enviar.",
  "chat.piPlan.agent": "Agente",
  "chat.piPlan.plan": "Plano",
  "chat.piPlan.toggleAria": "Modo Agente ou Plano",
  "chat.piPlan.build": "Build",
  "chat.piPlan.building": "Construindo…",
  "chat.piPlan.buildModelAria": "Modelo para Build",
  "chat.piPlan.actionFailed": "Não foi possível mudar para Plano. Recarregue a sessão e tente de novo.",
  "chat.piPlan.buildFailed": "Não foi possível iniciar o Build",
  "chat.piPlan.discard": "Descartar",
  "chat.piPlan.discardFailed": "Não foi possível descartar o plano",
  "chat.piPlan.discardConfirmTitle": "Descartar este plano?",
  "chat.piPlan.discardConfirmDescription": "Isso remove o plano pronto ou salvo da sessão.",
  "chat.piPlan.discardConfirm": "Descartar",
  ...
  "chat.piPlan.readySelect.implementFreshDescription": "Abrir uma nova sessão vinculada e transferir só o plano aprovado.",
  "chat.piPlan.readySelect.export": "Exportar plano…",
  "chat.piPlan.readySelect.save": "Salvar para depois",
  "chat.piPlan.readySelect.stay": "Permanecer no modo Plano",
  "chat.piPlan.readySelect.exit": "Descartar o plano e sair",
  "chat.tool.planModeComplete": "Modo Plano concluído",
  "chat.tool.planEnter": "Modo Plano",
  "chat.tool.planExit": "Modo Build",
  "chat.piGoal.button": "Goal",
  "chat.piGoal.buttonAria": "Iniciar Goal",
  "chat.piGoal.dialog.title": "Iniciar Goal",
  "chat.piGoal.dialog.objectiveLabel": "Objetivo",
  "chat.piGoal.dialog.objectivePlaceholder": "O que o agente deve alcançar?",
  "chat.piGoal.dialog.submit": "Iniciar",
  "chat.piGoal.dialog.cancel": "Cancelar",
  "chat.piGoal.dialog.exitPlan": "Sair do Plan",
  "chat.piGoal.dialog.aria": "Iniciar Goal",
  "chat.piGoal.error.empty": "Digite um objetivo para iniciar o Goal.",
  "chat.piGoal.error.missingCommand": "O Goal está instalado, mas este chat não conseguiu iniciá-lo. Toque em Iniciar de novo ou recarregue a sessão.",
  "chat.piGoal.error.failed": "Não foi possível iniciar o Goal.",
  "chat.piGoal.error.planActive": "O modo Plan está ativo. Saia do Plan antes de iniciar o Goal.",
  "chat.piGoal.error.noSession": "Abra uma sessão antes de iniciar o Goal.",
  "chat.piGoal.row.aria": "Goal atual",
  ...
  "chat.messageBody.forkDialog.title": "Iniciar nova sessão",
  ...
  "chat.messageBody.toast.planSavedWithPath": "Plano salvo em {path}",
  "chat.messageBody.toast.imageSaved": "Imagem salva",
  "chat.messageBody.toast.generateImageFailed": "Não foi possível gerar a imagem",
  "chat.messageBody.toast.noImageToSave": "Esta mensagem não tem imagem para salvar.",
  "chat.messageBody.toast.copied": "Copiado",
  "chat.messageBody.toast.copyFailed": "Falha ao copiar",
  ...
  "chat.chatInput.placeholder.chatPi": "@ para arquivos/agentes; / para comandos e habilidades; # para snippets",
  "chat.chatInput.placeholder.chatCompact": "Use @ / ! # para ajudantes",
  "chat.chatInput.placeholder.chatCompactPi": "Use @ / # para ajudantes",
  ...
  "chat.chatInput.toast.modelRequired": "Selecione um modelo antes de enviar. Adicione um provedor em Configurações se a lista estiver vazia.",
  ...
  "chat.chatInput.toast.unknownCommand": "Esse comando ainda não está disponível.",
  "chat.chatInput.toast.commandFailed": "Não foi possível executar esse comando.",
  "chat.chatInput.pendingPromptHint": "Envie ou descarte o cartão antes de mandar a mensagem.",
  ...
  "commandPalette.description": "Buscar sessões, ações e arquivos.",
  "commandPalette.input.placeholder": "Buscar sessões, ações, arquivos...",
  ...
  "saveProjectPlanDialog.description": "Salve este plano como um arquivo Markdown na pasta .pichamber/plans deste projeto.",
  ...
  "projects.sharedTrust.description": "{path} neste repositório define comandos que rodam nesta máquina. Confie uma vez e o Pichamber só perguntará de novo quando eles mudarem.",
  ...
  "mcpDropdown.status.cached": "Pronto, ainda não conectado",
  "mcpDropdown.status.disabled": "Desativado",
  ...
  "onboarding.localSetup.dialog.selectOpencodeBinary": "Selecionar executável do pi",
  ...
  "onboarding.localSetup.status.detected": "Pi encontrado em {path}",
  ...
  "onboarding.localSetup.windows.hintDetectionFailed": "Se a detecção falhar, defina um caminho nativo, como ~/.local/bin/pi.",
  "onboarding.localSetup.hint.ensurePath": "Já está instalado? Confira se pi está no seu PATH.",
  "onboarding.localSetup.hint.setEnv": "Ou defina a variável de ambiente PI_BINARY.",
  ...
  "updateDialog.actions.openGitHubRelease": "Abrir o release no GitHub",
  "updateDialog.manualInstall.unsignedMac": "Esta versão para Mac não consegue instalar atualizações no app. Abra o release no GitHub e substitua o Pichamber.app pelo do .dmg.",
  ...
  "updateDialog.error.takingLonger": "A atualização está demorando mais do que o esperado. Aguarde um pouco e atualize, ou execute: pichamber update",
  ...
  'chat.workStatus.pinned.empty': 'Nenhuma mensagem fixada',
  ...
  'chat.workStatus.subagent.foreground': 'Primeiro plano',
  'chat.workStatus.subagent.background': 'Segundo plano',
  ...
  'chat.workStatus.action.openSubagentOwned': 'Abrir {name} (parte de {parent})',
  'chat.workStatus.action.open': 'Abrir',
  'chat.workStatus.subagent.unopenableTooltip': 'Nenhuma sessão para abrir',
  'chat.workStatus.subagent.summarize': 'Post result to parent',
  'chat.workStatus.subagent.summarizeAgain': 'Reenviar resultado para a sessão pai',
  'chat.workStatus.subagent.summarizeAgainHint': 'Os resultados são enviados automaticamente quando um subagente em segundo plano termina. Use só se a entrega falhou.',
  'chat.workStatus.subagent.handoffMessage': 'Resultado do subagente "{name}" (usar como contexto):\n{body}',
  'chat.workStatus.subagent.handoffEmpty': 'O subagente "{name}" terminou sem um resultado em texto; abra a sessão filha para detalhes.',
  ...
  'chat.workStatus.kimi.membership.free': 'Grátis',
  'chat.workStatus.kimi.membership.basic': 'Básico',
  'chat.workStatus.kimi.membership.intermediate': 'Intermediário',
  'chat.workStatus.kimi.membership.advanced': 'Avançado',
  'chat.workStatus.kimi.membership.professional': 'Profissional',
  'chat.workStatus.kimi.membership.enterprise': 'Empresarial',
  'chat.workStatus.kimi.window.weekly': 'Semanal',
