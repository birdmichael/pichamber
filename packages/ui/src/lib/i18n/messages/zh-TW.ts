...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.message.context.previewConsole': '開發伺服器日誌（{file}）',
  ...
  'mobile.sessions.activeWorktreeAria': '作用中的 worktree',
  ...
  'mobile.sessions.editOrderHint': '拖曳手柄以重新排序專案。點按專案可顯示其 worktree 並同樣拖曳排序。點按勾號完成。',
  ...
  'mobile.projectEdit.worktreesEmpty': '此專案還沒有 worktree。',
  'mobile.projectEdit.reorderHint': '拖曳以重新排序 worktree。',
  ...
  'mobile.projectEdit.deleteWorktreeConfirm': '移除 worktree 「{name}」？此操作無法復原。',
  'mobile.projectEdit.deleteWorktreeDirty': '此 worktree 有未提交的變更，將會遺失。',
  ...
  'mobile.changes.placeholder.description': '工作區檢閱、同步與提交動作會顯示在這裡。',
  ...
  'mobile.changes.diffDetail.missingDescription': '返回 Git 並重新整理清單。',
  'mobile.changes.diffDetail.imageUnavailable': '行動版 Git 尚不支援圖片 diff。',
  ...
  'multirun.compare.title': '比較執行',
  'multirun.compare.subtitleSingle': '{count} 個執行',
  'multirun.compare.subtitlePlural': '{count} 個執行',
  'multirun.compare.actions.openRun': '開啟',
  'multirun.compare.actions.close': '關閉',
  'multirun.compare.empty': '此群組尚無執行。',
  'multirun.compare.run.loading': '正在載入此執行…',
  'multirun.compare.run.empty': '尚無訊息。',
  'multirun.compare.run.missingDirectory': '此執行沒有目錄，無法載入對話。',
  'multirun.compare.status.running': '進行中',
  'multirun.compare.status.idle': '閒置',
  ...
  'multirun.launcher.actions.startWithRunCountSingle': '開始（{count} 次運行）',
  'multirun.launcher.actions.startWithRunCountPlural': '開始（{count} 次運行）',
  ...
  'sessions.sidebar.footer.actions.refresh': '重新整理',
  'sessions.sidebar.footer.refresh.tooltip': '重新載入工作階段列表與目前對話',
  'sessions.sidebar.footer.refresh.aria': '重新載入工作階段列表與目前對話',
  'sessions.sidebar.footer.refresh.disabledBusy': '工作階段正在回覆，無法重新整理',
  'sessions.sidebar.footer.refresh.disabledCompacting': '正在壓縮上下文，無法重新整理',
  'sessions.sidebar.footer.refresh.disabledInFlight': '正在重新整理工作階段列表與目前對話',
  'sessions.sidebar.footer.refresh.success': '已重新載入工作階段列表與目前對話',
  'sessions.sidebar.footer.refresh.failed': '重新整理工作階段失敗',
  ...
  'sessions.sidebar.header.grouping.byWorktree': '依 worktree',
  ...
  'sessions.worktreesPage.description': '建立、檢視及移除此專案的 git worktree。',
  'sessions.worktreesPage.closeAria': '關閉 worktree',
  ...
  'sessions.sidebar.session.menu.exportJsonl': '匯出 JSONL',
  'sessions.sidebar.session.menu.exportHtml': '匯出 HTML',
  'sessions.sidebar.header.actions.importSession': '匯入工作階段',
  'sessions.sidebar.session.import.success': '工作階段已匯入',
  'sessions.sidebar.session.import.failed': '匯入工作階段失敗',
  'sessions.sidebar.session.export.failed': '匯出工作階段失敗',
  'sessions.sidebar.session.menu.moveToWorktree': '移至新 worktree',
  'sessions.sidebar.session.moveToWorktree.success': '工作階段已移至新 worktree',
  'sessions.sidebar.session.moveToWorktree.failed': '無法將工作階段移至新 worktree',
  'sessions.sidebar.session.moveToWorktree.tooltip': '從目前分支建立新 worktree，轉移未提交的變更，並將此工作階段及其子工作階段移至其中。',
  'sessions.sidebar.session.moveToWorktree.tooltipBusy': '僅在工作階段閒置時可用。請停止目前活動或等待其完成。',
  'sessions.sidebar.session.moveToWorktree.tooltipMoving': '此工作階段已在移至新 worktree。',
  'sessions.sidebar.session.menu.moveToWorktreeTargets': '移至 worktree',
  'sessions.sidebar.session.moveToWorktree.main': '主 worktree',
  'sessions.sidebar.session.moveToWorktree.refreshing': '正在重新整理 worktree…',
  'sessions.sidebar.session.moveToWorktree.loadFailed': '無法載入 worktree',
  'sessions.sidebar.session.moveToWorktree.current': '目前 worktree',
  'sessions.sidebar.session.moveToWorktree.existingSuccess': '工作階段已移至 worktree',
  'sessions.sidebar.session.moveToWorktree.existingFailed': '無法將工作階段移至 worktree',
  'sessions.sidebar.session.moveToWorktree.tooltipTargets': '顯示既有 worktree，以及為此工作階段新建一個的選項。',
  'sessions.sidebar.session.moveToWorktree.confirm.title': '來源目錄有未提交的變更',
  'sessions.sidebar.session.moveToWorktree.confirm.changedFiles': '此 worktree 中已變更的檔案：{count}。',
  'sessions.sidebar.session.moveToWorktree.confirm.ownership': 'Pichamber 依目錄追蹤這些變更，而不是依工作階段。',
  'sessions.sidebar.session.moveToWorktree.confirm.sessionOnlyHelp': '只移動此工作階段及其子工作階段，來源檔案維持不變。',
  'sessions.sidebar.session.moveToWorktree.confirm.allChangesHelp': '轉移工作階段目錄下的變更。成功後未暫存與未追蹤的檔案會離開來源。',
  'sessions.sidebar.session.moveToWorktree.confirm.stagedWarning': '已暫存的變更會留在來源，並複製到目標。',
  'sessions.sidebar.session.moveToWorktree.confirm.baseWarning': '目標使用不同 Git 基線時，轉移可能失敗。',
  ...
  'sessions.sidebar.session.moveToWorktree.sourceVerificationFailed': '無法核實來源變更。未改動 worktree 或工作階段。',
  'sessions.sidebar.session.moveToWorktree.applyChangesFailed': '目標無法接受來源變更。工作階段與來源變更均未移動。請重試並選擇「僅移動工作階段」。',
  'sessions.sidebar.session.moveToWorktree.changesMayBeInDestination': '目標確認移動前連線中斷。工作階段可能未移動，未提交變更可能已在目標 worktree。重試前請先檢查那裡。',
  'sessions.sidebar.session.menu.compareRuns': '比較執行',
  ...
  'sessions.sidebar.session.status.movingToWorktree': '正在將會話移至新 worktree',
  ...
  'sessions.sidebar.group.actions.compareRuns': '比較執行',
  'sessions.sidebar.group.actions.compareRunsAria': '比較 {label} 中的執行',
  ...
  'gitView.changes.revertFileDescription': '還原 {path} 的本地變更？此操作無法復原。',
  'gitView.changes.revertFile': '還原',
  ...
  'gitView.empty.notGitRepositoryDescription': '目前資料夾是 Git 儲存庫時才會顯示 Git 狀態。',
  ...
  'contextRail.configure.dialogDescription': '選擇側欄顯示哪些面板。隱藏的面板會保留資料，只是不出現在側欄上。',
  ...
  'contextPanel.browser.hostAppBlocked': '無法在瀏覽器面板中開啟 Pichamber 應用本身。',
  ...
  'diffView.state.notGitRepository': '目前不是 Git 儲存庫。目前資料夾是 Git 儲存庫時才會顯示差異。',
  ...
  "diffView.branch.empty": "此分支相對於 {base} 沒有已提交的變更",
  "diffView.branch.emptyExcludesWorkingTree": "此檢視不含工作區。未提交的檔案仍在「已變更」中。",
  ...
  'header.services.openWithCurrentPi': '切換本機或遠端實例（目前：{current}）',
  'header.services.open': '開啟服務、用量和 MCP',
  'header.services.openPi': '開啟服務',
  'header.services.openPiWithMcp': '開啟服務和 MCP',
  ...
  'chat.changedFiles.actions.showMore': '顯示另外 {count} 個',
  ...
  'chat.emptyState.draftTitleWithProject': '我們在 {project} 做什麼？',
  ...
  'chat.promptNavigator.openTimeline': '會話時間線',
  ...
  'chat.toast.opencodeRestartInterrupted.description': 'Pi 在回覆仍在產生時重新啟動了。發送一則訊息以繼續。',
  ...
  'chat.commandAutocomplete.command.btwDescription': '在暫時子工作階段提出旁支問題，而不打亂目前聊天。',
  ...
  'chat.fileMentionAutocomplete.empty': '找不到檔案或 Agent',
  ...
  'chat.btw.mainComposerPlaceholder': '在此 btw 工作階段提問…',
  'chat.btw.loading': '正在啟動 btw 工作階段…',
  'chat.btw.toast.emptyArgument': '請在 /btw 後輸入問題',
  'chat.btw.toast.createFailed': '無法啟動 btw 工作階段',
  'chat.btw.toast.destroyFailed': '無法銷毀 btw 工作階段。它將保留在側邊欄中。',
  'chat.btw.working': '處理中…',
  'chat.btw.collapseAria': '摺疊 btw 面板',
  'chat.btw.expandAria': '展開 btw 面板',
  'chat.btw.promoteAria': '保留為一般工作階段',
  'chat.btw.toast.promoteFailed': '無法將 btw 工作階段保留為一般工作階段',
  ...
  'chat.piExtensionUi.inputNeeded': '需要輸入',
  'chat.piExtensionUi.selectMultiple': '多選',
  'chat.piExtensionUi.other': '其他…',
  'chat.piExtensionUi.yourAnswer': '你的回答',
  'chat.piExtensionUi.submit': '提交',
  'chat.piExtensionUi.dismiss': '關閉',
  'chat.piExtensionUi.confirm': '確認',
  'chat.piExtensionUi.cancel': '取消',
  'chat.piExtensionUi.submitFailed': '傳送回答失敗',
  'chat.piExtensionUi.dismissFailed': '關閉問題失敗',
  'chat.piExtensionUi.noLongerPending': '此問題已不再等待回覆。',
  'chat.piExtensionUi.tryAgain': '請稍後再試。',
  'chat.piExtensionUi.answered': '已回答',
  'chat.piExtensionUi.cancelled': '已取消',
  'chat.piExtensionUi.questionFallback': '問題',
  'chat.piExtensionUi.confirmAria': '擴充功能確認',
  'chat.piExtensionUi.chooseOption': '請先選擇一項以啟用提交。',
  'chat.piPlan.agent': '智慧體',
  'chat.piPlan.plan': '計畫',
  'chat.piPlan.toggleAria': '智慧體或計畫模式',
  'chat.piPlan.build': '建置',
  'chat.piPlan.building': '正在建置…',
  'chat.piPlan.buildModelAria': '建置所用模型',
  'chat.piPlan.actionFailed': '無法切換到計畫。請重載工作階段後再試。',
  'chat.piPlan.buildFailed': '無法開始建置',
  'chat.piPlan.discard': '捨棄',
  'chat.piPlan.discardFailed': '無法捨棄該計畫',
  'chat.piPlan.discardConfirmTitle': '捨棄此計畫？',
  'chat.piPlan.discardConfirmDescription': '這會從目前工作階段清除已就緒或已儲存的計畫。',
  'chat.piPlan.discardConfirm': '捨棄',
  ...
  'chat.piPlan.readySelect.title': '計畫已就緒。接下來怎麼做？在此實作會在目前工作階段以智能體繼續。全新開始只會把已核准的計畫轉到新工作階段。',
  'chat.piPlan.readySelect.implementHere': '在此實作',
  'chat.piPlan.readySelect.implementHereDescription': '在目前工作階段繼續，並保留規劃對話。',
  'chat.piPlan.readySelect.implementFresh': '全新開始並實作',
  'chat.piPlan.readySelect.implementFreshDescription': '開啟一個關聯的新工作階段，只轉移已核准的計畫。',
  'chat.piPlan.readySelect.export': '匯出計畫…',
  'chat.piPlan.readySelect.save': '稍後儲存',
  'chat.piPlan.readySelect.stay': '留在計畫模式',
  'chat.piPlan.readySelect.exit': '捨棄計畫並退出',
  'chat.tool.planModeComplete': '計畫模式完成',
  'chat.tool.planEnter': '計畫模式',
  'chat.tool.planExit': '建置模式',
  'chat.piGoal.button': 'Goal',
  'chat.piGoal.buttonAria': '開始 Goal',
  'chat.piGoal.dialog.title': '開始 Goal',
  'chat.piGoal.dialog.objectiveLabel': '目標',
  'chat.piGoal.dialog.objectivePlaceholder': '代理需要完成什麼？',
  'chat.piGoal.dialog.submit': '開始',
  'chat.piGoal.dialog.cancel': '取消',
  'chat.piGoal.dialog.exitPlan': '退出 Plan',
  'chat.piGoal.dialog.aria': '開始 Goal',
  ...
  'chat.piGoal.error.planActive': 'Plan 模式已開啟。請先退出 Plan，再開始 Goal。',
  ...
  'chat.messageBody.forkDialog.title': '開始新工作階段',
  ...
  'chat.messageBody.toast.planSavedWithPath': '計畫已儲存到 {path}',
  'chat.messageBody.toast.imageSaved': '圖片已儲存',
  'chat.messageBody.toast.generateImageFailed': '生成圖片失敗',
  'chat.messageBody.toast.noImageToSave': '這則訊息沒有可儲存的圖片。',
  'chat.messageBody.toast.copied': '已複製',
  'chat.messageBody.toast.copyFailed': '複製失敗',
  'chat.messageBody.usage.input': '輸入',
  'chat.messageBody.usage.output': '輸出',
  'chat.messageBody.usage.reasoning': '推理',
  'chat.messageBody.usage.cacheRead': '快取讀取',
  'chat.messageBody.usage.cacheWrite': '快取寫入',
  'chat.messageBody.usage.cost': '費用',
  ...
  'chat.chatInput.placeholder.chatPi': '@ 用於檔案/Agent；/ 用於命令；# 用於程式片段',
  'chat.chatInput.placeholder.chatCompact': '使用 @ / ! # 輔助',
  'chat.chatInput.placeholder.chatCompactPi': '使用 @ / # 輔助',
  ...
  'chat.dictation.unsupported': '目前環境不支援語音輸入',
  'chat.dictation.disabled': '設定中已關閉語音輸入',
  'chat.dictation.microphonePermissionDenied': '麥克風權限被拒絕',
  'chat.dictation.microphoneNotFound': '找不到麥克風',
  'chat.dictation.microphoneUnavailable': '無法存取麥克風',
  'chat.dictation.startFailed': '無法開始語音輸入',
  ...
  'chat.chatInput.toast.unknownCommand': '該命令尚不可用。',
  'chat.chatInput.toast.commandFailed': '無法執行該命令。',
  'chat.chatInput.pendingPromptHint': '傳送訊息前請先提交或關閉卡片。',
  ...
  'commandPalette.description': '搜尋會話、操作和檔案。',
  'commandPalette.input.placeholder': '搜尋會話、操作、檔案...',
  ...
  'saveProjectPlanDialog.description': '將此計畫儲存為專案中 .pichamber/plans 資料夾下的 Markdown 檔案。',
  ...
  'projects.sharedTrust.description': '此儲存庫中的 {path} 定義了會在本機執行的命令。信任一次後，只有當命令變更時 Pichamber 才會再次詢問。',
  'projects.sharedTrust.setupCommands': 'Worktree設定命令',
  ...
  'mcpDropdown.status.cached': '已就緒，尚未連線',
  'mcpDropdown.status.disabled': '已停用',
  ...
  'onboarding.localSetup.windows.hintDetectionFailed': '若偵測失敗，請設定原生路徑，例如 ~/.local/bin/pi。',
  'onboarding.localSetup.hint.ensurePath': '已安裝？請確認 pi 在你的 PATH 中。',
  'onboarding.localSetup.hint.setEnv': '或設定 PI_BINARY 環境變數。',
  ...
  'updateDialog.error.takingLonger': '更新耗時超出預期。請稍等後重新整理，或執行：pichamber update',
  ...
  'chat.workStatus.subagent.foreground': '前景',
  'chat.workStatus.subagent.background': '背景',
  'chat.workStatus.subagent.blocked': '已封鎖',
  'chat.workStatus.subagent.failed': '失敗',
  'chat.workStatus.subagent.paused': '已暫停',
  'chat.workStatus.subagent.queued': '排隊中',
  ...
  'chat.workStatus.subagent.namedForeground': '{name} · 前景',
  'chat.workStatus.subagent.namedBackground': '{name} · 背景',
  ...
  'chat.workStatus.action.openSubagentOwned': '開啟 {name}（屬於 {parent}）',
  'chat.workStatus.action.open': '開啟',
  'chat.workStatus.subagent.unopenableTooltip': '還沒有可開啟的工作階段',
  'chat.workStatus.subagent.summarize': 'Post result to parent',
  'chat.workStatus.subagent.summarizeAgain': '重新送回父工作階段',
  'chat.workStatus.subagent.summarizeAgainHint': '背景子代理完成後會自動回傳結果。僅在漏傳時使用此按鈕。',
  'chat.workStatus.subagent.handoffMessage': '子智慧體「{name}」結果（請作為上下文參考）：\n{body}',
  'chat.workStatus.subagent.handoffEmpty': '子智慧體「{name}」已結束但沒有文字結果，請開啟子工作階段查看詳情。',
  ...
  'chat.workStatus.kimi.membership.free': '免費',
  'chat.workStatus.kimi.membership.basic': '基礎',
  'chat.workStatus.kimi.membership.intermediate': '中級',
  'chat.workStatus.kimi.membership.advanced': '高級',
  'chat.workStatus.kimi.membership.professional': '專業',
  'chat.workStatus.kimi.membership.enterprise': '企業',
  'chat.workStatus.kimi.window.weekly': '每週',
