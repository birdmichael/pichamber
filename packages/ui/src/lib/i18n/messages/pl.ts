...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.message.context.previewConsole': 'Logi serwera deweloperskiego ({file})',
  ...
  'mobile.changes.placeholder.title': 'Git',
  ...
  'mobile.changes.diffDetail.missingDescription': 'Wróć do Git i odśwież listę.',
  'mobile.changes.diffDetail.imageUnavailable': 'Diffy obrazów nie są jeszcze dostępne w mobilnym Git.',
  ...
  'sessions.sidebar.footer.actions.refresh': 'Odśwież',
  'sessions.sidebar.footer.refresh.tooltip': 'Ponownie wczytaj listę sesji i otwartą rozmowę',
  'sessions.sidebar.footer.refresh.aria': 'Ponownie wczytaj listę sesji i otwartą rozmowę',
  'sessions.sidebar.footer.refresh.disabledBusy': 'Odświeżanie niedostępne, gdy sesja odpowiada',
  'sessions.sidebar.footer.refresh.disabledCompacting': 'Odświeżanie niedostępne podczas kompresji kontekstu',
  'sessions.sidebar.footer.refresh.disabledInFlight': 'Ponowne wczytywanie listy sesji i otwartej rozmowy',
  'sessions.sidebar.footer.refresh.success': 'Ponownie wczytano listę sesji i otwartą rozmowę',
  'sessions.sidebar.footer.refresh.failed': 'Nie udało się ponownie wczytać sesji',
  ...
  'sessions.sidebar.project.actions.newWorktree': 'Nowy worktree',
  'sessions.sidebar.project.actions.newWorktreeEllipsis': 'Nowy worktree...',
  ...
  'sessions.sidebar.session.menu.exportJsonl': 'Eksportuj JSONL',
  'sessions.sidebar.session.menu.exportHtml': 'Eksportuj HTML',
  'sessions.sidebar.header.actions.importSession': 'Importuj sesję',
  'sessions.sidebar.session.import.success': 'Sesja zaimportowana',
  'sessions.sidebar.session.import.failed': 'Nie udało się zaimportować sesji',
  'sessions.sidebar.session.export.failed': 'Nie udało się wyeksportować sesji',
  ...
  'sessions.sidebar.session.moveToWorktree.existingSuccess': 'Sesja przeniesiona do worktree',
  'sessions.sidebar.session.moveToWorktree.existingFailed': 'Nie udało się przenieść sesji do worktree',
  'sessions.sidebar.session.moveToWorktree.tooltipTargets': 'Pokazuje istniejące worktree oraz opcję utworzenia nowego dla tej sesji.',
  ...
  'sessions.sidebar.session.moveToWorktree.confirm.ownership': 'Pichamber śledzi te zmiany według katalogu, nie według sesji.',
  'sessions.sidebar.session.moveToWorktree.confirm.sessionOnlyHelp': 'Przenosi tylko tę sesję i jej podsesje, nie zmieniając plików źródłowych.',
  'sessions.sidebar.session.moveToWorktree.confirm.allChangesHelp': 'Przenosi zmiany z katalogu sesji. Po sukcesie pliki niestage’owane i nieśledzone opuszczają źródło.',
  'sessions.sidebar.session.moveToWorktree.confirm.stagedWarning': 'Zmiany w stagingu zostają w źródle i są kopiowane do celu.',
  'sessions.sidebar.session.moveToWorktree.confirm.baseWarning': 'Transfer może się nie udać, gdy cel ma inną bazę Git.',
  'sessions.sidebar.session.moveToWorktree.confirm.sessionOnly': 'Przenieś tylko sesję',
  'sessions.sidebar.session.moveToWorktree.confirm.allChanges': 'Przenieś wszystkie zmiany źródła',
  'sessions.sidebar.session.moveToWorktree.confirm.cancel': 'Anuluj',
  'sessions.sidebar.session.moveToWorktree.sourceVerificationFailed': 'Nie udało się zweryfikować zmian źródła. Ani worktree, ani sesja nie zostały zmienione.',
  'sessions.sidebar.session.moveToWorktree.applyChangesFailed': 'Cel nie przyjął zmian źródła. Sesja i zmiany nie zostały przeniesione. Spróbuj ponownie i wybierz Przenieś tylko sesję.',
  'sessions.sidebar.session.moveToWorktree.changesMayBeInDestination': 'Połączenie przerwano przed potwierdzeniem. Sesja mogła nie zostać przeniesiona, a niezacommitowane zmiany mogą już być w docelowym worktree. Sprawdź je przed ponowną próbą.',
  'sessions.sidebar.session.menu.compareRuns': 'Porównaj uruchomienia',
  ...
  'multirun.launcher.groupName.info': 'Używane dla katalogu worktree i nazw gałęzi',
  ...
  'multirun.launcher.actions.startWithRunCountSingle': 'Uruchom ({count} uruchomienie)',
  'multirun.launcher.actions.startWithRunCountPlural': 'Uruchom ({count} uruchomień)',
  ...
  'multirun.compare.title': 'Porównaj uruchomienia',
  'multirun.compare.subtitleSingle': '{count} uruchomienie',
  'multirun.compare.subtitlePlural': '{count} uruchomień',
  'multirun.compare.actions.openRun': 'Otwórz',
  'multirun.compare.actions.close': 'Zamknij',
  'multirun.compare.empty': 'W tej grupie nie ma jeszcze uruchomień.',
  'multirun.compare.run.loading': 'Wczytywanie tego uruchomienia…',
  'multirun.compare.run.empty': 'Nie ma jeszcze wiadomości.',
  'multirun.compare.run.missingDirectory': 'To uruchomienie nie ma katalogu, więc nie można wczytać historii.',
  'multirun.compare.status.running': 'W toku',
  'multirun.compare.status.idle': 'Bezczynne',
  'multirun.compare.role.user': 'Ty',
  'multirun.compare.role.assistant': 'Asystent',
  ...
  'sessions.sidebar.dialogs.worktreeDelete.descriptionNoLinked': 'To usuwa wybrane worktree.',
  'sessions.sidebar.dialogs.worktreeDelete.descriptionOneLinked': 'To usuwa wybrane worktree i archiwizuje {count} powiązaną sesję.',
  'sessions.sidebar.dialogs.worktreeDelete.descriptionManyLinked': 'To usuwa wybrane worktree i archiwizuje {count} powiązane sesje.',
  ...
  'sessions.sidebar.group.actions.compareRuns': 'Porównaj uruchomienia',
  'sessions.sidebar.group.actions.compareRunsAria': 'Porównaj uruchomienia w {label}',
  'sessions.sidebar.group.actions.deleteWorktree': 'Usuń worktree',
  ...
  'sessions.sidebar.sessionDialogs.worktree.errorRemoveTitle': 'Nie udało się usunąć worktree',
  'sessions.sidebar.sessionDialogs.worktree.removedTitle': 'Worktree usunięte',
  'sessions.sidebar.sessionDialogs.worktree.removed': 'Worktree usunięte.',
  'sessions.sidebar.sessionDialogs.worktree.removedWithRemote': 'Worktree i zdalna gałąź usunięte.',
  'sessions.sidebar.sessionDialogs.worktree.attachedArchived': 'Dołączone worktree zarchiwizowane.',
  'sessions.sidebar.sessionDialogs.worktree.attachedArchivedPlural': 'Dołączone worktree zarchiwizowane.',
  'sessions.sidebar.sessionDialogs.worktree.archivedAndRemoteRemoved': 'Zarchiwizowane worktree i usunięte zdalne gałęzie.',
  'sessions.sidebar.sessionDialogs.worktree.label': 'Worktree',
  'sessions.sidebar.sessionDialogs.worktree.pathUnavailable': 'Ścieżka worktree niedostępna.',
  ...
  'session.githubIntegration.validation.branchAlreadyCheckedOut': 'Gałąź jest już wyewidencjonowana w worktree',
  ...
  'chat.changedFiles.actions.showMore': 'Pokaż jeszcze {count}',
  'chat.changedFiles.actions.collapse': 'Pokaż mniej',
  ...
  'chat.emptyState.draftTitleWithProject': 'Nad czym pracujemy w {project}?',
  ...
  'chat.promptNavigator.openTimeline': 'Oś czasu sesji',
  ...
  'chat.commandAutocomplete.command.btwDescription': 'Zadaj pytanie poboczne w tymczasowej sesji podrzędnej bez zboczenia z tej rozmowy.',
  ...
  'chat.commandAutocomplete.keyboardHintEmpty': 'Esc zamknij',
  ...
  'chat.fileMentionAutocomplete.empty': 'Nie znaleziono plików ani agentów',
  ...
  'chat.btw.destroyAria': 'Usuń tę sesję btw',
  'chat.btw.titleFallback': 'sesja btw',
  'chat.btw.mainComposerPlaceholder': 'Zapytaj w tej sesji btw…',
  ...
  'chat.btw.toast.destroyFailed': 'Nie udało się usunąć sesji btw. Pozostanie na pasku bocznym.',
  'chat.btw.working': 'Praca…',
  'chat.btw.collapseAria': 'Zwiń panel btw',
  'chat.btw.expandAria': 'Rozwiń panel btw',
  'chat.btw.promoteAria': 'Zachowaj jako zwykłą sesję',
  'chat.btw.toast.promoteFailed': 'Nie udało się zachować sesji btw jako zwykłej sesji',
  ...
  'chat.piExtensionUi.inputNeeded': 'Wymagana odpowiedź',
  'chat.piExtensionUi.selectMultiple': 'Wybór wielokrotny',
  'chat.piExtensionUi.other': 'Inne…',
  'chat.piExtensionUi.yourAnswer': 'Twoja odpowiedź',
  'chat.piExtensionUi.submit': 'Wyślij',
  'chat.piExtensionUi.dismiss': 'Odrzuć',
  'chat.piExtensionUi.confirm': 'Potwierdź',
  'chat.piExtensionUi.cancel': 'Anuluj',
  'chat.piExtensionUi.submitFailed': 'Nie udało się wysłać odpowiedzi',
  'chat.piExtensionUi.dismissFailed': 'Nie udało się odrzucić pytania',
  'chat.piExtensionUi.noLongerPending': 'To pytanie nie oczekuje już na odpowiedź.',
  'chat.piExtensionUi.tryAgain': 'Spróbuj ponownie za chwilę.',
  'chat.piExtensionUi.answered': 'Odpowiedziano',
  'chat.piExtensionUi.cancelled': 'Anulowano',
  'chat.piExtensionUi.questionFallback': 'Pytanie',
  'chat.piExtensionUi.confirmAria': 'Potwierdzenie rozszerzenia',
  'chat.piExtensionUi.chooseOption': 'Wybierz opcję, aby włączyć Wyślij.',
  'chat.piPlan.agent': 'Agent',
  'chat.piPlan.plan': 'Plan',
  'chat.piPlan.toggleAria': 'Tryb Agent lub Plan',
  'chat.piPlan.build': 'Build',
  'chat.piPlan.building': 'Budowanie…',
  'chat.piPlan.buildModelAria': 'Model dla Build',
  'chat.piPlan.actionFailed': 'Nie udało się przełączyć na Plan. Ponownie wczytaj sesję i spróbuj jeszcze raz.',
  'chat.piPlan.buildFailed': 'Nie udało się rozpocząć Build',
  'chat.piPlan.discard': 'Odrzuć',
  'chat.piPlan.discardFailed': 'Nie udało się odrzucić planu',
  'chat.piPlan.discardConfirmTitle': 'Odrzucić ten plan?',
  'chat.piPlan.discardConfirmDescription': 'To usunie gotowy lub zapisany plan z sesji.',
  'chat.piPlan.discardConfirm': 'Odrzuć',
  ...
  'chat.piPlan.readySelect.implementFreshDescription': 'Otwórz nową powiązaną sesję i przenieś tylko zatwierdzony plan.',
  'chat.piPlan.readySelect.export': 'Eksportuj plan…',
  'chat.piPlan.readySelect.save': 'Zapisz na później',
  'chat.piPlan.readySelect.stay': 'Pozostań w trybie Plan',
  'chat.piPlan.readySelect.exit': 'Odrzuć plan i wyjdź',
  'chat.tool.planModeComplete': 'Tryb Plan zakończony',
  'chat.tool.planEnter': 'Tryb Plan',
  'chat.tool.planExit': 'Tryb Build',
  'chat.piGoal.button': 'Goal',
  'chat.piGoal.buttonAria': 'Uruchom Goal',
  'chat.piGoal.dialog.title': 'Uruchom Goal',
  'chat.piGoal.dialog.objectiveLabel': 'Cel',
  'chat.piGoal.dialog.objectivePlaceholder': 'Co ma osiągnąć agent?',
  'chat.piGoal.dialog.submit': 'Uruchom',
  'chat.piGoal.dialog.cancel': 'Anuluj',
  'chat.piGoal.dialog.exitPlan': 'Zakończ Plan',
  'chat.piGoal.dialog.aria': 'Uruchom Goal',
  ...
  'chat.piGoal.error.planActive': 'Tryb Plan jest aktywny. Zakończ Plan, zanim uruchomisz Goal.',
  ...
  'chat.messageBody.forkDialog.title': 'Rozpocznij nową sesję',
  ...
  'chat.messageBody.forkDialog.createWorktree': 'Utwórz worktree',
  ...
  'chat.messageBody.toast.planSavedWithPath': 'Zapisano plan w {path}',
  ...
  'chat.messageBody.toast.noImageToSave': 'Ta wiadomość nie ma obrazu do zapisania.',
  ...
  'onboarding.localSetup.dialog.selectOpencodeBinary': 'Wybierz binarkę pi',
  ...
  'onboarding.localSetup.status.detected': 'Znaleziono Pi w {path}',
  'onboarding.localSetup.windows.hintDetectionFailed': 'Jeśli wykrywanie nie powiedzie się, ustaw natywną ścieżkę, np. ~/.local/bin/pi.',
  'onboarding.localSetup.hint.ensurePath': 'Juz zainstalowane? Upewnij się, że pi jest w twoim PATH.',
  'onboarding.localSetup.hint.setEnv': 'Lub ustaw zmienną środowiskową PI_BINARY.',
  ...
  'agentManager.detail.actions.copyWorktreePath': 'Kopiuj ścieżkę worktree',
  'agentManager.detail.actions.keepThisRemoveOthers': 'Zostaw to, usuń pozostałe',
  'agentManager.detail.actions.removeThisWorktree': 'Usuń to worktree',
  'agentManager.detail.actions.worktreeActionsAria': 'Akcje worktree',
  'agentManager.detail.dialog.cancel': 'Anuluj',
  'agentManager.detail.dialog.remove': 'Usuń',
  'agentManager.detail.dialog.removeOtherWorktreesDescription': 'Zachować „{label}” i usunąć pozostałe worktree w „{group}”?',
  'agentManager.detail.dialog.removeOtherWorktreesTitle': 'Usuń pozostałe worktree',
  'agentManager.detail.dialog.removeOthers': 'Usuń pozostałe',
  'agentManager.detail.dialog.removeWorktreeDescription': 'Usunąć „{label}”? Spowoduje to usunięcie wszystkich sesji w tym worktree i samego worktree.',
  'agentManager.detail.dialog.removeWorktreeTitle': 'Usuń worktree',
  ...
  'agentManager.detail.toast.failedToFullyRemoveWorktree': 'Nie udało się całkowicie usunąć worktree',
  'agentManager.detail.toast.noWorktreePath': 'Brak dostępnej ścieżki worktree',
  'agentManager.detail.toast.otherWorktreesRemoved': 'Usunięto pozostałe worktree',
  'agentManager.detail.toast.removingOtherWorktrees': 'Usuwanie pozostałych drzew pracy...',
  'agentManager.detail.toast.removingWorktree': 'Usuwanie worktree...',
  'agentManager.detail.toast.worktreePathCopied': 'Ścieżka worktree skopiowana',
  'agentManager.detail.toast.worktreeRemoved': 'Worktree usunięte',
  ...
  'agentManager.empty.groupName.description': 'Używane do nazwy katalogu worktree i gałęzi',
  ...
  'agentManager.empty.setupCommands.description': 'Polecenia uruchamiane w każdym nowym worktree. Użyj $ROOT_PROJECT_PATH dla katalogu projektu.',
  ...
  'branchPickerDialog.actions.createWorktreeAria': 'Utwórz worktree z gałęzi',
  'branchPickerDialog.actions.deleteAria': 'Usuń gałąź',
  'branchPickerDialog.actions.deletePrompt': 'Usuń',
  'branchPickerDialog.actions.deleteWorktreeAria': 'Usuń worktree',
  ...
  'branchPickerDialog.error.createWorktreeFailed': 'Nie udało się utworzyć worktree',
  ...
  'branchPickerDialog.toast.failedToCreateWorktree': 'Nie udało się utworzyć worktree',
  ...
  'branchPickerDialog.toast.worktreeCreated': 'Worktree utworzone',
  'branchPickerDialog.tooltip.createWorktree': 'Utwórz worktree',
  ...
  'branchPickerDialog.tooltip.deleteWorktree': 'Usuń worktree',
  'branchPickerDialog.tooltip.deleteWorktreeRootProtected': 'Nie można usunąć głównego worktree',
  ...
  'branchPickerDialog.tooltip.worktreeAlreadyExists': 'Worktree już istnieje',
  ...
  'chat.chatInput.placeholder.chatPi': '@ dla plików/agentów; / dla poleceń i umiejętności; # dla fragmentów',
  'chat.chatInput.placeholder.chatCompact': 'Użyj @ / ! # dla pomocników',
  'chat.chatInput.placeholder.chatCompactPi': 'Użyj @ / # dla pomocników',
  ...
  'chat.dictation.unsupported': 'Dyktowanie nie jest obsługiwane w tym środowisku',
  'chat.dictation.disabled': 'Dyktowanie jest wyłączone w Ustawieniach',
  'chat.dictation.microphonePermissionDenied': 'Odmowa dostępu do mikrofonu',
  'chat.dictation.microphoneNotFound': 'Nie znaleziono mikrofonu',
  'chat.dictation.microphoneUnavailable': 'Nie można uzyskać dostępu do mikrofonu',
  'chat.dictation.startFailed': 'Nie można rozpocząć dyktowania',
  ...
  'chat.chatInput.toast.commandFailed': 'Nie udało się uruchomić tego polecenia.',
  'chat.chatInput.pendingPromptHint': 'Wyślij lub odrzuć kartę przed wysłaniem wiadomości.',
  ...
  'contextPanel.browser.hostAppBlocked': 'Nie można otworzyć aplikacji Pichamber w panelu przeglądarki.',
  ...
  'diffView.state.notGitRepository': 'To nie jest repozytorium Git. Diffy są dostępne, gdy ten folder jest repozytorium Git.',
  ...
  "diffView.branch.empty": "Brak zatwierdzonych zmian w tej gałęzi względem {base}",
  "diffView.branch.emptyExcludesWorkingTree": "Ten widok nie obejmuje drzewa roboczego. Niezatwierdzone pliki pozostają w Zmienionych.",
  ...
  'gitView.changes.revertFileDescription': 'Cofnąć lokalne zmiany w {path}? Tej operacji nie można cofnąć.',
  'gitView.changes.revertFile': 'Cofnij',
  ...
  'gitView.empty.notGitRepositoryDescription': 'Status Git jest dostępny, gdy ten folder jest repozytorium Git.',
  ...
  'worktree.bootstrap.toast.failed': 'Konfiguracja worktree nie powiodła się',
  'worktree.bootstrap.toast.failedDescription': 'Worktree zostało utworzone, ale konfiguracja w tle nie została ukończona.',
  'worktree.bootstrap.toast.timeoutDescription': 'Worktree zostało utworzone, ale konfiguracja w tle przekroczyła limit czasu.',
  ...
  'gitView.header.createPullRequest': 'Utwórz pull request',
  ...
  'gitView.worktree.availableInWorktreeMode': 'Dostępne tylko w trybie worktree',
  ...
  'header.services.openPi': 'Otwórz usługi',
  'header.services.openPiWithMcp': 'Otwórz usługi i MCP',
  ...
  'helpDialog.item.createNewWorktreeDraft': 'Utwórz nowy szkic worktree',
  ...
  'mcpDropdown.status.cached': 'Gotowy, jeszcze nie połączony',
  'mcpDropdown.status.disabled': 'Wyłączony',
  ...
  'planView.actions.sendToNewWorktreeSession': 'Wyślij do nowej sesji worktree',
  ...
  'projects.sharedTrust.description': '{path} w tym repozytorium definiuje polecenia uruchamiane na tym komputerze. Zaufaj raz, a Pichamber zapyta ponownie tylko wtedy, gdy się zmienią.',
  ...
  'rightSidebar.contextNotesTodo.sendDialog.title.newWorktree': 'Wyślij do nowego worktree',
  ...
  'rightSidebar.contextNotesTodo.toast.sentToNewWorktreeSession': 'Zadanie wysłane do nowej sesji worktree',
  'rightSidebar.contextNotesTodo.toast.worktreeRequiresGitRepo': 'Akcje worktree są dostępne tylko dla repozytoriów Git',
  ...
  'rightSidebar.contextNotesTodo.todo.sendMenu.newWorktreeSession': 'Wyślij do nowej sesji worktree',
  ...
  'saveProjectPlanDialog.description': 'Zapisz ten plan jako plik Markdown w folderze .pichamber/plans tego projektu.',
  ...
  'session.githubIssuePicker.actions.createInWorktree': 'Utwórz w worktree',
  ...
  'session.githubIssuePicker.actions.toggleWorktreeAria': 'Przełącz worktree',
  ...
  'session.newWorktree.actions.createWorktree': 'Utwórz worktree',
  ...
  'session.newWorktree.error.createWorktreeFailed': 'Nie udało się utworzyć worktree',
  ...
  'session.newWorktree.error.worktreeDirectoryRequired': 'Katalog worktree jest wymagany',
  ...
  'session.newWorktree.title': 'Nowy worktree',
  ...
  'session.newWorktree.toast.worktreeCreated': 'Worktree utworzone',
  ...
  'session.newWorktree.worktreeDirectory': 'Katalog worktree',
  ...
  'chat.workStatus.pinned.empty': 'Brak przypiętych wiadomości',
  ...
  'chat.workStatus.subagent.foreground': 'Pierwszy plan',
  'chat.workStatus.subagent.background': 'Tło',
  ...
  'chat.workStatus.action.openSubagentOwned': 'Otwórz {name} (część {parent})',
  'chat.workStatus.action.open': 'Otwórz',
  'chat.workStatus.subagent.unopenableTooltip': 'Brak sesji do otwarcia',
  'chat.workStatus.subagent.summarize': 'Post result to parent',
  'chat.workStatus.subagent.summarizeAgain': 'Wyślij wynik ponownie do sesji nadrzędnej',
  'chat.workStatus.subagent.summarizeAgainHint': 'Wyniki są odsyłane automatycznie po zakończeniu subagenta w tle. Użyj tylko, gdy przekazanie się nie udało.',
  'chat.workStatus.subagent.handoffMessage': 'Wynik subagenta „{name}” (użyj jako kontekst):\n{body}',
  'chat.workStatus.subagent.handoffEmpty': 'Subagent „{name}” zakończył się bez wyniku tekstowego; otwórz jego sesję, aby zobaczyć szczegóły.',
  ...
  'chat.workStatus.kimi.membership.free': 'Darmowy',
  'chat.workStatus.kimi.membership.basic': 'Podstawowy',
  'chat.workStatus.kimi.membership.intermediate': 'Średni',
  'chat.workStatus.kimi.membership.advanced': 'Zaawansowany',
