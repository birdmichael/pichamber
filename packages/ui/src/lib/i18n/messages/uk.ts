...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.message.context.previewConsole': 'Журнали dev-сервера ({file})',
  ...
  "mobile.changes.diffDetail.missingDescription": "Поверніться до Git і оновіть список.",
  "mobile.changes.diffDetail.imageUnavailable": "Image diffs поки недоступні в мобільному Git.",
  ...
  "multirun.compare.title": "Порівняти запуски",
  "multirun.compare.subtitleSingle": "{count} запуск",
  "multirun.compare.subtitlePlural": "{count} запусків",
  "multirun.compare.actions.openRun": "Відкрити",
  "multirun.compare.actions.close": "Закрити",
  "multirun.compare.empty": "У цій групі ще немає запусків.",
  "multirun.compare.run.loading": "Завантаження цього запуску…",
  "multirun.compare.run.empty": "Повідомлень ще немає.",
  "multirun.compare.run.missingDirectory": "У цього запуску немає каталогу, тому історію не можна завантажити.",
  "multirun.compare.status.running": "Виконується",
  "multirun.compare.status.idle": "Очікує",
  "multirun.compare.role.user": "Ви",
  "multirun.compare.role.assistant": "Асистент",
  "multirun.launcher.attachments.label": "Файли",
  "multirun.launcher.actions.startWithRunCount": "Запустити ({count} запусків)",
  "multirun.launcher.actions.startWithRunCountSingle": "Запустити ({count} запуск)",
  "multirun.launcher.actions.startWithRunCountPlural": "Запустити ({count} запусків)",
  ...
  "sessions.sidebar.footer.actions.refresh": "Оновити",
  "sessions.sidebar.footer.refresh.tooltip": "Перезавантажити список сесій і відкриту розмову",
  "sessions.sidebar.footer.refresh.aria": "Перезавантажити список сесій і відкриту розмову",
  "sessions.sidebar.footer.refresh.disabledBusy": "Оновлення недоступне, поки сесія відповідає",
  "sessions.sidebar.footer.refresh.disabledCompacting": "Оновлення недоступне під час стиснення контексту",
  "sessions.sidebar.footer.refresh.disabledInFlight": "Оновлення списку сесій і відкритої розмови",
  "sessions.sidebar.footer.refresh.success": "Список сесій і відкриту розмову оновлено",
  "sessions.sidebar.footer.refresh.failed": "Не вдалося оновити сесії",
  ...
  "sessions.sidebar.session.menu.exportJsonl": "Експортувати JSONL",
  "sessions.sidebar.session.menu.exportHtml": "Експортувати HTML",
  "sessions.sidebar.header.actions.importSession": "Імпортувати сеанс",
  "sessions.sidebar.session.import.success": "Сеанс імпортовано",
  "sessions.sidebar.session.import.failed": "Не вдалося імпортувати сеанс",
  "sessions.sidebar.session.export.failed": "Не вдалося експортувати сеанс",
  ...
  "sessions.sidebar.session.moveToWorktree.tooltipTargets": "Показує наявні worktree і опцію створити новий для цієї сесії.",
  "sessions.sidebar.session.moveToWorktree.confirm.title": "У джерелі є незакомічені зміни",
  "sessions.sidebar.session.moveToWorktree.confirm.changedFiles": "Змінені файли в цьому worktree: {count}.",
  "sessions.sidebar.session.moveToWorktree.confirm.ownership": "Pichamber відстежує ці зміни за каталогом, а не за сесією.",
  "sessions.sidebar.session.moveToWorktree.confirm.sessionOnlyHelp": "Переносить лише цю сесію та її підсесії, не змінюючи файли джерела.",
  "sessions.sidebar.session.moveToWorktree.confirm.allChangesHelp": "Переносить зміни з каталогу сесії. Після успіху незастейджені й невідстежувані файли залишають джерело.",
  "sessions.sidebar.session.moveToWorktree.confirm.stagedWarning": "Застейджені зміни лишаються в джерелі й копіюються в призначення.",
  "sessions.sidebar.session.moveToWorktree.confirm.baseWarning": "Перенесення може не вдатися, якщо призначення має іншу базу Git.",
  "sessions.sidebar.session.moveToWorktree.confirm.sessionOnly": "Перенести лише сесію",
  "sessions.sidebar.session.moveToWorktree.confirm.allChanges": "Перенести всі зміни джерела",
  "sessions.sidebar.session.moveToWorktree.confirm.cancel": "Скасувати",
  "sessions.sidebar.session.moveToWorktree.sourceVerificationFailed": "Не вдалося перевірити зміни джерела. Worktree і сесію не змінено.",
  "sessions.sidebar.session.moveToWorktree.applyChangesFailed": "Призначення не прийняло зміни джерела. Сесію й зміни не перенесено. Повторіть і виберіть «Перенести лише сесію».",
  "sessions.sidebar.session.moveToWorktree.changesMayBeInDestination": "З’єднання обірвалось до підтвердження. Сесія могла не перенестись, а незакомічені зміни вже можуть бути в цільовому worktree. Перевірте перед повторною спробою.",
  "sessions.sidebar.session.menu.compareRuns": "Порівняти запуски",
  ...
  "sessions.sidebar.group.actions.compareRuns": "Порівняти запуски",
  "sessions.sidebar.group.actions.compareRunsAria": "Порівняти запуски в {label}",
  ...
  "gitView.changes.revertFileDialogTitle": "Скасувати зміни файлу?",
  "gitView.changes.revertFileDescription": "Скасувати локальні зміни в {path}? Це не можна скасувати.",
  "gitView.changes.revertFile": "Скасувати",
  ...
  "gitView.header.createPullRequest": "Створити pull request",
  ...
  "gitView.empty.notGitRepositoryDescription": "Статус Git доступний, коли ця папка є репозиторієм Git.",
  ...
  "gitView.pullRequest.detachedHeadHint": "Відокремлений HEAD — спочатку створіть гілку.",
  ...
  "contextPanel.browser.hostAppBlocked": "Не можна відкрити застосунок Pichamber у панелі браузера.",
  ...
  "filesView.editor.save": "Зберегти",
  ...
  "diffView.state.notGitRepository": "Це не Git-репозиторій. Diff доступний, коли ця папка є репозиторієм Git.",
  ...
  "diffView.branch.empty": "Немає закомічених змін у цій гілці відносно {base}",
  "diffView.branch.emptyExcludesWorkingTree": "Цей перегляд не включає робоче дерево. Невідправлені файли залишаються в Змінених.",
  ...
  'chat.dictation.unsupported': 'Диктування не підтримується в цьому середовищі',
  'chat.dictation.disabled': 'Диктування вимкнено в Параметрах',
  'chat.dictation.microphonePermissionDenied': 'Відмовлено в доступі до мікрофона',
  'chat.dictation.microphoneNotFound': 'Мікрофон не знайдено',
  'chat.dictation.microphoneUnavailable': 'Неможливо отримати доступ до мікрофона',
  'chat.dictation.startFailed': 'Не вдалося почати диктування',
  ...
  "header.services.openPi": "Відкрити сервіси",
  "header.services.openPiWithMcp": "Відкрити сервіси та MCP",
  ...
  "chat.promptNavigator.openTimeline": "Хронологія сесії",
  ...
  "chat.timeline.title": "Хронологія сесії",
  ...
  "chat.commandAutocomplete.command.btwDescription": "Поставте побічне запитання в тимчасовій дочірній сесії, не збиваючи цю розмову з курсу.",
  ...
  "chat.commandAutocomplete.command.runDescription": "Запустити субагента як одноразовий робочий процес",
  ...
  "chat.fileMentionAutocomplete.empty": "Файлів або агентів не знайдено",
  ...
  "chat.btw.mainComposerPlaceholder": "Запитайте в цій сесії btw…",
  "chat.btw.loading": "Запуск сесії btw…",
  "chat.btw.toast.emptyArgument": "Введіть запитання після /btw",
  "chat.btw.toast.createFailed": "Не вдалося запустити сесію btw",
  "chat.btw.toast.destroyFailed": "Не вдалося знищити сесію btw. Вона залишиться на бічній панелі.",
  "chat.btw.working": "Працює…",
  "chat.btw.collapseAria": "Згорнути панель btw",
  "chat.btw.expandAria": "Розгорнути панель btw",
  "chat.btw.promoteAria": "Залишити як звичайну сесію",
  "chat.btw.toast.promoteFailed": "Не вдалося залишити сесію btw як звичайну сесію",
  ...
  "chat.piExtensionUi.inputNeeded": "Потрібна відповідь",
  "chat.piExtensionUi.selectMultiple": "Множинний вибір",
  "chat.piExtensionUi.other": "Інше…",
  "chat.piExtensionUi.yourAnswer": "Ваша відповідь",
  "chat.piExtensionUi.submit": "Надіслати",
  "chat.piExtensionUi.dismiss": "Відхилити",
  "chat.piExtensionUi.confirm": "Підтвердити",
  "chat.piExtensionUi.cancel": "Скасувати",
  "chat.piExtensionUi.submitFailed": "Не вдалося надіслати відповідь",
  "chat.piExtensionUi.dismissFailed": "Не вдалося відхилити запитання",
  "chat.piExtensionUi.noLongerPending": "Це запитання більше не очікує відповіді.",
  "chat.piExtensionUi.tryAgain": "Спробуйте ще раз за мить.",
  "chat.piExtensionUi.answered": "Відповіли",
  "chat.piExtensionUi.cancelled": "Скасовано",
  "chat.piExtensionUi.questionFallback": "Запитання",
  "chat.piExtensionUi.confirmAria": "Підтвердження розширення",
  "chat.piExtensionUi.chooseOption": "Оберіть варіант, щоб увімкнути Надіслати.",
  "chat.piPlan.agent": "Агент",
  "chat.piPlan.plan": "План",
  "chat.piPlan.toggleAria": "Режим Агент або План",
  "chat.piPlan.build": "Build",
  "chat.piPlan.building": "Збирання…",
  "chat.piPlan.buildModelAria": "Модель для Build",
  "chat.piPlan.actionFailed": "Не вдалося перемкнутися на План. Перезавантажте сеанс і спробуйте ще раз.",
  "chat.piPlan.buildFailed": "Не вдалося почати Build",
  "chat.piPlan.discard": "Відхилити",
  "chat.piPlan.discardFailed": "Не вдалося відхилити план",
  "chat.piPlan.discardConfirmTitle": "Відхилити цей план?",
  "chat.piPlan.discardConfirmDescription": "Це очистить готовий або збережений план із сесії.",
  "chat.piPlan.discardConfirm": "Відхилити",
  ...
  "chat.piPlan.readySelect.title": "План готовий. Що далі? Реалізувати тут продовжить цю сесію як Агент. Почати наново перенесе лише затверджений план у нову сесію.",
  "chat.piPlan.readySelect.implementHere": "Реалізувати тут",
  "chat.piPlan.readySelect.implementHereDescription": "Продовжити в цій сесії з розмовою планування.",
  "chat.piPlan.readySelect.implementFresh": "Почати наново й реалізувати",
  "chat.piPlan.readySelect.implementFreshDescription": "Відкрити нову пов’язану сесію та перенести лише затверджений план.",
  "chat.piPlan.readySelect.export": "Експортувати план…",
  "chat.piPlan.readySelect.save": "Зберегти на потім",
  "chat.piPlan.readySelect.stay": "Залишитися в режимі Плану",
  "chat.piPlan.readySelect.exit": "Відхилити план і вийти",
  "chat.tool.planModeComplete": "Режим Плану завершено",
  "chat.tool.planEnter": "Режим Плану",
  "chat.tool.planExit": "Режим Build",
  "chat.piGoal.button": "Goal",
  "chat.piGoal.buttonAria": "Запустити Goal",
  "chat.piGoal.dialog.title": "Запустити Goal",
  "chat.piGoal.dialog.objectiveLabel": "Мета",
  "chat.piGoal.dialog.objectivePlaceholder": "Що має досягти агент?",
  "chat.piGoal.dialog.submit": "Запустити",
  "chat.piGoal.dialog.cancel": "Скасувати",
  "chat.piGoal.dialog.exitPlan": "Вийти з Plan",
  "chat.piGoal.dialog.aria": "Запустити Goal",
  "chat.piGoal.error.empty": "Введіть мету, щоб запустити Goal.",
  ...
  "chat.piGoal.error.planActive": "Режим Plan активний. Вийдіть із Plan, перш ніж запускати Goal.",
  ...
  "chat.messageBody.forkDialog.title": "Почати нову сесію",
  ...
  "chat.messageBody.toast.planSavedWithPath": "План збережено в {path}",
  ...
  "chat.messageBody.toast.noImageToSave": "У цьому повідомленні немає зображення для збереження.",
  ...
  "chat.chatInput.placeholder.chatPi": "@ для файлів/агентів; / для команд і навичок; # для сніпетів",
  "chat.chatInput.placeholder.chatCompact": "Використовуйте @ / ! # для помічників",
  "chat.chatInput.placeholder.chatCompactPi": "Використовуйте @ / # для помічників",
  ...
  "chat.chatInput.toast.unknownCommand": "Ця команда ще недоступна.",
  "chat.chatInput.toast.commandFailed": "Не вдалося виконати цю команду.",
  "chat.chatInput.pendingPromptHint": "Надішліть або відхиліть картку перед надсиланням.",
  ...
  "commandPalette.description": "Пошук сесій, дій і файлів.",
  "commandPalette.input.placeholder": "Пошук сесій, дій, файлів...",
  ...
  "saveProjectPlanDialog.description": "Збережіть цей план як файл Markdown у теці .pichamber/plans цього проєкту.",
  ...
  "projects.sharedTrust.description": "{path} у цьому репозиторії містить команди, які виконуються на цьому комп'ютері. Довірте їх один раз, і Pichamber запитає знову лише коли вони зміняться.",
  ...
  "mcpDropdown.status.cached": "Готово, ще не підключено",
  "mcpDropdown.status.disabled": "Вимкнено",
  ...
  "onboarding.localSetup.dialog.selectOpencodeBinary": "Вибрати виконуваний файл pi",
  ...
  "onboarding.localSetup.status.detected": "Pi знайдено в {path}",
  ...
  "onboarding.localSetup.windows.hintDetectionFailed": "Якщо виявлення не вдається, укажіть нативний шлях, наприклад ~/.local/bin/pi.",
  "onboarding.localSetup.hint.ensurePath": "Вже встановлено? Переконайтеся, що pi знаходиться у вашому PATH.",
  "onboarding.localSetup.hint.setEnv": "Або встановіть змінну середовища PI_BINARY.",
  ...
  "updateDialog.error.takingLonger": "Оновлення триває довше, ніж очікувалося. Зачекайте трохи та оновіть або запустіть: pichamber update",
  ...
  'chat.workStatus.subagent.foreground': 'Передній план',
  'chat.workStatus.subagent.background': 'Фон',
  'chat.workStatus.subagent.blocked': 'заблоковано',
  'chat.workStatus.subagent.failed': 'збій',
  'chat.workStatus.subagent.paused': 'призупинено',
  'chat.workStatus.subagent.queued': 'в черзі',
  'chat.workStatus.subagent.stopped': 'зупинено',
  ...
  'chat.workStatus.subagent.namedForeground': '{name} · Передній план',
  'chat.workStatus.subagent.namedBackground': '{name} · Фон',
  ...
  'chat.workStatus.action.openSubagentOwned': 'Відкрити {name} (частина {parent})',
  'chat.workStatus.action.open': 'Відкрити',
  'chat.workStatus.subagent.unopenableTooltip': 'Немає сеансу, який можна відкрити',
  'chat.workStatus.subagent.summarize': 'Post result to parent',
  'chat.workStatus.subagent.summarizeAgain': 'Надіслати результат до батьківського сеансу знову',
  'chat.workStatus.subagent.summarizeAgainHint': 'Результати повертаються автоматично, коли фоновий субагент завершується. Використовуйте лише якщо передачу пропущено.',
  'chat.workStatus.subagent.handoffMessage': 'Результат субагента «{name}» (використовуйте як контекст):\n{body}',
  'chat.workStatus.subagent.handoffEmpty': 'Субагент «{name}» завершився без текстового результату; відкрийте його сеанс для деталей.',
  ...
  'chat.workStatus.kimi.membership.free': 'Безкоштовний',
  'chat.workStatus.kimi.membership.basic': 'Базовий',
  'chat.workStatus.kimi.membership.intermediate': 'Середній',
  'chat.workStatus.kimi.membership.advanced': 'Просунутий',
  'chat.workStatus.kimi.membership.professional': 'Професійний',
  'chat.workStatus.kimi.membership.enterprise': 'Корпоративний',
  'chat.workStatus.kimi.window.weekly': 'Тиждень',
