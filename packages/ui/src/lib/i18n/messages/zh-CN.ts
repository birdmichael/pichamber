...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.subagentsComposer.role': '角色',
  'chat.subagentsComposer.model': '模型',
  'chat.subagentsComposer.thinking': '思考',
  'chat.subagentsComposer.launch': '运行',
  'chat.subagentsComposer.launching': '运行中…',
  'chat.subagentsComposer.taskPrompt': '请输入子代理任务',
  'chat.subagentsComposer.missingSessionOrModel': '请先打开会话并选择模型，再运行子代理。',
  'chat.subagentsComposer.launchFailed': '无法运行子代理。',
