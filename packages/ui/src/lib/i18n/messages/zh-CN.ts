...
export const dict: Record<I18nKey, string> = {
  ...
  'terminalView.toast.pasteFailed': '无法读取剪贴板。请改用粘贴快捷键。',
  ...
  'chat.message.context.previewConsole': '开发服务器日志（{file}）',
  ...
  'mobile.sessions.activeWorktreeAria': '活动 worktree',
  ...
  'mobile.sessions.editOrderHint': '拖动手柄以重新排序项目。点按项目可显示其 worktree 并同样拖动排序。点按对勾完成。',
  ...
  'mobile.projectEdit.worktreesEmpty': '此项目还没有 worktree。',
  'mobile.projectEdit.reorderHint': '拖动以重新排序 worktree。',
  'mobile.projectEdit.dragWorktreeAria': '拖动 {label} 以重新排序',
  'mobile.projectEdit.deleteWorktreeAria': '移除 worktree {label}',
  'mobile.projectEdit.deleteWorktreeTitle': '移除 worktree',
  'mobile.projectEdit.deleteWorktreeConfirmButton': '移除',
  'mobile.projectEdit.deleteWorktreeConfirm': '移除 worktree “{name}”？此操作无法撤销。',
  'mobile.projectEdit.deleteWorktreeDirty': '此 worktree 有未提交的更改，将会丢失。',
  ...
  'mobile.changes.diffDetail.missingDescription': '返回 Git 并刷新列表。',
  'mobile.changes.diffDetail.imageUnavailable': '移动 Git 暂不支持图片 diff。',
  ...
  'multirun.launcher.groupName.info': '用于 worktree 目录和分支名称',
  ...
  'multirun.compare.title': '对比运行',
  'multirun.compare.subtitleSingle': '{count} 个运行',
  'multirun.compare.subtitlePlural': '{count} 个运行',
  'multirun.compare.actions.openRun': '打开',
  'multirun.compare.actions.close': '关闭',
  'multirun.compare.empty': '此组还没有运行。',
  'multirun.compare.run.loading': '正在加载此运行…',
  'multirun.compare.run.empty': '还没有消息。',
  'multirun.compare.run.missingDirectory': '此运行没有目录，无法加载对话。',
  'multirun.compare.status.running': '进行中',
  'multirun.compare.status.idle': '空闲',
  'multirun.compare.role.user': '你',
  'multirun.compare.role.assistant': '助手',
  'multirun.launcher.attachments.label': '文件',
  'multirun.launcher.actions.startWithRunCount': '开始（{count} 次运行）',
  'multirun.launcher.actions.startWithRunCountSingle': '开始（{count} 次运行）',
  'multirun.launcher.actions.startWithRunCountPlural': '开始（{count} 次运行）',
  ...
  'sessions.sidebar.footer.actions.refresh': '刷新',
  'sessions.sidebar.footer.refresh.tooltip': '重新加载会话列表和当前对话',
  'sessions.sidebar.footer.refresh.aria': '重新加载会话列表和当前对话',
  'sessions.sidebar.footer.refresh.disabledBusy': '会话正在回复，无法刷新',
  'sessions.sidebar.footer.refresh.disabledCompacting': '正在压缩上下文，无法刷新',
  'sessions.sidebar.footer.refresh.disabledInFlight': '正在刷新会话列表和当前对话',
  'sessions.sidebar.footer.refresh.success': '已重新加载会话列表和当前对话',
  'sessions.sidebar.footer.refresh.failed': '刷新会话失败',
  ...
  'sessions.sidebar.header.grouping.byWorktree': '按 worktree',
  ...
  'sessions.sidebar.project.actions.manageWorktrees': '管理 worktree',
  'sessions.worktreesPage.title': '{project} 的 worktree',
  'sessions.worktreesPage.description': '创建、查看和删除此项目的 git worktree。',
  'sessions.worktreesPage.closeAria': '关闭 worktree',
  ...
  'sessions.sidebar.project.actions.newWorktree': '新建 worktree',
  'sessions.sidebar.project.actions.newWorktreeEllipsis': '新建 worktree...',
  ...
  'sessions.sidebar.session.menu.exportJsonl': '导出 JSONL',
  'sessions.sidebar.session.menu.exportHtml': '导出 HTML',
  'sessions.sidebar.header.actions.importSession': '导入会话',
  'sessions.sidebar.session.import.success': '会话已导入',
  'sessions.sidebar.session.import.failed': '导入会话失败',
  'sessions.sidebar.session.export.failed': '导出会话失败',
  'sessions.sidebar.session.menu.moveToWorktree': '移至新 worktree',
  'sessions.sidebar.session.moveToWorktree.success': '会话已移至新 worktree',
  'sessions.sidebar.session.moveToWorktree.failed': '无法将会话移至新 worktree',
  'sessions.sidebar.session.moveToWorktree.tooltip': '从当前分支创建新 worktree，转移未提交的更改，并将此会话及其子会话移至其中。',
  'sessions.sidebar.session.moveToWorktree.tooltipBusy': '仅在会话空闲时可用。请停止当前活动或等待其完成。',
  'sessions.sidebar.session.moveToWorktree.tooltipMoving': '此会话已在移至新 worktree。',
  'sessions.sidebar.session.menu.moveToWorktreeTargets': '移至 worktree',
  'sessions.sidebar.session.moveToWorktree.main': '主 worktree',
  'sessions.sidebar.session.moveToWorktree.refreshing': '正在刷新 worktree…',
  'sessions.sidebar.session.moveToWorktree.loadFailed': '无法加载 worktree',
  'sessions.sidebar.session.moveToWorktree.current': '当前 worktree',
  'sessions.sidebar.session.moveToWorktree.existingSuccess': '会话已移至 worktree',
  'sessions.sidebar.session.moveToWorktree.existingFailed': '无法将会话移至 worktree',
  'sessions.sidebar.session.moveToWorktree.tooltipTargets': '显示已有 worktree，以及为此会话新建一个的选项。',
  'sessions.sidebar.session.moveToWorktree.confirm.title': '源目录有未提交的更改',
  'sessions.sidebar.session.moveToWorktree.confirm.changedFiles': '此 worktree 中已更改的文件：{count}。',
  'sessions.sidebar.session.moveToWorktree.confirm.ownership': 'Pichamber 按目录跟踪这些更改，而不是按会话。',
  'sessions.sidebar.session.moveToWorktree.confirm.sessionOnlyHelp': '只移动此会话及其子会话，源文件保持不变。',
  'sessions.sidebar.session.moveToWorktree.confirm.allChangesHelp': '转移会话目录下的更改。成功后未暂存和未跟踪的文件会离开源目录。',
  'sessions.sidebar.session.moveToWorktree.confirm.stagedWarning': '已暂存的更改会留在源目录，并复制到目标。',
  'sessions.sidebar.session.moveToWorktree.confirm.baseWarning': '目标使用不同 Git 基线时，转移可能失败。',
  ...
  'sessions.sidebar.session.moveToWorktree.sourceVerificationFailed': '无法核实源更改。未改动 worktree 或会话。',
  'sessions.sidebar.session.moveToWorktree.applyChangesFailed': '目标无法接受源更改。会话和源更改均未移动。请重试并选择“仅移动会话”。',
  'sessions.sidebar.session.moveToWorktree.changesMayBeInDestination': '目标确认移动前连接中断。会话可能未移动，未提交更改可能已在目标 worktree。重试前请先检查那里。',
  'sessions.sidebar.session.menu.compareRuns': '对比运行',
  ...
  'sessions.sidebar.session.status.movingToWorktree': '正在将会话移至新 worktree',
  ...
  'sessions.sidebar.dialogs.worktreeDelete.descriptionNoLinked': '这将移除所选 worktree。',
  'sessions.sidebar.dialogs.worktreeDelete.descriptionOneLinked': '这将移除所选 worktree 并归档 {count} 个关联会话。',
  'sessions.sidebar.dialogs.worktreeDelete.descriptionManyLinked': '这将移除所选 worktree 并归档 {count} 个关联会话。',
  ...
  'sessions.sidebar.group.actions.compareRuns': '对比运行',
  'sessions.sidebar.group.actions.compareRunsAria': '对比 {label} 中的运行',
  'sessions.sidebar.group.actions.deleteWorktree': '删除 worktree',
  ...
  'sessions.sidebar.sessionDialogs.delete.note': 'worktree 目录会保留。与所选会话关联的子会话也会被删除。',
  ...
  'sessions.sidebar.sessionDialogs.worktree.errorRemoveTitle': '移除 worktree 失败',
  ...
  'sessions.sidebar.sessionDialogs.worktree.removedWithRemote': 'worktree 和远程分支已移除。',
  'sessions.sidebar.sessionDialogs.worktree.attachedArchived': '关联 worktree 已归档。',
  'sessions.sidebar.sessionDialogs.worktree.attachedArchivedPlural': '关联 worktree 已归档。',
  'sessions.sidebar.sessionDialogs.worktree.archivedAndRemoteRemoved': 'worktree 已归档且远程分支已移除。',
  'sessions.sidebar.sessionDialogs.worktree.label': 'worktree',
  'sessions.sidebar.sessionDialogs.worktree.pathUnavailable': 'worktree 路径不可用。',
  ...
  'sessions.sidebar.sessionDialogs.actions.deleteWorktree': '删除 worktree',
  ...
  'gitView.changes.revertFileDescription': '还原 {path} 的本地更改？此操作无法撤销。',
  'gitView.changes.revertFile': '还原',
  ...
  'gitView.header.createPullRequest': '创建拉取请求',
  ...
  'gitView.empty.notGitRepositoryDescription': '当前文件夹是 Git 仓库时才会显示 Git 状态。',
  ...
  'worktree.bootstrap.toast.failed': 'worktree 设置失败',
  'worktree.bootstrap.toast.failedDescription': 'worktree 已创建，但后台设置未完成。',
  'worktree.bootstrap.toast.timeoutDescription': 'worktree 已创建，但后台设置超时。',
  ...
  'gitView.pullRequest.detachedHeadHint': '当前为分离的 HEAD，请先创建分支。',
  ...
  'gitView.worktree.availableInWorktreeMode': '仅在 worktree 模式下可用',
  ...
  'walkthrough.blocked.noModel.title': '没有可用的评审模型',
  'walkthrough.blocked.noModel.description': '请在 ~/.pi/agent（auth.json 与 models.json）中配置提供方后再生成评审。',
  ...
  'planView.state.noPlanYet': '还没有计划',
  ...
  'diffView.state.notGitRepository': '当前不是 Git 仓库。当前文件夹是 Git 仓库时才会显示差异。',
  ...
  "diffView.branch.empty": "此分支相对于 {base} 没有已提交的更改",
  "diffView.branch.emptyExcludesWorkingTree": "此视图不含工作区。未提交的文件仍在「已更改」中。",
  ...
  'header.services.openPi': '打开服务',
  'header.services.openPiWithMcp': '打开服务和 MCP',
  ...
  'session.newWorktree.error.worktreeDirectoryRequired': 'worktree 目录为必填项',
  ...
  'chat.changedFiles.actions.showMore': '显示另外 {count} 个',
  ...
  'chat.emptyState.draftTitleWithProject': '我们在 {project} 做什么？',
  ...
  'chat.promptNavigator.openTimeline': '会话时间线',
  ...
  'chat.commandAutocomplete.command.runDescription': '运行一个子智能体（一次性工作流）',
  ...
  'chat.commandAutocomplete.keyboardHintEmpty': 'Esc 关闭',
  ...
  'chat.fileMentionAutocomplete.empty': '未找到文件或智能体',
  ...
  'chat.btw.toast.emptyArgument': '请在 /btw 后输入问题',
  'chat.btw.toast.createFailed': '无法启动 btw 会话',
  'chat.btw.toast.destroyFailed': '无法销毁 btw 会话。它将保留在侧边栏中。',
  'chat.btw.working': '处理中…',
  'chat.btw.collapseAria': '折叠 btw 面板',
  'chat.btw.expandAria': '展开 btw 面板',
  'chat.btw.promoteAria': '保留为普通会话',
  'chat.btw.toast.promoteFailed': '无法将 btw 会话保留为普通会话',
  ...
  'chat.piExtensionUi.inputNeeded': '需要输入',
  'chat.piExtensionUi.selectMultiple': '多选',
  'chat.piExtensionUi.other': '其他…',
  'chat.piExtensionUi.yourAnswer': '你的回答',
  'chat.piExtensionUi.submit': '提交',
  'chat.piExtensionUi.dismiss': '关闭',
  'chat.piExtensionUi.confirm': '确认',
  'chat.piExtensionUi.cancel': '取消',
  'chat.piExtensionUi.submitFailed': '发送回答失败',
  'chat.piExtensionUi.dismissFailed': '关闭问题失败',
  'chat.piExtensionUi.noLongerPending': '该问题已不再等待回复。',
  'chat.piExtensionUi.tryAgain': '请稍后重试。',
  'chat.piExtensionUi.answered': '已回答',
  'chat.piExtensionUi.cancelled': '已取消',
  'chat.piExtensionUi.questionFallback': '问题',
  'chat.piExtensionUi.confirmAria': '扩展确认',
  'chat.piExtensionUi.chooseOption': '请先选择一项以启用提交。',
  'chat.piPlan.agent': '智能体',
  'chat.piPlan.plan': '计划',
  'chat.piPlan.toggleAria': '智能体或计划模式',
  'chat.piPlan.build': '构建',
  'chat.piPlan.building': '正在构建…',
  'chat.piPlan.buildModelAria': '构建所用模型',
  'chat.piPlan.actionFailed': '无法切换到计划。请重载会话后再试。',
  'chat.piPlan.buildFailed': '无法开始构建',
  'chat.piPlan.discard': '丢弃',
  'chat.piPlan.discardFailed': '无法丢弃该计划',
  'chat.piPlan.discardConfirmTitle': '丢弃此计划？',
  'chat.piPlan.discardConfirmDescription': '这会从当前会话清除已就绪或已保存的计划。',
  'chat.piPlan.discardConfirm': '丢弃',
  'chat.piPlan.discardCancel': '保留计划',
  'chat.piPlan.discardConfirmAria': '丢弃计划确认',
  'chat.piPlan.enabledNotify': '已启用计划模式。我会探索并制定计划，但不会修改文件。',
  'chat.piPlan.implementingNotify': '正在实现已批准的计划。可能会修改文件。',
  'chat.piPlan.draftHint': '发送后才会开始 Plan。',
  'chat.piPlan.row.aria': 'Plan 模式',
  'chat.piPlan.readySelect.title': '计划已就绪。接下来怎么做？在此实现会在当前会话以智能体继续。全新开始只会把已批准的计划转到新会话。',
  'chat.piPlan.readySelect.implementHere': '在此实现',
  'chat.piPlan.readySelect.implementHereDescription': '在当前会话继续，并保留规划对话。',
  'chat.piPlan.readySelect.implementFresh': '全新开始并实现',
  'chat.piPlan.readySelect.implementFreshDescription': '打开一个关联的新会话，只转移已批准的计划。',
  'chat.piPlan.readySelect.export': '导出计划…',
  'chat.piPlan.readySelect.save': '稍后保存',
  'chat.piPlan.readySelect.stay': '留在计划模式',
  'chat.piPlan.readySelect.exit': '丢弃计划并退出',
  'chat.tool.planModeComplete': '计划模式完成',
  'chat.tool.planEnter': '计划模式',
  'chat.tool.planExit': '构建模式',
  'chat.piGoal.button': 'Goal',
  'chat.piGoal.buttonAria': '开始 Goal',
  'chat.piGoal.dialog.title': '开始 Goal',
  'chat.piGoal.dialog.objectiveLabel': '目标',
  'chat.piGoal.dialog.objectivePlaceholder': '代理需要完成什么？',
  'chat.piGoal.dialog.submit': '开始',
  'chat.piGoal.dialog.cancel': '取消',
  'chat.piGoal.dialog.exitPlan': '退出 Plan',
  'chat.piGoal.dialog.aria': '开始 Goal',
  'chat.piGoal.error.empty': '请输入目标后再开始 Goal。',
  'chat.piGoal.error.missingCommand': 'Goal 已安装，但当前会话没能启动。请再点一次开始，或先重载会话。',
  'chat.piGoal.error.failed': '无法开始 Goal。',
  'chat.piGoal.error.planActive': 'Plan 模式已开启。请先退出 Plan，再开始 Goal。',
  'chat.piGoal.error.noSession': '请先打开一个会话再开始 Goal。',
  'chat.piGoal.row.aria': '当前 Goal',
  ...
  'chat.messageBody.toast.planSavedWithPath': '计划已保存到 {path}',
  'chat.messageBody.toast.imageSaved': '图片已保存',
  'chat.messageBody.toast.generateImageFailed': '生成图片失败',
  'chat.messageBody.toast.noImageToSave': '这条消息没有可保存的图片。',
  'chat.messageBody.toast.copied': '已复制',
  'chat.messageBody.toast.copyFailed': '复制失败',
  'chat.messageBody.usage.input': '输入',
  'chat.messageBody.usage.output': '输出',
  'chat.messageBody.usage.reasoning': '推理',
  'chat.messageBody.usage.cacheRead': '缓存读取',
  'chat.messageBody.usage.cacheWrite': '缓存写入',
  'chat.messageBody.usage.cost': '费用',
  ...
  'chat.chatInput.placeholder.chatPi': '@ 用于文件/智能体；/ 用于命令和技能；# 用于代码片段',
  'chat.chatInput.placeholder.chatCompact': '使用 @ / ! # 辅助',
  'chat.chatInput.placeholder.chatCompactPi': '使用 @ / # 辅助',
  ...
  'chat.dictation.unsupported': '当前环境不支持语音输入',
  'chat.dictation.disabled': '设置中已关闭语音输入',
  'chat.dictation.microphonePermissionDenied': '麦克风权限被拒绝',
  'chat.dictation.microphoneNotFound': '未找到麦克风',
  'chat.dictation.microphoneUnavailable': '无法访问麦克风',
  'chat.dictation.startFailed': '无法开始语音输入',
  ...
  'chat.chatInput.toast.unknownCommand': '该命令尚不可用。',
  'chat.chatInput.toast.commandFailed': '无法运行该命令。',
  'chat.chatInput.pendingPromptHint': '发送消息前请先提交或关闭卡片。',
  ...
  'chat.agentRoster.launchForm': '启动子智能体',
  'chat.agentRoster.role': '角色',
  'chat.agentRoster.chooseModel': '选择提供商和模型',
  'chat.agentRoster.taskPlaceholder': '描述本次运行要完成的任务…',
  ...
  'chat.agentRoster.model': '提供商 / 模型',
  'chat.agentRoster.thinking': '思考',
  'chat.agentRoster.tools': '工具 / 能力（逗号分隔）',
  'chat.agentRoster.systemPrompt': '系统提示词',
  'chat.agentRoster.task': '本次运行任务',
  'chat.agentRoster.user': '用户',
  'chat.agentRoster.project': '项目',
  'chat.agentRoster.save': '保存',
  'chat.agentRoster.createOverride': '创建覆盖',
  'chat.agentRoster.run': '运行',
  'chat.agentRoster.running': '运行中…',
  'chat.agentRoster.saved': '子代理已保存',
  'chat.agentRoster.saveFailed': '无法保存子代理',
  'chat.agentRoster.runFailed': '无法运行子代理',
  'chat.agentRoster.missingRunFields': '请选择会话和模型，然后输入任务。',
  'chat.agentRoster.noDescription': '暂无描述',
  'chat.agentRoster.builtin': '内置',
  ...
  'commandPalette.description': '搜索会话、操作和文件。',
  'commandPalette.input.placeholder': '搜索会话、操作、文件...',
  ...
  'commandPalette.item.newWorktreeDraft': '新建 worktree 草稿',
  ...
  'saveProjectPlanDialog.description': '将此计划保存为项目中 .pichamber/plans 文件夹下的 Markdown 文件。',
  ...
  'branchPickerDialog.actions.createWorktreeAria': '从分支创建 worktree',
  ...
  'branchPickerDialog.tooltip.createWorktree': '创建 worktree',
  ...
  'branchPickerDialog.toast.worktreeCreated': 'worktree 已创建',
  'branchPickerDialog.toast.failedToCreateWorktree': '创建 worktree 失败',
  ...
  'branchPickerDialog.error.createWorktreeFailed': '创建 worktree 失败',
  ...
  'agentManager.sidebar.dialog.deleteGroupDescription': '删除“{group}”？这会移除该组中的所有 worktree 和会话。',
  ...
  'agentManager.detail.actions.copyWorktreePath': '复制 worktree 路径',
  ...
  'agentManager.detail.dialog.removeWorktreeDescription': '移除“{label}”？这将删除该 worktree 中的所有会话并移除 worktree 本身。',
  'agentManager.detail.dialog.removeOtherWorktreesDescription': '保留“{label}”，并移除“{group}”中的其他 worktree。',
  ...
  'agentManager.detail.toast.noWorktreePath': '没有可用的 worktree 路径',
  'agentManager.detail.toast.worktreePathCopied': 'worktree 路径已复制',
  ...
  'agentManager.empty.groupName.description': '用于 worktree 目录和分支命名',
  ...
  'agentManager.empty.setupCommands.description': '这些命令会在每个新 worktree 中运行。项目根目录可用 $ROOT_PROJECT_PATH。',
  ...
  'projects.sharedTrust.description': '此仓库中的 {path} 定义了会在本机运行的命令。信任一次后，只有当命令变更时 Pichamber 才会再次询问。',
  'projects.sharedTrust.setupCommands': 'Worktree设置命令',
  ...
  'mcpDropdown.status.cached': '已就绪，尚未连接',
  'mcpDropdown.status.disabled': '已禁用',
  ...
  'onboarding.localSetup.description': '安装 Pi 以继续。',
  'onboarding.localSetup.dialog.selectOpencodeBinary': '选择 Pi 可执行文件',
  'onboarding.localSetup.errors.cliNotReady': 'Pi 尚未就绪。请确认安装完成后重试。',
  ...
  'onboarding.localSetup.windows.hintDetectionFailed': '若检测失败，请设置原生路径，例如 ~/.local/bin/pi。',
  'onboarding.localSetup.hint.ensurePath': '已安装？请确认 pi 在你的 PATH 中。',
  'onboarding.localSetup.hint.setEnv': '或设置 PI_BINARY 环境变量。',
  ...
  'onboarding.desktopRecovery.localUnavailable.description': '进程内 Pi 内核未能启动。请检查 ~/.pi/agent，或改为连接远程服务器。',
  ...
  'updateDialog.actions.openGitHubRelease': '打开 GitHub 发布页',
  'updateDialog.manualInstall.unsignedMac': '此 Mac 版本无法在应用内安装更新。请打开 GitHub 发布页，用 .dmg 里的 Pichamber.app 替换现有应用。',
  ...
  'chat.workStatus.subagent.foreground': '前台',
  'chat.workStatus.subagent.background': '后台',
  ...
  'chat.workStatus.subagent.stop': '停止运行',
  'chat.workStatus.subagent.stopping': '正在停止…',
  'chat.workStatus.subagent.stopFailed': '停止子代理失败',
  ...
  'chat.workStatus.action.openSubagentOwned': '打开 {name}（属于 {parent}）',
  'chat.workStatus.action.open': '打开',
  'chat.workStatus.subagent.unopenableTooltip': '还没有可打开的会话',
  'chat.workStatus.subagent.summarize': '将结果发回父会话',
  'chat.workStatus.subagent.summarizeAgain': '重新发回父会话',
  'chat.workStatus.subagent.summarizeAgainHint': '后台子代理完成后会自动回传结果。仅在漏传时使用此按钮。',
  'chat.workStatus.subagent.handoffMessage': '子智能体「{name}」结果（请作为上下文参考）：\n{body}',
  'chat.workStatus.subagent.handoffEmpty': '子智能体「{name}」已结束但没有文本结果，请打开子会话查看详情。',
  'chat.workStatus.subagent.summarizing': '正在发送…',
  'chat.workStatus.subagent.summaryPosted': '结果已发回父会话',
  'chat.workStatus.subagent.summaryFailed': '无法发送结果',
  'chat.workStatus.subagent.noSummary': '子智能体没有返回文本结果，请打开子会话查看详情。',
  ...
  'chat.workStatus.kimi.membership.free': '免费',
  'chat.workStatus.kimi.membership.basic': '基础',
  'chat.workStatus.kimi.membership.intermediate': '中级',
  'chat.workStatus.kimi.membership.advanced': '高级',
