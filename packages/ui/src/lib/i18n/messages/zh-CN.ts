...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.piPlan.actionFailed': '无法切换智能体或计划',
  ...
  'chat.piGoal.error.missingCommand': '当前会话没有 /{command}。',
  ...
  'piUpdate.toast.available.title': 'Pichamber 才能带到 Pi {version}',
  'piUpdate.toast.available.description': '此版本随更新的 Pichamber 提供。请更新应用以获取。',
