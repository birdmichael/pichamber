...
export const dict = {
  ...
  'chat.message.context.previewConsole': 'Journaux du serveur de dev ({file})',
  ...
  'multirun.compare.title': 'Comparer les exécutions',
  'multirun.compare.subtitleSingle': '{count} exécution',
  'multirun.compare.subtitlePlural': '{count} exécutions',
  'multirun.compare.actions.openRun': 'Ouvrir',
  'multirun.compare.actions.close': 'Fermer',
  'multirun.compare.empty': 'Aucune exécution dans ce groupe pour le moment.',
  'multirun.compare.run.loading': 'Chargement de cette exécution…',
  'multirun.compare.run.empty': 'Aucun message pour le moment.',
  'multirun.compare.run.missingDirectory': 'Cette exécution n’a pas de dossier, son historique ne peut pas être chargé.',
  'multirun.compare.status.running': 'En cours',
  'multirun.compare.status.idle': 'Inactif',
  'multirun.compare.role.user': 'Vous',
  'multirun.compare.role.assistant': 'Assistant',
  'multirun.launcher.attachments.label': 'Fichiers',
  'multirun.launcher.actions.startWithRunCount': 'Démarrer ({count} exécutions)',
  'multirun.launcher.actions.startWithRunCountSingle': 'Démarrer ({count} exécution)',
  'multirun.launcher.actions.startWithRunCountPlural': 'Démarrer ({count} exécutions)',
  ...
  'sessions.sidebar.footer.actions.refresh': 'Actualiser',
  'sessions.sidebar.footer.refresh.tooltip': 'Recharger la liste des sessions et la conversation ouverte',
  'sessions.sidebar.footer.refresh.aria': 'Recharger la liste des sessions et la conversation ouverte',
  'sessions.sidebar.footer.refresh.disabledBusy': 'Actualisation indisponible pendant que la session répond',
  'sessions.sidebar.footer.refresh.disabledCompacting': 'Actualisation indisponible pendant la compaction',
  'sessions.sidebar.footer.refresh.disabledInFlight': 'Rechargement de la liste des sessions et de la conversation ouverte',
  'sessions.sidebar.footer.refresh.success': 'Liste des sessions et conversation ouverte rechargées',
  'sessions.sidebar.footer.refresh.failed': 'Échec du rechargement des sessions',
  ...
  'sessions.sidebar.session.menu.exportJsonl': 'Exporter JSONL',
  'sessions.sidebar.session.menu.exportHtml': 'Exporter HTML',
  'sessions.sidebar.header.actions.importSession': 'Importer une session',
  'sessions.sidebar.session.import.success': 'Session importée',
  'sessions.sidebar.session.import.failed': 'Échec de l\'import de la session',
  'sessions.sidebar.session.export.failed': 'Échec de l\'export de la session',
  ...
  'sessions.sidebar.session.moveToWorktree.confirm.title': 'La source a des modifications non validées',
  'sessions.sidebar.session.moveToWorktree.confirm.changedFiles': 'Fichiers modifiés dans ce worktree : {count}.',
  'sessions.sidebar.session.moveToWorktree.confirm.ownership': 'Pichamber suit ces modifications par répertoire, pas par session.',
  'sessions.sidebar.session.moveToWorktree.confirm.sessionOnlyHelp': 'Déplace uniquement cette session et ses sous-sessions, sans modifier les fichiers source.',
  'sessions.sidebar.session.moveToWorktree.confirm.allChangesHelp': 'Transfère les modifications du répertoire de session. Après succès, les fichiers non indexés et non suivis quittent la source.',
  ...
  'sessions.sidebar.session.moveToWorktree.confirm.baseWarning': 'Le transfert peut échouer si la destination utilise une autre base Git.',
  'sessions.sidebar.session.moveToWorktree.confirm.sessionOnly': 'Déplacer uniquement la session',
  'sessions.sidebar.session.moveToWorktree.confirm.allChanges': 'Déplacer toutes les modifications source',
  'sessions.sidebar.session.moveToWorktree.confirm.cancel': 'Annuler',
  'sessions.sidebar.session.moveToWorktree.sourceVerificationFailed': 'Impossible de vérifier les modifications source. Aucun worktree ni session n’a été modifié.',
  'sessions.sidebar.session.moveToWorktree.applyChangesFailed': 'La destination n’a pas accepté les modifications source. La session et les modifications n’ont pas été déplacées. Réessayez avec Déplacer uniquement la session.',
  'sessions.sidebar.session.moveToWorktree.changesMayBeInDestination': 'La connexion a été coupée avant confirmation. La session n’a peut-être pas bougé, et vos modifications non validées sont peut-être déjà dans le worktree de destination. Vérifiez-le avant de réessayer.',
  'sessions.sidebar.session.menu.compareRuns': 'Comparer les exécutions',
  ...
  'sessions.sidebar.group.actions.compareRuns': 'Comparer les exécutions',
  'sessions.sidebar.group.actions.compareRunsAria': 'Comparer les exécutions de {label}',
  ...
  'gitView.changes.revertFileDescription': 'Annuler les modifications locales de {path} ? Cette action est irréversible.',
  'gitView.changes.revertFile': 'Annuler',
  ...
  'gitView.stashes.toast.localChangesOverwrite': 'Les modifications locales seraient écrasées ({paths}) ; validez ou mettez-les de côté d\'abord',
  'gitView.stashes.toast.localChangesOverwriteWithMore': 'Les modifications locales seraient écrasées ({paths}, +{count} autres) ; validez ou mettez-les de côté d\'abord',
  ...
  'gitView.empty.notGitRepositoryDescription': 'L\'état Git s\'affiche lorsque ce dossier est un dépôt Git.',
  ...
  'diffView.state.notGitRepository': 'Pas un dépôt Git. Les diffs s\'affichent lorsque ce dossier est un dépôt Git.',
  ...
  "diffView.branch.empty": "Aucune modification validée sur cette branche par rapport à {base}",
  "diffView.branch.emptyExcludesWorkingTree": "Cette vue n’inclut pas l’arbre de travail. Les fichiers non validés restent dans Modifiés.",
  ...
  'rightSidebar.contextNotesTodo.notes.titlePlain': 'Notes rapides',
  ...
  'header.services.openPi': 'Ouvrir les services',
  'header.services.openPiWithMcp': 'Ouvrir les services et MCP',
  ...
  'chat.changedFiles.actions.showMore': 'Afficher {count} de plus',
  'chat.changedFiles.actions.collapse': 'Afficher moins',
  ...
  'chat.promptNavigator.openTimeline': 'Chronologie de la session',
  ...
  'chat.commandAutocomplete.command.btwDescription': 'Poser une question à part dans une session enfant temporaire sans dévier ce chat.',
  ...
  'chat.fileMentionAutocomplete.empty': 'Aucun fichier ni agent trouvé',
  ...
  'chat.btw.toast.destroyFailed': 'Impossible de détruire la session btw. Elle restera dans la barre latérale.',
  'chat.btw.working': 'En cours…',
  'chat.btw.collapseAria': 'Réduire le panneau btw',
  'chat.btw.expandAria': 'Développer le panneau btw',
  'chat.btw.promoteAria': 'Conserver comme session séparée',
  'chat.btw.toast.promoteFailed': 'Impossible de conserver la session btw',
  ...
  'chat.messageBody.toast.planSavedWithPath': 'Plan enregistré dans {path}',
  ...
  'chat.messageBody.toast.noImageToSave': 'Ce message n’a aucune image à enregistrer.',
  ...
  'chat.chatInput.placeholder.chatPi': '@ pour les fichiers/agents ; / pour les commandes et les skills ; # pour les extraits',
  'chat.chatInput.placeholder.chatCompact': 'Utiliser @ / ! # pour les aides',
  'chat.chatInput.placeholder.chatCompactPi': 'Utiliser @ / # pour les aides',
  ...
  'chat.dictation.unsupported': 'La dictée n\'est pas prise en charge dans cet environnement',
  'chat.dictation.disabled': 'La dictée est désactivée dans les Réglages',
  'chat.dictation.microphonePermissionDenied': 'Autorisation du microphone refusée',
  'chat.dictation.microphoneNotFound': 'Aucun microphone trouvé',
  'chat.dictation.microphoneUnavailable': 'Impossible d\'accéder au microphone',
  'chat.dictation.startFailed': 'Impossible de démarrer la dictée',
  ...
  'chat.chatInput.toast.unknownCommand': 'Cette commande n\'est pas encore disponible.',
  'chat.chatInput.toast.commandFailed': 'Impossible d\'exécuter cette commande.',
  'chat.chatInput.pendingPromptHint': 'Validez ou ignorez la carte avant d\'envoyer.',
  ...
  'commandPalette.description': 'Recherchez des sessions, des actions et des fichiers.',
  'commandPalette.input.placeholder': 'Rechercher des sessions, des actions, des fichiers...',
  ...
  'saveProjectPlanDialog.description': 'Enregistrez ce plan en fichier Markdown dans le dossier .pichamber/plans de ce projet.',
  ...
  'projects.sharedTrust.description': '{path} dans ce dépôt définit des commandes qui s\'exécutent sur cette machine. Faites-leur confiance une fois, et Pichamber ne redemandera que si elles changent.',
  ...
  'mcpDropdown.status.cached': 'Prêt, pas encore connecté',
  'mcpDropdown.status.disabled': 'Désactivé',
  ...
  'onboarding.localSetup.status.detected': 'Pi trouvé : {path}',
  ...
  'onboarding.localSetup.windows.hintDetectionFailed': 'Si la détection échoue, définissez un chemin natif tel que ~/.local/bin/pi.',
  'onboarding.localSetup.hint.ensurePath': 'Déjà installé ? Assurez-vous que pi est dans votre PATH.',
  'onboarding.localSetup.hint.setEnv': 'Ou définissez la variable d\'environnement PI_BINARY.',
  ...
  'mobile.changes.diffDetail.missingDescription': 'Retournez à Git et actualisez la liste.',
  'mobile.changes.diffDetail.imageUnavailable': 'Les diffs d’images ne sont pas encore disponibles dans le Git mobile.',
  ...
  'chat.piExtensionUi.inputNeeded': 'Réponse requise',
  'chat.piExtensionUi.selectMultiple': 'Sélection multiple',
  'chat.piExtensionUi.other': 'Autre…',
  'chat.piExtensionUi.yourAnswer': 'Votre réponse',
  'chat.piExtensionUi.submit': 'Envoyer',
  'chat.piExtensionUi.dismiss': 'Ignorer',
  'chat.piExtensionUi.confirm': 'Confirmer',
  'chat.piExtensionUi.cancel': 'Annuler',
  'chat.piExtensionUi.submitFailed': 'Échec de l\'envoi de la réponse',
  'chat.piExtensionUi.dismissFailed': 'Échec de l\'abandon de la question',
  'chat.piExtensionUi.noLongerPending': 'Cette question n\'attend plus de réponse.',
  'chat.piExtensionUi.tryAgain': 'Veuillez réessayer dans un instant.',
  'chat.piExtensionUi.answered': 'Répondu',
  'chat.piExtensionUi.cancelled': 'Annulé',
  'chat.piExtensionUi.questionFallback': 'Question',
  'chat.piExtensionUi.confirmAria': 'Confirmation de l\'extension',
  'chat.piExtensionUi.chooseOption': 'Choisissez une option pour activer Envoyer.',
  'chat.piPlan.agent': 'Agent',
  'chat.piPlan.plan': 'Plan',
  'chat.piPlan.toggleAria': 'Mode Agent ou Plan',
  'chat.piPlan.build': 'Build',
  'chat.piPlan.building': 'Construction…',
  'chat.piPlan.buildModelAria': 'Modèle pour Build',
  'chat.piPlan.actionFailed': 'Impossible de passer en mode Plan. Rechargez la session puis réessayez.',
  'chat.piPlan.buildFailed': 'Impossible de lancer Build',
  'chat.piPlan.discard': 'Abandonner',
  'chat.piPlan.discardFailed': 'Impossible d’abandonner le plan',
  'chat.piPlan.discardConfirmTitle': 'Abandonner ce plan ?',
  'chat.piPlan.discardConfirmDescription': 'Cela efface le plan prêt ou enregistré de la session.',
  'chat.piPlan.discardConfirm': 'Abandonner',
  ...
  'chat.piPlan.readySelect.implementFreshDescription': 'Ouvrir une nouvelle session liée et transférer uniquement le plan approuvé.',
  'chat.piPlan.readySelect.export': 'Exporter le plan…',
  'chat.piPlan.readySelect.save': 'Enregistrer pour plus tard',
  'chat.piPlan.readySelect.stay': 'Rester en mode Plan',
  'chat.piPlan.readySelect.exit': 'Abandonner le plan et quitter',
  'chat.tool.planModeComplete': 'Mode Plan terminé',
  'chat.tool.planEnter': 'Mode Plan',
  'chat.tool.planExit': 'Mode Build',
  'chat.piGoal.button': 'Goal',
  'chat.piGoal.buttonAria': 'Démarrer Goal',
  'chat.piGoal.dialog.title': 'Démarrer Goal',
  'chat.piGoal.dialog.objectiveLabel': 'Objectif',
  'chat.piGoal.dialog.objectivePlaceholder': 'Que doit accomplir l’agent ?',
  'chat.piGoal.dialog.submit': 'Démarrer',
  'chat.piGoal.dialog.cancel': 'Annuler',
  'chat.piGoal.dialog.exitPlan': 'Quitter Plan',
  'chat.piGoal.dialog.aria': 'Démarrer Goal',
  ...
  'chat.piGoal.error.planActive': 'Le mode Plan est actif. Quittez Plan avant de démarrer Goal.',
  ...
  'chat.workStatus.pinned.empty': 'Aucun message épinglé',
  ...
  'chat.workStatus.subagent.foreground': 'Premier plan',
  'chat.workStatus.subagent.background': 'Arrière-plan',
  'chat.workStatus.subagent.blocked': 'bloqué',
  'chat.workStatus.subagent.failed': 'échec',
  'chat.workStatus.subagent.paused': 'en pause',
  'chat.workStatus.subagent.queued': 'en file d\'attente',
  'chat.workStatus.subagent.stopped': 'arrêté',
  ...
  'chat.workStatus.subagent.namedForeground': '{name} · Premier plan',
  'chat.workStatus.subagent.namedBackground': '{name} · Arrière-plan',
  ...
  'chat.workStatus.action.openSubagentOwned': 'Ouvrir {name} (fait partie de {parent})',
  'chat.workStatus.action.open': 'Ouvrir',
  'chat.workStatus.subagent.unopenableTooltip': 'Aucune session à ouvrir',
  'chat.workStatus.subagent.summarize': 'Post result to parent',
  'chat.workStatus.subagent.summarizeAgain': 'Renvoyer le résultat à la session parente',
  'chat.workStatus.subagent.summarizeAgainHint': 'Les résultats sont renvoyés automatiquement quand un sous-agent en arrière-plan se termine. À utiliser seulement en cas d’oubli.',
  'chat.workStatus.subagent.handoffMessage': 'Résultat du sous-agent « {name} » (à utiliser comme contexte) :\n{body}',
  'chat.workStatus.subagent.handoffEmpty': 'Le sous-agent « {name} » s’est terminé sans résultat texte ; ouvrez sa session pour les détails.',
  ...
  'chat.workStatus.kimi.membership.free': 'Gratuit',
  'chat.workStatus.kimi.membership.basic': 'Basique',
  'chat.workStatus.kimi.membership.intermediate': 'Intermédiaire',
  'chat.workStatus.kimi.membership.advanced': 'Avancé',
  'chat.workStatus.kimi.membership.professional': 'Professionnel',
  'chat.workStatus.kimi.membership.enterprise': 'Entreprise',
  'chat.workStatus.kimi.window.weekly': 'Hebdomadaire',
