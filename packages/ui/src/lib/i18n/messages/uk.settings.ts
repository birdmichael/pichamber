...
export const settingsDict = {
  ...
  'settings.featurePlugins.slot.goal.info': 'Встановлює пакет Goal. Увімкнення потрібне для пізніших елементів Goal на робочому столі. Ця сторінка не додає кнопку Goal у композер.',
  ...
  'settings.featurePlugins.field.source': 'Джерело',
  'settings.featurePlugins.field.source.info': 'npm, git або локальний шлях. Готові чіпи лише заповнюють це поле. Вони не встановлюють пакет.',
  'settings.featurePlugins.field.source.placeholder': 'npm:пакет, git:… або локальний шлях',
  'settings.featurePlugins.field.source.aria': 'Джерело {slot}',
  'settings.featurePlugins.field.command': 'Команда запуску',
  'settings.featurePlugins.field.command.info': 'Slash-команда, якою пізніше запускають Goal. Типово — goal. Plan, MCP і Subagents тут не мають команди запуску.',
  'settings.featurePlugins.field.command.placeholder': 'goal',
  'settings.featurePlugins.field.command.aria': 'Команда запуску Goal',
  'settings.featurePlugins.presets.aria': 'Готові джерела {slot}',
  ...
  'settings.featurePlugins.status.installed': 'Встановлено в пакетах Pi.',
  'settings.featurePlugins.status.notInstalled': 'Не встановлено. Відкриття цієї сторінки ніколи не встановлює пакет.',
...
"settings.remoteInstances.clientAuth.actions.addDevice": "Додати пристрій",
  ...
  "settings.providers.page.custom.field.apiKey.info": "Зберігається в автентифікації OpenCode, не Pichamber. Використовуйте {env:VAR_NAME}, щоб читати ключ зі змінної середовища.",
  ...
  "settings.providers.page.auth.apiKeyTooltip": "Ключі надсилаються безпосередньо до OpenCode і ніколи не зберігаються в Pichamber.",
