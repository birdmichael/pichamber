...
export const settingsDict = {
  ...
  'settings.featurePlugins.field.command.info': 'Slash-команда, яку запускає кнопка Goal у композері. Типово — goal. Plan, MCP і Subagents тут не мають команди запуску.',
