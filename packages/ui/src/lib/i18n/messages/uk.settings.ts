...
"settings.remoteInstances.clientAuth.actions.addDevice": "Додати пристрій",
  ...
  "settings.providers.sidebar.empty.description": "Перевірте ~/.pi/agent/models.json і auth.json",
  ...
  "settings.providers.page.empty.checkOpenCodeConfiguration": "Перевірте ~/.pi/agent/models.json і auth.json",
