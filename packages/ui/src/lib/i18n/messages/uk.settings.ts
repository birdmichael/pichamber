...
export const settingsDict = {
  ...
  'settings.featurePlugins.slot.goal.info': 'Встановлює пакет Goal. Увімкніть його, щоб показати кнопку Goal у композері. Ця сторінка ніколи не встановлює автоматично.',
  'settings.featurePlugins.slot.plan.title': 'Plan',
  'settings.featurePlugins.slot.plan.info': 'Встановлює пакет Plan. Увімкнення потрібне для пізніших Agent/Plan, Перегляду плану та Build. Ця сторінка не запускає /plan.',
  'settings.featurePlugins.slot.mcp.title': 'MCP',
  'settings.featurePlugins.slot.mcp.info': 'Встановлює адаптер MCP. Увімкнення потрібне для пізнішого MCP у Work Status і Налаштування → MCP. Ця сторінка не запускає /mcp.',
  'settings.featurePlugins.slot.subagents.title': 'Subagents',
  'settings.featurePlugins.slot.subagents.info': 'Встановлює пакет Subagents. Увімкнення потрібне для пізнішого Work Status і дочірніх сеансів із записом. Ця сторінка не запускає /subagents-fleet.',
  'settings.featurePlugins.enabled.label': 'Увімкнено',
  'settings.featurePlugins.enabled.info': 'Залишає пакет встановленим, але ховає пізніші елементи робочого столу для цього слота.',
  ...
  'settings.featurePlugins.dialog.uninstall.description': 'Це прибере пакет із пакетів Pi. Увімкнення чи вимкнення збережеться.',
