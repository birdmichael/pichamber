...
export const settingsDict = {
  ...
  'settings.featurePlugins.slot.goal.info': 'Goal 패키지를 설치합니다. 사용 설정은 이후 데스크톱 Goal 컨트롤을 위한 것입니다. 이 페이지는 작성기에 Goal 버튼을 추가하지 않습니다.',
  ...
  'settings.featurePlugins.field.source': '소스',
  'settings.featurePlugins.field.source.info': 'npm, git 또는 로컬 경로입니다. 프리셋 칩은 이 필드만 채웁니다. 패키지를 설치하지 않습니다.',
  'settings.featurePlugins.field.source.placeholder': 'npm:package, git:… 또는 로컬 경로',
  'settings.featurePlugins.field.source.aria': '{slot} 소스',
  'settings.featurePlugins.field.command': '시작 명령',
  'settings.featurePlugins.field.command.info': '나중에 Goal을 시작할 슬래시 명령입니다. 기본값은 goal입니다. Plan, MCP, Subagents에는 여기 시작 명령이 없습니다.',
  'settings.featurePlugins.field.command.placeholder': 'goal',
  'settings.featurePlugins.field.command.aria': 'Goal 시작 명령',
  'settings.featurePlugins.presets.aria': '{slot} 소스 프리셋',
  'settings.featurePlugins.enabled.label': '사용',
  'settings.featurePlugins.enabled.info': '패키지는 설치해 두고 이 슬롯의 이후 데스크톱 컨트롤은 숨깁니다.',
  'settings.featurePlugins.status.installed': 'Pi packages에 설치되어 있습니다.',
  'settings.featurePlugins.status.notInstalled': '설치되어 있지 않습니다. 이 페이지를 열어도 패키지가 설치되지 않습니다.',
...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.openchamber.tools.field.agentWebToolInfo': '에이전트가 Pichamber 브라우저 패널에서 페이지를 확인하고 조작할 수 있습니다. URL 열기, 내용 읽기, 클릭, 입력, 스크롤, 모바일과 데스크톱 레이아웃 전환이 가능합니다. 각 세션에 작은 도구 설명이 추가됩니다. OpenCode를 다시 시작하면 적용됩니다.',
  ...
  'settings.providers.page.custom.field.apiKey.info': 'Pichamber가 아니라 OpenCode 인증에 저장됩니다. 환경 변수에서 읽으려면 {env:VAR_NAME}을 사용하세요.',
  ...
  'settings.providers.page.auth.apiKeyTooltip': '키는 OpenCode로 직접 전송되며 Pichamber에 저장되지 않습니다.',
