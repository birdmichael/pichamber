...
export const settingsDict = {
  ...
  'settings.featurePlugins.slot.goal.info': 'Goal 패키지를 설치합니다. 활성화하면 입력창에 Goal 버튼이 나타납니다. 이 페이지는 자동으로 설치하지 않습니다.',
  'settings.featurePlugins.slot.plan.title': 'Plan',
  'settings.featurePlugins.slot.plan.info': 'Plan 패키지를 설치합니다. 사용 설정은 이후 Agent/Plan, 계획 보기, Build를 위한 것입니다. 이 페이지는 /plan을 시작하지 않습니다.',
  'settings.featurePlugins.slot.mcp.title': 'MCP',
  'settings.featurePlugins.slot.mcp.info': 'MCP 어댑터 패키지를 설치합니다. 사용 설정은 이후 Work Status MCP와 설정 → MCP를 위한 것입니다. 이 페이지는 /mcp를 시작하지 않습니다.',
  'settings.featurePlugins.slot.subagents.title': 'Subagents',
  'settings.featurePlugins.slot.subagents.info': 'Subagents 패키지를 설치합니다. 사용 설정은 이후 Work Status와 쓰기 가능한 자식 세션을 위한 것입니다. 이 페이지는 /subagents-fleet을 시작하지 않습니다.',
  'settings.featurePlugins.enabled.label': '사용',
  'settings.featurePlugins.enabled.info': '패키지는 설치해 두고 이 슬롯의 이후 데스크톱 컨트롤은 숨깁니다.',
  ...
  'settings.featurePlugins.dialog.uninstall.description': 'Pi packages에서 이 패키지를 제거합니다. 사용/사용 안 함 설정은 유지됩니다.',
