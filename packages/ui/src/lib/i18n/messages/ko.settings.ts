...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.providers.sidebar.empty.description': '~/.pi/agent/models.json 및 auth.json을 확인하세요',
  ...
  'settings.providers.page.empty.checkOpenCodeConfiguration': '~/.pi/agent/models.json 및 auth.json을 확인하세요',
