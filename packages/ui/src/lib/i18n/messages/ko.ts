...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.message.context.previewConsole': '개발 서버 로그 ({file})',
  ...
  'mobile.changes.diffDetail.missingDescription': 'Git으로 돌아가 목록을 새로고침하세요.',
  'mobile.changes.diffDetail.imageUnavailable': '이미지 diff는 아직 모바일 Git에서 사용할 수 없습니다.',
  ...
  'multirun.compare.title': '실행 비교',
  'multirun.compare.subtitleSingle': '{count}개 실행',
  'multirun.compare.subtitlePlural': '{count}개 실행',
  'multirun.compare.actions.openRun': '열기',
  'multirun.compare.actions.close': '닫기',
  'multirun.compare.empty': '이 그룹에 아직 실행이 없습니다.',
  'multirun.compare.run.loading': '이 실행을 불러오는 중…',
  'multirun.compare.run.empty': '아직 메시지가 없습니다.',
  'multirun.compare.run.missingDirectory': '이 실행에 디렉터리가 없어 대화를 불러올 수 없습니다.',
  'multirun.compare.status.running': '실행 중',
  'multirun.compare.status.idle': '대기',
  'multirun.compare.role.user': '나',
  'multirun.compare.role.assistant': '어시스턴트',
  'multirun.launcher.attachments.label': '파일',
  'multirun.launcher.actions.startWithRunCount': '시작 ({count}개 실행)',
  'multirun.launcher.actions.startWithRunCountSingle': '시작 ({count}개 실행)',
  'multirun.launcher.actions.startWithRunCountPlural': '시작 ({count}개 실행)',
  ...
  'sessions.sidebar.footer.actions.refresh': '새로고침',
  'sessions.sidebar.footer.refresh.tooltip': '세션 목록과 열린 대화를 다시 불러옵니다',
  'sessions.sidebar.footer.refresh.aria': '세션 목록과 열린 대화를 다시 불러옵니다',
  'sessions.sidebar.footer.refresh.disabledBusy': '세션이 응답 중일 때는 새로고침할 수 없습니다',
  'sessions.sidebar.footer.refresh.disabledCompacting': '컨텍스트를 압축하는 중에는 새로고침할 수 없습니다',
  'sessions.sidebar.footer.refresh.disabledInFlight': '세션 목록과 열린 대화를 다시 불러오는 중',
  'sessions.sidebar.footer.refresh.success': '세션 목록과 열린 대화를 다시 불러왔습니다',
  'sessions.sidebar.footer.refresh.failed': '세션을 다시 불러오지 못했습니다',
  ...
  'sessions.sidebar.session.menu.exportJsonl': 'JSONL 보내기',
  'sessions.sidebar.session.menu.exportHtml': 'HTML 보내기',
  'sessions.sidebar.header.actions.importSession': '세션 가져오기',
  'sessions.sidebar.session.import.success': '세션을 가져왔습니다',
  'sessions.sidebar.session.import.failed': '세션을 가져오지 못했습니다',
  'sessions.sidebar.session.export.failed': '세션을 보내지 못했습니다',
  ...
  'sessions.sidebar.session.moveToWorktree.main': '기본 worktree',
  'sessions.sidebar.session.moveToWorktree.refreshing': 'worktree를 새로 고치는 중…',
  ...
  'sessions.sidebar.session.moveToWorktree.tooltipTargets': '기존 worktree와 이 세션용 새 worktree 만들기 옵션을 보여 줍니다.',
  'sessions.sidebar.session.moveToWorktree.confirm.title': '소스에 커밋되지 않은 변경이 있습니다',
  'sessions.sidebar.session.moveToWorktree.confirm.changedFiles': '이 worktree의 변경된 파일: {count}.',
  'sessions.sidebar.session.moveToWorktree.confirm.ownership': 'Pichamber는 이 변경을 세션이 아니라 디렉터리 단위로 추적합니다.',
  'sessions.sidebar.session.moveToWorktree.confirm.sessionOnlyHelp': '소스 파일은 그대로 두고 이 세션과 하위 세션만 이동합니다.',
  'sessions.sidebar.session.moveToWorktree.confirm.allChangesHelp': '세션 디렉터리의 변경을 옮깁니다. 성공하면 스테이징되지 않은 파일과 추적되지 않은 파일은 소스에서 사라집니다.',
  'sessions.sidebar.session.moveToWorktree.confirm.stagedWarning': '스테이징된 변경은 소스에 남고 대상으로 복사됩니다.',
  'sessions.sidebar.session.moveToWorktree.confirm.baseWarning': '대상의 Git 기준이 다르면 전송이 실패할 수 있습니다.',
  'sessions.sidebar.session.moveToWorktree.confirm.sessionOnly': '세션만 이동',
  'sessions.sidebar.session.moveToWorktree.confirm.allChanges': '소스 변경 모두 이동',
  'sessions.sidebar.session.moveToWorktree.confirm.cancel': '취소',
  'sessions.sidebar.session.moveToWorktree.sourceVerificationFailed': '소스 변경을 확인할 수 없습니다. worktree와 세션은 바뀌지 않았습니다.',
  'sessions.sidebar.session.moveToWorktree.applyChangesFailed': '대상이 소스 변경을 받지 못했습니다. 세션과 변경은 이동하지 않았습니다. ‘세션만 이동’으로 다시 시도하세요.',
  'sessions.sidebar.session.moveToWorktree.changesMayBeInDestination': '대상이 이동을 확인하기 전에 연결이 끊겼습니다. 세션은 이동하지 않았을 수 있고, 커밋되지 않은 변경은 대상 worktree에 있을 수 있습니다. 다시 시도하기 전에 확인하세요.',
  'sessions.sidebar.session.menu.compareRuns': '실행 비교',
  ...
  'sessions.sidebar.group.actions.compareRuns': '실행 비교',
  'sessions.sidebar.group.actions.compareRunsAria': '{label}의 실행 비교',
  ...
  'gitView.changes.revertFileDescription': '{path}의 로컬 변경 사항을 되돌릴까요? 이 작업은 취소할 수 없습니다.',
  'gitView.changes.revertFile': '되돌리기',
  ...
  'gitView.stashes.toast.applyFailed': '스태시 적용에 실패했습니다',
  'gitView.stashes.toast.localChangesOverwrite': '로컬 변경 사항이 덮어쓰입니다 ({paths}). 먼저 커밋하거나 스태시하세요',
  'gitView.stashes.toast.localChangesOverwriteWithMore': '로컬 변경 사항이 덮어쓰입니다 ({paths}, +{count}개 더). 먼저 커밋하거나 스태시하세요',
  ...
  'gitView.empty.notGitRepositoryDescription': '현재 폴더가 Git 레포지토리일 때 Git 상태를 볼 수 있습니다.',
  ...
  'gitView.pullRequest.detachedHeadHint': 'Detached HEAD입니다. 먼저 브랜치를 만드세요.',
  ...
  'diffView.state.notGitRepository': 'Git 레포지토리가 아닙니다. 현재 폴더가 Git 레포지토리일 때 diff를 볼 수 있습니다.',
  ...
  "diffView.branch.empty": "이 브랜치에는 {base}에 대한 커밋된 변경 사항이 없습니다",
  "diffView.branch.emptyExcludesWorkingTree": "이 보기에는 작업 트리가 포함되지 않습니다. 커밋되지 않은 파일은 변경됨에 남아 있습니다.",
  ...
  'rightSidebar.contextNotesTodo.notes.titlePlain': '빠른 메모',
  ...
  'header.services.openWithCurrentPi': '로컬 또는 원격 인스턴스 전환(현재: {current})',
  'header.services.open': '서비스, 사용량, MCP 열기',
  'header.services.openPi': '서비스 열기',
  'header.services.openPiWithMcp': '서비스 및 MCP 열기',
  ...
  'chat.promptNavigator.openTimeline': '세션 타임라인',
  ...
  'chat.commandAutocomplete.command.btwDescription': '이 채팅의 흐름을 바꾸지 않고 임시 하위 세션에서 곁질문을 합니다.',
  ...
  'chat.fileMentionAutocomplete.empty': '파일 또는 에이전트 없음',
  ...
  'chat.btw.mainComposerPlaceholder': '이 btw 세션에서 질문…',
  'chat.btw.loading': 'btw 세션을 시작하는 중…',
  ...
  'chat.btw.promoteAria': '일반 세션으로 유지',
  'chat.btw.toast.promoteFailed': 'btw 세션을 일반 세션으로 유지하지 못했습니다',
  ...
  'chat.piExtensionUi.inputNeeded': '입력이 필요합니다',
  'chat.piExtensionUi.selectMultiple': '다중 선택',
  'chat.piExtensionUi.other': '기타…',
  'chat.piExtensionUi.yourAnswer': '내 답변',
  'chat.piExtensionUi.submit': '제출',
  'chat.piExtensionUi.dismiss': '닫기',
  'chat.piExtensionUi.confirm': '확인',
  'chat.piExtensionUi.cancel': '취소',
  'chat.piExtensionUi.submitFailed': '응답을 보내지 못했습니다',
  'chat.piExtensionUi.dismissFailed': '질문을 닫지 못했습니다',
  'chat.piExtensionUi.noLongerPending': '이 질문은 더 이상 응답을 기다리지 않습니다.',
  'chat.piExtensionUi.tryAgain': '잠시 후 다시 시도하세요.',
  'chat.piExtensionUi.answered': '답변함',
  'chat.piExtensionUi.cancelled': '취소됨',
  'chat.piExtensionUi.questionFallback': '질문',
  'chat.piExtensionUi.confirmAria': '확장 확인',
  'chat.piExtensionUi.chooseOption': '제출을 활성화하려면 옵션을 선택하세요.',
  'chat.piPlan.agent': '에이전트',
  'chat.piPlan.plan': '플랜',
  'chat.piPlan.toggleAria': '에이전트 또는 플랜 모드',
  'chat.piPlan.build': '빌드',
  'chat.piPlan.building': '빌드 중…',
  'chat.piPlan.buildModelAria': '빌드에 사용할 모델',
  'chat.piPlan.actionFailed': '플랜으로 전환하지 못했습니다. 세션을 다시 불러온 뒤 재시도하세요.',
  'chat.piPlan.buildFailed': '빌드를 시작하지 못했습니다',
  'chat.piPlan.discard': '폐기',
  'chat.piPlan.discardFailed': '플랜을 폐기하지 못했습니다',
  'chat.piPlan.discardConfirmTitle': '이 플랜을 폐기할까요?',
  'chat.piPlan.discardConfirmDescription': '준비되었거나 저장된 플랜이 이 세션에서 지워집니다.',
  'chat.piPlan.discardConfirm': '폐기',
  ...
  'chat.piPlan.readySelect.implementFreshDescription': '연결된 새 세션을 열고 승인된 플랜만 옮깁니다.',
  'chat.piPlan.readySelect.export': '플랜 내보내기…',
  'chat.piPlan.readySelect.save': '나중에 저장',
  'chat.piPlan.readySelect.stay': '플랜 모드 유지',
  'chat.piPlan.readySelect.exit': '플랜을 폐기하고 종료',
  'chat.tool.planModeComplete': '플랜 모드 완료',
  'chat.tool.planEnter': '플랜 모드',
  'chat.tool.planExit': '빌드 모드',
  'chat.piGoal.button': 'Goal',
  'chat.piGoal.buttonAria': 'Goal 시작',
  'chat.piGoal.dialog.title': 'Goal 시작',
  'chat.piGoal.dialog.objectiveLabel': '목표',
  'chat.piGoal.dialog.objectivePlaceholder': '에이전트가 무엇을 달성해야 하나요?',
  'chat.piGoal.dialog.submit': '시작',
  'chat.piGoal.dialog.cancel': '취소',
  'chat.piGoal.dialog.exitPlan': 'Plan 종료',
  'chat.piGoal.dialog.aria': 'Goal 시작',
  'chat.piGoal.error.empty': 'Goal을 시작하려면 목표를 입력하세요.',
  ...
  'chat.piGoal.error.planActive': 'Plan 모드가 켜져 있습니다. Plan을 종료한 다음 Goal을 시작하세요.',
  ...
  'chat.messageBody.forkDialog.title': '새 세션 시작',
  ...
  'chat.messageBody.toast.planSavedWithPath': '플랜이 {path}에 저장되었습니다',
  'chat.messageBody.toast.imageSaved': '이미지 저장된',
  'chat.messageBody.toast.generateImageFailed': '이미지 생성 실패',
  'chat.messageBody.toast.noImageToSave': '이 메시지에는 저장할 이미지가 없습니다.',
  ...
  'chat.chatInput.placeholder.chatPi': '@ 파일/에이전트; / 명령 및 스킬; # 스니펫',
  'chat.chatInput.placeholder.chatCompact': '@ / ! # 도우미 사용',
  'chat.chatInput.placeholder.chatCompactPi': '@ / # 도우미 사용',
  ...
  'chat.dictation.unsupported': '이 환경에서는 받아쓰기를 지원하지 않습니다',
  'chat.dictation.disabled': '설정에서 받아쓰기가 꺼져 있습니다',
  'chat.dictation.microphonePermissionDenied': '마이크 권한이 거부되었습니다',
  'chat.dictation.microphoneNotFound': '마이크를 찾을 수 없습니다',
  'chat.dictation.microphoneUnavailable': '마이크에 접근할 수 없습니다',
  'chat.dictation.startFailed': '받아쓰기를 시작할 수 없습니다',
  ...
  'chat.chatInput.toast.unknownCommand': '해당 명령은 아직 사용할 수 없습니다.',
  'chat.chatInput.toast.commandFailed': '해당 명령을 실행할 수 없습니다.',
  'chat.chatInput.pendingPromptHint': '보내기 전에 카드를 제출하거나 닫으세요.',
  ...
  'commandPalette.description': '세션, 작업, 파일을 검색합니다.',
  'commandPalette.input.placeholder': '세션, 작업, 파일 검색…',
  ...
  'saveProjectPlanDialog.description': '이 플랜을 프로젝트의 .pichamber/plans 폴더에 Markdown 파일로 저장합니다.',
  ...
  'mcpDropdown.status.cached': '준비됨(아직 연결되지 않음)',
  'mcpDropdown.status.disabled': '사용 안 함',
  ...
  'onboarding.localSetup.dialog.selectOpencodeBinary': 'pi 바이너리 선택',
  ...
  'onboarding.localSetup.status.detected': 'Pi를 {path}에서 찾았습니다',
  ...
  'onboarding.localSetup.windows.hintDetectionFailed': '감지에 실패하면 ~/.local/bin/pi 같은 네이티브 경로를 설정하세요.',
  'onboarding.localSetup.hint.ensurePath': '이미 설치되어 있나요? pi가 PATH에 있는지 확인하세요.',
  'onboarding.localSetup.hint.setEnv': '또는 `PI_BINARY` 환경 변수를 설정하세요.',
  ...
  'updateDialog.error.takingLonger': '업데이트가 예상보다 오래 걸립니다. 잠시 기다린 뒤 새로고침하거나 `pichamber update`를 실행하세요.',
  ...
  'chat.workStatus.pinned.empty': '고정된 메시지가 없습니다',
  ...
  'chat.workStatus.subagent.foreground': '포그라운드',
  'chat.workStatus.subagent.background': '백그라운드',
  ...
  'chat.workStatus.action.openSubagentOwned': '{name} 열기 ({parent}의 하위)',
  ...
  'chat.workStatus.subagent.summarizeAgain': '결과를 상위 세션으로 다시 보내기',
  'chat.workStatus.subagent.summarizeAgainHint': '백그라운드 하위 에이전트가 끝나면 결과가 자동으로 돌아옵니다. 누락됐을 때만 사용하세요.',
  'chat.workStatus.subagent.handoffMessage': '하위 에이전트 "{name}" 결과(컨텍스트로 참고):\n{body}',
  'chat.workStatus.subagent.handoffEmpty': '하위 에이전트 "{name}"이(가) 텍스트 결과 없이 끝났습니다. 하위 세션을 열어 확인하세요.',
  ...
  'chat.workStatus.kimi.membership.free': '무료',
  'chat.workStatus.kimi.membership.basic': '베이직',
  'chat.workStatus.kimi.membership.intermediate': '중급',
  'chat.workStatus.kimi.membership.advanced': '고급',
  'chat.workStatus.kimi.membership.professional': '프로',
  'chat.workStatus.kimi.membership.enterprise': '엔터프라이즈',
  'chat.workStatus.kimi.window.weekly': '주간',
