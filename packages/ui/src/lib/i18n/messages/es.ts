...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.message.context.previewConsole': 'Registros del servidor de desarrollo ({file})',
  ...
  "mobile.changes.diffDetail.missingDescription": "Vuelve a Git y actualiza la lista.",
  "mobile.changes.diffDetail.imageUnavailable": "Los diffs de imagen aún no están disponibles en el Git móvil.",
  ...
  "multirun.compare.title": "Comparar ejecuciones",
  "multirun.compare.subtitleSingle": "{count} ejecución",
  "multirun.compare.subtitlePlural": "{count} ejecuciones",
  "multirun.compare.actions.openRun": "Abrir",
  "multirun.compare.actions.close": "Cerrar",
  "multirun.compare.empty": "Aún no hay ejecuciones en este grupo.",
  "multirun.compare.run.loading": "Cargando esta ejecución…",
  "multirun.compare.run.empty": "Aún no hay mensajes.",
  "multirun.compare.run.missingDirectory": "Esta ejecución no tiene directorio, así que no se puede cargar la conversación.",
  "multirun.compare.status.running": "En curso",
  "multirun.compare.status.idle": "Inactiva",
  "multirun.compare.role.user": "Tú",
  "multirun.compare.role.assistant": "Asistente",
  "multirun.launcher.attachments.label": "Archivos",
  "multirun.launcher.actions.startWithRunCount": "Iniciar ({count} ejecuciones)",
  "multirun.launcher.actions.startWithRunCountSingle": "Iniciar ({count} ejecución)",
  "multirun.launcher.actions.startWithRunCountPlural": "Iniciar ({count} ejecuciones)",
  ...
  "sessions.sidebar.footer.actions.refresh": "Actualizar",
  "sessions.sidebar.footer.refresh.tooltip": "Recargar la lista de sesiones y la conversación abierta",
  "sessions.sidebar.footer.refresh.aria": "Recargar la lista de sesiones y la conversación abierta",
  "sessions.sidebar.footer.refresh.disabledBusy": "No se puede actualizar mientras la sesión responde",
  "sessions.sidebar.footer.refresh.disabledCompacting": "No se puede actualizar mientras se compacta el contexto",
  "sessions.sidebar.footer.refresh.disabledInFlight": "Recargando la lista de sesiones y la conversación abierta",
  "sessions.sidebar.footer.refresh.success": "Lista de sesiones y conversación abierta recargadas",
  "sessions.sidebar.footer.refresh.failed": "No se pudieron recargar las sesiones",
  ...
  "sessions.sidebar.header.actions.importSession": "Importar sesión",
  "sessions.sidebar.session.import.success": "Sesión importada",
  "sessions.sidebar.session.import.failed": "No se pudo importar la sesión",
  "sessions.sidebar.session.export.failed": "No se pudo exportar la sesión",
  ...
  "sessions.sidebar.session.menu.moveToWorktreeTargets": "Mover a un worktree",
  ...
  "sessions.sidebar.session.moveToWorktree.confirm.title": "El origen tiene cambios sin confirmar",
  "sessions.sidebar.session.moveToWorktree.confirm.changedFiles": "Archivos cambiados en este worktree: {count}.",
  "sessions.sidebar.session.moveToWorktree.confirm.ownership": "Pichamber rastrea estos cambios por directorio, no por sesión.",
  "sessions.sidebar.session.moveToWorktree.confirm.sessionOnlyHelp": "Mueve esta sesión y sus subsesiones y deja los archivos de origen sin cambios.",
  "sessions.sidebar.session.moveToWorktree.confirm.allChangesHelp": "Transfiere los cambios bajo el directorio de la sesión. Tras el éxito, los archivos no preparados y sin seguimiento salen del origen.",
  "sessions.sidebar.session.moveToWorktree.confirm.stagedWarning": "Los cambios preparados permanecen en el origen y se copian al destino.",
  "sessions.sidebar.session.moveToWorktree.confirm.baseWarning": "La transferencia puede fallar si el destino usa otra base de Git.",
  "sessions.sidebar.session.moveToWorktree.confirm.sessionOnly": "Mover solo la sesión",
  "sessions.sidebar.session.moveToWorktree.confirm.allChanges": "Mover todos los cambios de origen",
  "sessions.sidebar.session.moveToWorktree.confirm.cancel": "Cancelar",
  "sessions.sidebar.session.moveToWorktree.sourceVerificationFailed": "No se pudieron verificar los cambios de origen. No se modificó el worktree ni la sesión.",
  "sessions.sidebar.session.moveToWorktree.applyChangesFailed": "El destino no aceptó los cambios de origen. La sesión y los cambios no se movieron. Reintenta y elige Mover solo la sesión.",
  "sessions.sidebar.session.moveToWorktree.changesMayBeInDestination": "La conexión se cortó antes de que el destino confirmara el movimiento. La sesión puede no haberse movido y los cambios sin confirmar pueden estar ya en el worktree de destino. Compruébalo antes de reintentar.",
  "sessions.sidebar.session.menu.compareRuns": "Comparar ejecuciones",
  ...
  "sessions.sidebar.group.actions.compareRuns": "Comparar ejecuciones",
  "sessions.sidebar.group.actions.compareRunsAria": "Comparar ejecuciones de {label}",
  ...
  "gitView.changes.revertFileDialogTitle": "¿Revertir cambios del archivo?",
  "gitView.changes.revertFileDescription": "¿Revertir los cambios locales en {path}? Esto no se puede deshacer.",
  "gitView.changes.revertFile": "Revertir",
  ...
  "gitView.stashes.toast.applyFailed": "No se pudo aplicar el stash",
  "gitView.stashes.toast.localChangesOverwrite": "Los cambios locales se sobrescribirían ({paths}); haz commit o stash primero",
  "gitView.stashes.toast.localChangesOverwriteWithMore": "Los cambios locales se sobrescribirían ({paths}, +{count} más); haz commit o stash primero",
  ...
  "gitView.empty.notGitRepositoryDescription": "El estado de Git está disponible cuando esta carpeta es un repositorio Git.",
  ...
  "gitView.pullRequest.detachedHeadHint": "HEAD desvinculado: crea una rama primero.",
  ...
  'contextPanel.browser.hostAppBlocked': 'No se puede abrir la app Pichamber dentro del navegador.',
  ...
  "planView.state.noPlanYet": "Aún no hay un plan",
  ...
  "diffView.state.notGitRepository": "No es un repositorio Git. Los diffs están disponibles cuando esta carpeta es un repositorio Git.",
  ...
  "diffView.branch.empty": "No hay cambios confirmados en esta rama respecto a {base}",
  "diffView.branch.emptyExcludesWorkingTree": "Esta vista no incluye el árbol de trabajo. Los archivos sin confirmar siguen en Cambiados.",
  ...
  'chat.dictation.unsupported': 'El dictado no es compatible en este entorno',
  'chat.dictation.disabled': 'El dictado está desactivado en Ajustes',
  'chat.dictation.microphonePermissionDenied': 'Permiso del micrófono denegado',
  'chat.dictation.microphoneNotFound': 'No se encontró ningún micrófono',
  'chat.dictation.microphoneUnavailable': 'No se puede acceder al micrófono',
  'chat.dictation.startFailed': 'No se pudo iniciar el dictado',
  ...
  "header.services.openWithCurrentPi": "Cambiar instancia local o remota (actual: {current})",
  "header.services.open": "Abrir servicios, uso y MCP",
  "header.services.openPi": "Abrir servicios",
  "header.services.openPiWithMcp": "Abrir servicios y MCP",
  ...
  "pullRequestComparison.select": "Seleccionar pull request",
  ...
  "chat.emptyState.draftTitleWithProject": "¿En qué estamos trabajando en {project}?",
  ...
  "chat.promptNavigator.openTimeline": "Línea de tiempo de la sesión",
  ...
  "chat.timeline.title": "Línea de tiempo de la sesión",
  ...
  'chat.commandAutocomplete.command.btwDescription': 'Haz una pregunta aparte en una sesión temporal hija sin desviar este chat.',
  ...
  "chat.commandAutocomplete.command.runDescription": "Ejecuta un subagente como un flujo de trabajo de una sola vez",
  ...
  "chat.commandAutocomplete.keyboardHintEmpty": "Esc cerrar",
  ...
  "chat.fileMentionAutocomplete.empty": "No se encontraron archivos ni agentes",
  ...
  'chat.btw.toast.destroyFailed': 'No se pudo destruir la sesión btw. Seguirá en la barra lateral.',
  'chat.btw.working': 'Trabajando…',
  'chat.btw.collapseAria': 'Contraer el panel btw',
  'chat.btw.expandAria': 'Expandir el panel btw',
  'chat.btw.promoteAria': 'Conservar como sesión independiente',
  ...
  "chat.piExtensionUi.inputNeeded": "Se necesita una respuesta",
  "chat.piExtensionUi.selectMultiple": "Selección múltiple",
  "chat.piExtensionUi.other": "Otro…",
  "chat.piExtensionUi.yourAnswer": "Tu respuesta",
  "chat.piExtensionUi.submit": "Enviar",
  "chat.piExtensionUi.dismiss": "Descartar",
  "chat.piExtensionUi.confirm": "Confirmar",
  "chat.piExtensionUi.cancel": "Cancelar",
  "chat.piExtensionUi.submitFailed": "No se pudo enviar la respuesta",
  "chat.piExtensionUi.dismissFailed": "No se pudo descartar la pregunta",
  "chat.piExtensionUi.noLongerPending": "Esta pregunta ya no espera una respuesta.",
  "chat.piExtensionUi.tryAgain": "Inténtalo de nuevo en un momento.",
  "chat.piExtensionUi.answered": "Respondida",
  "chat.piExtensionUi.cancelled": "Cancelada",
  "chat.piExtensionUi.questionFallback": "Pregunta",
  "chat.piExtensionUi.confirmAria": "Confirmación de la extensión",
  "chat.piExtensionUi.chooseOption": "Elige una opción para activar Enviar.",
  "chat.piPlan.agent": "Agente",
  "chat.piPlan.plan": "Plan",
  "chat.piPlan.toggleAria": "Modo Agente o Plan",
  "chat.piPlan.build": "Build",
  "chat.piPlan.building": "Compilando…",
  "chat.piPlan.buildModelAria": "Modelo para Build",
  "chat.piPlan.actionFailed": "No se pudo cambiar a Plan. Recarga la sesión e inténtalo de nuevo.",
  "chat.piPlan.buildFailed": "No se pudo iniciar Build",
  "chat.piPlan.discard": "Descartar",
  "chat.piPlan.discardFailed": "No se pudo descartar el plan",
  "chat.piPlan.discardConfirmTitle": "¿Descartar este plan?",
  "chat.piPlan.discardConfirmDescription": "Esto borra el plan listo o guardado de la sesión.",
  "chat.piPlan.discardConfirm": "Descartar",
  "chat.piPlan.discardCancel": "Conservar plan",
  "chat.piPlan.discardConfirmAria": "Confirmación para descartar el plan",
  "chat.piPlan.enabledNotify": "Modo Plan activado. Exploraré y planificaré, pero no modificaré archivos.",
  "chat.piPlan.implementingNotify": "Implementando el plan aprobado. Se pueden modificar archivos.",
  "chat.piPlan.draftHint": "Plan empezará al enviar.",
  "chat.piPlan.row.aria": "Modo Plan",
  "chat.piPlan.readySelect.title": "El plan está listo. ¿Qué sigue? Implementar aquí continúa en esta sesión como Agente. Empezar de cero transfiere solo el plan aprobado a una sesión nueva.",
  "chat.piPlan.readySelect.implementHere": "Implementar aquí",
  "chat.piPlan.readySelect.implementHereDescription": "Continuar en esta sesión con la conversación de planificación.",
  "chat.piPlan.readySelect.implementFresh": "Empezar de cero e implementar",
  "chat.piPlan.readySelect.implementFreshDescription": "Abrir una sesión nueva vinculada y transferir solo el plan aprobado.",
  "chat.piPlan.readySelect.export": "Exportar plan…",
  "chat.piPlan.readySelect.save": "Guardar para más tarde",
  "chat.piPlan.readySelect.stay": "Seguir en modo Plan",
  "chat.piPlan.readySelect.exit": "Descartar el plan y salir",
  "chat.tool.planModeComplete": "Modo Plan completado",
  "chat.tool.planEnter": "Modo Plan",
  ...
  "chat.piGoal.dialog.objectivePlaceholder": "¿Qué debe lograr el agente?",
  "chat.piGoal.dialog.submit": "Iniciar",
  "chat.piGoal.dialog.cancel": "Cancelar",
  "chat.piGoal.dialog.exitPlan": "Salir de Plan",
  "chat.piGoal.dialog.aria": "Iniciar Goal",
  "chat.piGoal.error.empty": "Escribe un objetivo para iniciar Goal.",
  ...
  "chat.piGoal.error.planActive": "El modo Plan está activo. Sal de Plan antes de iniciar Goal.",
  ...
  "chat.messageBody.forkDialog.title": "Iniciar nueva sesión",
  ...
  "chat.messageBody.toast.planSavedWithPath": "Plan guardado en {path}",
  "chat.messageBody.toast.imageSaved": "Imagen guardada",
  "chat.messageBody.toast.generateImageFailed": "No se pudo generar la imagen",
  "chat.messageBody.toast.noImageToSave": "Este mensaje no tiene ninguna imagen para guardar.",
  ...
  "chat.chatInput.placeholder.chatPi": "@ para archivos/agentes; / para comandos y habilidades; # para snippets",
  "chat.chatInput.placeholder.chatCompact": "Usa @ / ! # para ayudas",
  "chat.chatInput.placeholder.chatCompactPi": "Usa @ / # para ayudas",
  ...
  "chat.chatInput.toast.unknownCommand": "Ese comando aún no está disponible.",
  "chat.chatInput.toast.commandFailed": "No se pudo ejecutar ese comando.",
  "chat.chatInput.pendingPromptHint": "Envía o descarta la tarjeta antes de mandar un mensaje.",
  ...
  "commandPalette.description": "Buscar sesiones, acciones y archivos.",
  "commandPalette.input.placeholder": "Buscar sesiones, acciones, archivos...",
  ...
  "saveProjectPlanDialog.description": "Guarda este plan como un archivo Markdown en la carpeta .pichamber/plans de este proyecto.",
  ...
  "projects.sharedTrust.description": "{path} en este repositorio define comandos que se ejecutan en esta máquina. Confía una vez y Pichamber solo volverá a preguntar cuando cambien.",
  ...
  "mcpDropdown.status.cached": "Listo, aún no conectado",
  "mcpDropdown.status.disabled": "Desactivado",
  ...
  "onboarding.localSetup.dialog.selectOpencodeBinary": "Seleccionar ejecutable de pi",
  ...
  "onboarding.localSetup.status.detected": "Pi encontrado en {path}",
  ...
  "onboarding.localSetup.windows.hintDetectionFailed": "Si la detección falla, establece una ruta nativa como ~/.local/bin/pi.",
  "onboarding.localSetup.hint.ensurePath": "¿Ya está instalado? Asegúrate de que pi esté en tu PATH.",
  "onboarding.localSetup.hint.setEnv": "O establece la variable de entorno PI_BINARY.",
  ...
  "updateDialog.actions.openGitHubRelease": "Abrir la versión de GitHub",
  "updateDialog.manualInstall.unsignedMac": "Esta compilación de Mac no puede instalar actualizaciones en la app. Abre la versión de GitHub y sustituye Pichamber.app por la del .dmg.",
  ...
  "piUpdate.toast.actions.dismiss": "Descartar",
  "piUpdate.toast.actions.ok": "Aceptar",
  ...
  'chat.workStatus.subagent.foreground': 'Primer plano',
  ...
  'chat.workStatus.subagent.paused': 'en pausa',
  'chat.workStatus.subagent.queued': 'en cola',
  'chat.workStatus.subagent.stopped': 'detenido',
  ...
  'chat.workStatus.subagent.namedForeground': '{name} · Primer plano',
  ...
  'chat.workStatus.subagent.summarizeAgain': 'Reenviar resultado a la sesión principal',
  'chat.workStatus.subagent.summarizeAgainHint': 'Los resultados se envían automáticamente al terminar un subagente en segundo plano. Úsalo solo si faltó la entrega.',
  'chat.workStatus.subagent.handoffMessage': 'Resultado del subagente «{name}» (usar como contexto):\n{body}',
  'chat.workStatus.subagent.handoffEmpty': 'El subagente «{name}» terminó sin un resultado de texto; abre su sesión para ver detalles.',
  ...
  'chat.workStatus.kimi.membership.free': 'Gratis',
  'chat.workStatus.kimi.membership.basic': 'Básico',
  'chat.workStatus.kimi.membership.intermediate': 'Intermedio',
  'chat.workStatus.kimi.membership.advanced': 'Avanzado',
  'chat.workStatus.kimi.membership.professional': 'Profesional',
  'chat.workStatus.kimi.membership.enterprise': 'Empresa',
