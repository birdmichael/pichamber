...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.openchamber.tools.field.agentControlToolInfo': '让智能体在聊天中编排你的工作：创建会话和 worktree、将提示委派给其他智能体、管理计划任务。会为每个会话添加少量工具说明。在 重新加载 Pi 后生效。',
  ...
  'settings.openchamber.tools.field.agentWebToolInfo': '让智能体在 Pichamber 浏览器面板中查看并操作页面：打开网址、读取内容、点击、输入、滚动，以及在移动端与桌面端布局之间切换。会为每个会话添加少量工具说明。在 重新加载 Pi 后生效。',
