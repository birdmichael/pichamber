...
export const settingsDict = {
  ...
  'settings.featurePlugins.field.command.info': 'Comando slash que ejecuta el botón Goal del compositor. El valor predeterminado es goal. Plan, MCP y Subagents no tienen comando de inicio aquí.',
