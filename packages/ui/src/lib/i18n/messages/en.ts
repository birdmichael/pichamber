...
export const dict = {
  ...
  'mobile.connect.scan.invalid': 'That QR code is not a Pichamber connection code.',
  ...
  'mobile.changes.diffDetail.missingDescription': 'Go back to Git and refresh the list.',
  'mobile.changes.diffDetail.imageUnavailable': 'Image diffs are not available in mobile Git yet.',
  ...
  'multirun.compare.title': 'Compare runs',
  'multirun.compare.subtitleSingle': '{count} run',
  'multirun.compare.subtitlePlural': '{count} runs',
  'multirun.compare.actions.openRun': 'Open',
  'multirun.compare.actions.close': 'Close',
  'multirun.compare.empty': 'No runs in this group yet.',
  'multirun.compare.run.loading': 'Loading this run…',
  'multirun.compare.run.empty': 'No messages yet.',
  'multirun.compare.run.missingDirectory': 'This run has no directory, so its transcript cannot load.',
  'multirun.compare.status.running': 'Running',
  'multirun.compare.status.idle': 'Idle',
  'multirun.compare.role.user': 'You',
  ...
  'multirun.launcher.actions.startWithRunCountSingle': 'Start ({count} run)',
  'multirun.launcher.actions.startWithRunCountPlural': 'Start ({count} runs)',
  ...
  'sessions.sidebar.footer.actions.refresh': 'Refresh',
  'sessions.sidebar.footer.refresh.tooltip': 'Reload sessions and the open transcript',
  'sessions.sidebar.footer.refresh.aria': 'Reload sessions and the open transcript',
  'sessions.sidebar.footer.refresh.disabledBusy': 'Refresh unavailable while the session is responding',
  'sessions.sidebar.footer.refresh.disabledCompacting': 'Refresh unavailable while compaction is running',
  'sessions.sidebar.footer.refresh.disabledInFlight': 'Refreshing sessions and the open transcript',
  'sessions.sidebar.footer.refresh.success': 'Reloaded sessions and the open transcript',
  'sessions.sidebar.footer.refresh.failed': 'Failed to reload sessions',
  ...
  'sessions.sidebar.session.menu.exportJsonl': 'Export JSONL',
  'sessions.sidebar.session.menu.exportHtml': 'Export HTML',
  'sessions.sidebar.header.actions.importSession': 'Import session',
  'sessions.sidebar.session.import.success': 'Session imported',
  'sessions.sidebar.session.import.failed': 'Failed to import session',
  'sessions.sidebar.session.export.failed': 'Failed to export session',
  ...
  'sessions.sidebar.session.moveToWorktree.confirm.ownership': 'Pichamber tracks these changes by directory, not by session.',
  ...
  'sessions.sidebar.session.menu.compareRuns': 'Compare runs',
  ...
  'sessions.sidebar.group.actions.compareRuns': 'Compare runs',
  'sessions.sidebar.group.actions.compareRunsAria': 'Compare runs in {label}',
  ...
  'gitView.changes.revertFileDescription': 'Revert local changes in {path}? This cannot be undone.',
  'gitView.changes.revertFile': 'Revert',
  ...
  'gitView.stashes.toast.localChangesOverwrite': 'Local changes would be overwritten ({paths}); commit or stash first',
  'gitView.stashes.toast.localChangesOverwriteWithMore': 'Local changes would be overwritten ({paths}, +{count} more); commit or stash first',
  ...
  'gitView.pullRequest.detachedHeadHint': 'Detached HEAD — create a branch first.',
  ...
  'walkthrough.blocked.noModel.title': 'No review model available',
  'walkthrough.blocked.noModel.description': 'Add a provider in ~/.pi/agent (auth.json + models.json) to generate a review.',
  ...
  'contextPanel.browser.hostAppBlocked': 'Cannot open the Pichamber app inside Browser.',
  ...
  'diffView.state.notGitRepository': 'Not a Git repository. Diffs are available when this folder is a Git repository.',
  ...
  'diffView.branch.empty': 'No committed changes on this branch relative to {base}',
  'diffView.branch.emptyExcludesWorkingTree': 'This view excludes the working tree. Uncommitted files stay in Changed.',
  ...
  'header.services.openWithCurrentPi': 'Switch Local or remote instance (current: {current})',
  'header.services.open': 'Open services, usage and MCP',
  'header.services.openPi': 'Open services',
  'header.services.openPiWithMcp': 'Open services and MCP',
  ...
  'chat.changedFiles.actions.showMore': 'Show {count} more',
  'chat.changedFiles.actions.collapse': 'Show less',
  ...
  'chat.promptNavigator.openTimeline': 'Session timeline',
  ...
  'chat.timeline.title': 'Session timeline',
  ...
  'chat.commandAutocomplete.command.timelineDescription': 'Open the session timeline',
  ...
  'chat.commandAutocomplete.keyboardHintEmpty': 'Esc close',
  ...
  'chat.fileMentionAutocomplete.empty': 'No files or agents found',
  ...
  'chat.piExtensionUi.inputNeeded': 'Input needed',
  'chat.piExtensionUi.selectMultiple': 'Select multiple',
  'chat.piExtensionUi.other': 'Other…',
  'chat.piExtensionUi.yourAnswer': 'Your answer',
  'chat.piExtensionUi.submit': 'Submit',
  'chat.piExtensionUi.dismiss': 'Dismiss',
  'chat.piExtensionUi.confirm': 'Confirm',
  'chat.piExtensionUi.cancel': 'Cancel',
  'chat.piExtensionUi.submitFailed': 'Failed to send response',
  'chat.piExtensionUi.dismissFailed': 'Failed to dismiss question',
  'chat.piExtensionUi.noLongerPending': 'This question is no longer waiting for a response.',
  'chat.piExtensionUi.tryAgain': 'Please try again in a moment.',
  'chat.piExtensionUi.answered': 'Answered',
  'chat.piExtensionUi.cancelled': 'Cancelled',
  'chat.piExtensionUi.questionFallback': 'Question',
  'chat.piExtensionUi.confirmAria': 'Extension confirmation',
  'chat.piExtensionUi.chooseOption': 'Pick an option to enable Submit.',
  'chat.piPlan.agent': 'Agent',
  'chat.piPlan.plan': 'Plan',
  'chat.piPlan.toggleAria': 'Agent or Plan mode',
  'chat.piPlan.build': 'Build',
  'chat.piPlan.building': 'Building…',
  'chat.piPlan.buildModelAria': 'Model for Build',
  'chat.piPlan.actionFailed': 'Could not switch to Plan. Reload the session and try again.',
  'chat.piPlan.buildFailed': 'Could not start Build',
  'chat.piPlan.discard': 'Discard',
  'chat.piPlan.discardFailed': 'Could not discard the plan',
  'chat.piPlan.discardConfirmTitle': 'Discard this plan?',
  'chat.piPlan.discardConfirmDescription': 'This clears the ready or saved plan from the session.',
  'chat.piPlan.discardConfirm': 'Discard',
  ...
  'chat.piPlan.readySelect.implementFreshDescription': 'Open a new linked session; transfer only the approved plan.',
  'chat.piPlan.readySelect.export': 'Export plan…',
  'chat.piPlan.readySelect.save': 'Save for later',
  'chat.piPlan.readySelect.stay': 'Stay in Plan mode',
  'chat.piPlan.readySelect.exit': 'Discard plan and exit',
  'chat.tool.planModeComplete': 'Plan mode complete',
  'chat.tool.planEnter': 'Plan Mode',
  'chat.tool.planExit': 'Build Mode',
  'chat.piGoal.button': 'Goal',
  'chat.piGoal.buttonAria': 'Start Goal',
  'chat.piGoal.dialog.title': 'Start Goal',
  'chat.piGoal.dialog.objectiveLabel': 'Objective',
  'chat.piGoal.dialog.objectivePlaceholder': 'What should the agent accomplish?',
  'chat.piGoal.dialog.submit': 'Start',
  'chat.piGoal.dialog.cancel': 'Cancel',
  'chat.piGoal.dialog.exitPlan': 'Exit Plan',
  'chat.piGoal.dialog.aria': 'Start Goal',
  ...
  'chat.piGoal.error.planActive': 'Plan mode is active. Exit Plan before starting a Goal.',
  ...
  'chat.messageBody.forkDialog.title': 'Start new session',
  ...
  'chat.messageBody.toast.planSavedWithPath': 'Plan saved to {path}',
  'chat.messageBody.toast.imageSaved': 'Image saved',
  'chat.messageBody.toast.generateImageFailed': 'Failed to generate image',
  'chat.messageBody.toast.noImageToSave': 'This message has no image to save.',
  ...
  'chat.chatInput.placeholder.chatPi': '@ for files/agents; / for commands and skills; # for snippets',
  'chat.chatInput.placeholder.chatCompact': 'Use @ / ! # for helpers',
  'chat.chatInput.placeholder.chatCompactPi': 'Use @ / # for helpers',
  ...
  'chat.dictation.unsupported': 'Dictation is not supported in this environment',
  'chat.dictation.disabled': 'Dictation is turned off in Settings',
  'chat.dictation.microphonePermissionDenied': 'Microphone permission denied',
  'chat.dictation.microphoneNotFound': 'No microphone found',
  'chat.dictation.microphoneUnavailable': 'Unable to access the microphone',
  'chat.dictation.startFailed': 'Could not start dictation',
  ...
  'chat.chatInput.toast.unknownCommand': 'That command is not available yet.',
  'chat.chatInput.toast.commandFailed': 'Could not run that command.',
  'chat.chatInput.pendingPromptHint': 'Submit or dismiss the card before sending.',
  ...
  'chat.agentRoster.tools': 'Tools / capabilities (comma separated)',
  ...
  'commandPalette.description': 'Search sessions, actions, and files.',
  'commandPalette.input.placeholder': 'Search sessions, actions, files...',
  ...
  'saveProjectPlanDialog.description': "Save this plan as a Markdown file in this project's .pichamber/plans folder.",
  ...
  'projects.sharedTrust.description': '{path} in this repository defines commands that run on this machine. Trust them once, and Pichamber asks again only when they change.',
  ...
  'mcpDropdown.status.cached': 'Ready, not connected yet',
  ...
  'onboarding.localSetup.description': 'Install Pi to continue.',
  'onboarding.localSetup.dialog.selectOpencodeBinary': 'Select pi binary',
  'onboarding.localSetup.errors.cliNotReady': 'Pi is not ready yet. Please confirm installation is complete and try again.',
  ...
  'onboarding.localSetup.windows.hintDetectionFailed': 'If detection fails, set a native path such as ~/.local/bin/pi.',
  'onboarding.localSetup.hint.ensurePath': 'Already installed? Make sure pi is in your PATH.',
  'onboarding.localSetup.hint.setEnv': 'Or set PI_BINARY environment variable.',
  ...
  'onboarding.remoteConnection.description': 'Enter the address of a Pichamber server to connect to.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'Suggestions: Verify the URL points to a Pichamber server, or contact the server administrator.',
  ...
  'onboarding.remoteConnection.probe.wrongServiceMessage': 'Server responded but is not running Pichamber. Verify the address points to a Pichamber server.',
  ...
  'onboarding.desktopRecovery.localUnavailable.description': 'The in-process Pi kernel could not be started. Check ~/.pi/agent or connect to a remote server instead.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': 'The server at "{host}" is not running Pichamber. Verify the address points to a Pichamber server.',
  ...
  'chat.workStatus.subagent.foreground': 'Foreground',
  'chat.workStatus.subagent.background': 'Background',
  ...
  'chat.workStatus.action.openSubagentOwned': 'Open {name} (part of {parent})',
  ...
  'chat.workStatus.subagent.summarizeAgain': 'Resend result to parent',
  'chat.workStatus.subagent.summarizeAgainHint': 'Results post automatically when a background subagent finishes. Use this only if a handoff was missed.',
  'chat.workStatus.subagent.handoffMessage': 'Subagent "{name}" result (use as context):\n{body}',
  'chat.workStatus.subagent.handoffEmpty': 'Subagent "{name}" finished without a text result; open its session for details.',
  ...
  'chat.workStatus.kimi.membership.free': 'Free',
  'chat.workStatus.kimi.membership.basic': 'Basic',
  'chat.workStatus.kimi.membership.intermediate': 'Intermediate',
  'chat.workStatus.kimi.membership.advanced': 'Advanced',
