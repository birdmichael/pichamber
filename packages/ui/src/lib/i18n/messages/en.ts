...
export const dict = {
  ...
  'chat.piPlan.actionFailed': 'Could not switch Agent or Plan',
  ...
  'chat.piGoal.error.missingCommand': '/{command} is not available on this session.',
  ...
  'piUpdate.toast.available.title': 'Only a newer Pichamber includes Pi {version}',
