...
export const settingsDict = {
  ...
  'settings.featurePlugins.slot.goal.info': 'Instaluje pakiet Goal. Włącz go, aby pokazać przycisk Goal w kompozytorze. Ta strona nigdy nie instaluje automatycznie.',
  'settings.featurePlugins.slot.plan.title': 'Plan',
  'settings.featurePlugins.slot.plan.info': 'Instaluje pakiet Plan. Włączenie jest na później, pod Agent/Plan, Widok planu i Build. Ta strona nie uruchamia /plan.',
  'settings.featurePlugins.slot.mcp.title': 'MCP',
  'settings.featurePlugins.slot.mcp.info': 'Instaluje adapter MCP. Włączenie jest na później, pod MCP w Work Status i Ustawienia → MCP. Ta strona nie uruchamia /mcp.',
  'settings.featurePlugins.slot.subagents.title': 'Subagents',
  'settings.featurePlugins.slot.subagents.info': 'Instaluje pakiet Subagents. Włączenie jest na później, pod Work Status i zapisywalne sesje potomne. Ta strona nie uruchamia /subagents-fleet.',
  'settings.featurePlugins.enabled.label': 'Włączone',
  'settings.featurePlugins.enabled.info': 'Zostawia pakiet zainstalowany, ale ukrywa późniejsze sterowanie pulpitu dla tego gniazda.',
  ...
  'settings.featurePlugins.dialog.uninstall.description': 'To usunie pakiet z pakietów Pi. Ustawienie włączenia/wyłączenia zostanie zachowane.',
