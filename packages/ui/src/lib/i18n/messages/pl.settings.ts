...
export const settingsDict = {
  ...
  'settings.featurePlugins.slot.kimi.region.label': 'Region API Kimi',
  'settings.featurePlugins.slot.kimi.region.info': 'Wybiera host zgodny z Moonshot dla klucza API Kimi. Międzynarodowy to api.moonshot.ai, Chiny to api.moonshot.cn. Nie wpisujesz adresu URL.',
  ...
  'settings.featurePlugins.slot.kimi.region.aria': 'Region API Kimi',
