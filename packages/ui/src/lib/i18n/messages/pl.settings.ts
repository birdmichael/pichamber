...
export const settingsDict = {
  ...
  'settings.featurePlugins.field.source': 'Źródło',
  'settings.featurePlugins.field.source.info': 'npm, git albo ścieżka lokalna. Chipy predefiniowane tylko wypełniają to pole. Nie instalują pakietu.',
  'settings.featurePlugins.field.source.placeholder': 'npm:pakiet, git:… albo ścieżka lokalna',
  'settings.featurePlugins.field.source.aria': 'Źródło {slot}',
  'settings.featurePlugins.field.command': 'Polecenie startu',
  'settings.featurePlugins.field.command.info': 'Polecenie slash uruchamiane przez przycisk Goal w kompozytorze. Domyślnie goal. Plan, MCP i Subagents nie mają tu polecenia startu.',
  'settings.featurePlugins.field.command.placeholder': 'goal',
  'settings.featurePlugins.field.command.aria': 'Polecenie startu Goal',
  'settings.featurePlugins.presets.aria': 'Predefiniowane źródła {slot}',
  ...
  'settings.featurePlugins.status.installed': 'Zainstalowane w pakietach Pi.',
  'settings.featurePlugins.status.notInstalled': 'Nie zainstalowano. Otwarcie tej strony nigdy nie instaluje pakietu.',
  ...
  'settings.providers.page.auth.apiKeyTooltip': 'Klucze są wysyłane bezpośrednio do OpenCode i nigdy nie są przechowywane przez Pichamber.',
  ...
  'settings.providers.page.custom.field.apiKey.info': 'Przechowywany w auth OpenCode, nie przez Pichamber. Użyj {env:VAR_NAME}, aby odczytać klucz ze zmiennej środowiskowej.',
