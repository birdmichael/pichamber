...
export const settingsDict = {
  ...
  'settings.providers.page.empty.checkOpenCodeConfiguration': 'Sprawdź ~/.pi/agent/models.json i auth.json',
  ...
  'settings.providers.sidebar.empty.description': 'Sprawdź ~/.pi/agent/models.json i auth.json',
