...
export const settingsDict = {
  ...
  'settings.featurePlugins.slot.goal.info': 'Instaluje pakiet Goal. Włączenie jest na później, pod sterowanie Goal na pulpicie. Ta strona nie dodaje przycisku Goal w kompozytorze.',
  ...
  'settings.featurePlugins.field.command.info': 'Polecenie slash, które później uruchomi Goal. Domyślnie goal. Plan, MCP i Subagents nie mają tu polecenia startu.',
