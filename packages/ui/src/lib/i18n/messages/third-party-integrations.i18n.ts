...
export const thirdPartyIntegrationI18n = {
  en: {
    ...
    'settings.integrations.messengers.discord.description': 'Connect a Discord bot to chat with Pichamber.',
    'settings.integrations.messengers.telegram.name': 'Telegram',
    'settings.integrations.messengers.telegram.description': 'Connect a Telegram bot to chat with Pichamber.',
    ...
    'settings.integrations.thirdParty.status.restartRequired': 'Reload Pi before setting up this provider.',
    'settings.integrations.thirdParty.status.registryUnavailable': 'Could not check npm right now.',
    'settings.integrations.thirdParty.status.providerUnavailable': 'The provider is not available yet. Reload Pi and try again.',
    ...
    'settings.integrations.thirdParty.toast.restartRequired': 'Reload Pi for changes to take effect',
  ...
  de: {
    ...
    'settings.integrations.messengers.discord.name': 'Discord',
    'settings.integrations.messengers.discord.description': 'Verbinde einen Discord-Bot, um mit Pichamber zu chatten.',
    'settings.integrations.messengers.telegram.name': 'Telegram',
    'settings.integrations.messengers.telegram.description': 'Verbinde einen Telegram-Bot, um mit Pichamber zu chatten.',
  ...
  fr: {
    ...
    'settings.integrations.messengers.discord.name': 'Discord',
    'settings.integrations.messengers.discord.description': 'Connectez un bot Discord pour discuter avec Pichamber.',
    'settings.integrations.messengers.telegram.name': 'Telegram',
    'settings.integrations.messengers.telegram.description': 'Connectez un bot Telegram pour discuter avec Pichamber.',
    'settings.integrations.thirdParty.title': 'Intégrations tierces',
    'settings.integrations.thirdParty.info': 'Installez un plugin de fournisseur, puis configurez votre abonnement pour que Pichamber puisse l’utiliser.',
    ...
    'settings.integrations.thirdParty.dialog.remove.description': 'Supprimer {name} de votre configuration Pi globale ? Le fournisseur ne sera plus chargé après l’actualisation de Pi.',
  ...
  es: {
    ...
    'settings.integrations.messengers.discord.name': 'Discord',
    'settings.integrations.messengers.discord.description': 'Conecta un bot de Discord para chatear con Pichamber.',
    'settings.integrations.messengers.telegram.name': 'Telegram',
    'settings.integrations.messengers.telegram.description': 'Conecta un bot de Telegram para chatear con Pichamber.',
  ...
  ja: {
    ...
    'settings.integrations.messengers.discord.name': 'Discord',
    'settings.integrations.messengers.discord.description': 'Discord ボットを接続して Pichamber とチャットします。',
    'settings.integrations.messengers.telegram.name': 'Telegram',
    'settings.integrations.messengers.telegram.description': 'Telegram ボットを接続して Pichamber とチャットします。',
  ...
  ko: {
    ...
    'settings.integrations.messengers.discord.name': 'Discord',
    'settings.integrations.messengers.discord.description': 'Discord 봇을 연결해 Pichamber와 채팅하세요.',
    'settings.integrations.messengers.telegram.name': 'Telegram',
    'settings.integrations.messengers.telegram.description': 'Telegram 봇을 연결해 Pichamber와 채팅하세요.',
  ...
  pl: {
    ...
    'settings.integrations.messengers.discord.name': 'Discord',
    'settings.integrations.messengers.discord.description': 'Połącz bota Discord, aby czatować z Pichamber.',
    'settings.integrations.messengers.telegram.name': 'Telegram',
    'settings.integrations.messengers.telegram.description': 'Połącz bota Telegram, aby czatować z Pichamber.',
  ...
  'pt-BR': {
    ...
    'settings.integrations.messengers.discord.name': 'Discord',
    'settings.integrations.messengers.discord.description': 'Conecte um bot do Discord para conversar com o Pichamber.',
    'settings.integrations.messengers.telegram.name': 'Telegram',
    'settings.integrations.messengers.telegram.description': 'Conecte um bot do Telegram para conversar com o Pichamber.',
  ...
  uk: {
    ...
    'settings.integrations.messengers.discord.name': 'Discord',
    'settings.integrations.messengers.discord.description': 'Підключіть бота Discord, щоб спілкуватися з Pichamber.',
    'settings.integrations.messengers.telegram.name': 'Telegram',
    'settings.integrations.messengers.telegram.description': 'Підключіть бота Telegram, щоб спілкуватися з Pichamber.',
  ...
  'zh-CN': {
    ...
    'settings.integrations.messengers.discord.name': 'Discord',
    'settings.integrations.messengers.discord.description': '连接 Discord 机器人以与 Pichamber 聊天。',
    'settings.integrations.messengers.telegram.name': 'Telegram',
    'settings.integrations.messengers.telegram.description': '连接 Telegram 机器人以与 Pichamber 聊天。',
  ...
  'zh-TW': {
    ...
    'settings.integrations.messengers.discord.name': 'Discord',
    'settings.integrations.messengers.discord.description': '連接 Discord 機器人以與 Pichamber 聊天。',
    'settings.integrations.messengers.telegram.name': 'Telegram',
    'settings.integrations.messengers.telegram.description': '連接 Telegram 機器人以與 Pichamber 聊天。',
  ...
  tr: {
    ...
    'settings.page.integrations.description': 'Pichamber sağlayıcısı olarak kullanmak için üçüncü taraf abonelikler ekleyin.',
    'settings.page.integrations.descriptionPi': 'Sohbet habercileri henüz kullanılamıyor.',
    'settings.integrations.messengers.title': 'Haberciler',
    'settings.integrations.messengers.info': 'Discord veya Telegram üzerinden Pichamber ile sohbet edin. Bu köprüler henüz kullanılamıyor.',
    'settings.integrations.messengers.discord.name': 'Discord',
    'settings.integrations.messengers.discord.description': 'Pichamber ile sohbet etmek için bir Discord botu bağlayın.',
    'settings.integrations.messengers.telegram.name': 'Telegram',
    'settings.integrations.messengers.telegram.description': 'Pichamber ile sohbet etmek için bir Telegram botu bağlayın.',
    'settings.integrations.thirdParty.title': 'Üçüncü taraf entegrasyonlar',
    'settings.integrations.thirdParty.info': 'Bir sağlayıcı eklentisi kurun, ardından aboneliğinizi ayarlayın ki Pichamber onu kullanabilsin.',
    ...
    'settings.integrations.thirdParty.status.unpinned': 'En son sürüme uyuluyor',
    ...
    'settings.integrations.thirdParty.status.restartRequired': 'Bu sağlayıcıyı ayarlamadan önce Pi’yi yeniden yükleyin.',
    'settings.integrations.thirdParty.status.registryUnavailable': 'npm şu anda denetlenemedi.',
    'settings.integrations.thirdParty.status.providerUnavailable': 'Sağlayıcı henüz kullanılamıyor. Pi’yi yeniden yükleyip tekrar deneyin.',
    'settings.integrations.thirdParty.dialog.remove.title': 'Entegrasyonu kaldır',
    'settings.integrations.thirdParty.dialog.remove.description': '{name}, kullanıcı genelindeki Pi yapılandırmanızdan kaldırılsın mı? Pi yenilendikten sonra sağlayıcı artık yüklenmeyecek.',
    ...
    'settings.integrations.thirdParty.toast.providerUnavailable': 'Sağlayıcı henüz açılamadı',
    'settings.integrations.thirdParty.toast.restartRequired': 'Değişikliklerin geçerli olması için Pi’yi yeniden yükleyin',
    'settings.integrations.thirdParty.opencodeClaude.name': 'Claude Code',
    ...
    'settings.integrations.thirdParty.opencodeCommandcode.name': 'Command Code',
    'settings.integrations.thirdParty.opencodeCommandcode.description': '1$ Go Plan: sınırsız Laguna S 2.1 + 40$ DeepSeek V4 Pro. Giriş yapın, CLI yok.',
    'settings.integrations.thirdParty.opencodeCursorOauth.name': 'Cursor',
    'settings.integrations.thirdParty.opencodeCursorOauth.description': 'Cursor’ın cömert kendi model limitleri artık Pichamber’da.',
  },
} as const;
