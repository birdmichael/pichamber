...
export const SETTINGS_REGISTRY = {
  ...
  piAgentDir: field({ scope: 'instance', parse: parseTrimmedString }),
  piAgentDirResolved: field({ scope: 'instance', computed: true, parse: parseTrimmedString }),
  ...
  expandedEditorToolbar: field({ scope: 'profile', parse: parseBoolean, ui: uiStore('expandedEditorToolbar', (v) => useUIStore.getState().setExpandedEditorToolbar(v)) }),
