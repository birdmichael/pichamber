  ...
  const fileViewer = (
    ...
    >
      ...
      <div className="relative flex min-h-0 min-w-0 flex-1 flex-col">
        ...
        <ScrollableOverlay ref={setMainPreviewScroller} outerClassName="h-full min-h-0 min-w-0 flex-1" className={cn('h-full min-w-0', isLargeFile && '[overflow-anchor:none]')}>
          {!selectedFile ? (
