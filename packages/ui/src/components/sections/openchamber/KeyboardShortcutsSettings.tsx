...
const CATEGORY_TITLE_KEYS: Record<ShortcutCategory, I18nKey> = {
  session: 'settings.openchamber.keyboardShortcuts.category.session',
  models: 'settings.openchamber.keyboardShortcuts.category.models',
  panels: 'settings.openchamber.keyboardShortcuts.category.panels',
  navigation: 'settings.openchamber.keyboardShortcuts.category.navigation',
  application: 'settings.openchamber.keyboardShortcuts.category.application',
};
