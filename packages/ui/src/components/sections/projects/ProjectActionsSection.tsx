                ...
                <div className="flex items-start gap-2">
                  ...
                  {action.name.trim() && action.command.trim() ? (
                    <Button
                      ...
                      title={hasChanges ? t('settings.projects.shared.actions.shareAfterSave') : t('settings.projects.shared.actions.shareTitle', { path: sharedState?.path ?? '.pichamber/project.json' })}
