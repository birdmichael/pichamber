...
// Quiet one-paragraph recap of the agent's last reply. It sits in the reserved
// band under the transcript and simply vanishes in place once a new message
// makes it stale (no scroll jump). Appears only after the quiet window.
