...
//
// `PICHAMBER_DATA_DIR (or OPENCHAMBER_DATA_DIR)` is documented as "the Pichamber data directory",
...
// `~/.config/pichamber`. Now every folder hangs off the data directory, so an
