...
| Recaps disappear without jump | **DEFER** | | |
...
| Session tab title fade on hover | **DEFER** | Cosmetic | |
...
| Ctrl+N/P model lists | **DEFER** | | |
| Send-shortcut / large-paste copy | **DEFER** | | |
| Chat typography/spacing polish | SKIP | fights layout with glass overhaul | |
| Selection highlight unify | **DEFER** | | |
