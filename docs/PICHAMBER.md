...
- Native OpenCode plugins, MCP OAuth, LSP diagnostics, permission/question dialogs, share, revert, Scheduled Tasks, and the managed OpenCode upgrade/binary resolver
