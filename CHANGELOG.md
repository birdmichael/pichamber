...
- Desktop: browser tabs and address history follow the current project. All Chats share one browser, separate from every Settings project. Sign-in cookies stay shared.
