...
- Chat: a parent user bubble beside Work Status and a child tab wraps in the column instead of collapsing to a one-line ellipsis. Composer model and Agent chips ellipsize the label or hide the least important chip instead of clipping mid-glyph (`grok-4.(`, a bare `A`).
