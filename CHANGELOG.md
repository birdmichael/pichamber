...
- **Desktop:** the sidebar Settings gear opens on the first click. Opening on pointerdown mounted the dialog before mouseup, so Base UI treated the same press as an outside dismiss.
