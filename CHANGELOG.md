...
- **Mobile:** Git now opens the same Pull Request and Diff views as Desktop. Walkthrough is available from those views on tablet-width screens (768px and up). The Electron Browser session is not on mobile.
