...
- **Mobile:** when an agent asks a question, the phone is notified even if Desktop is still open. Tapping the notification opens that chat on the waiting card. On iPhone, Confirm prompts unlock the phone and open the app to answer. Locking the Mac no longer hides waiting-question or finished-session alerts.
