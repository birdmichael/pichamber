...
- Sessions: Scheduled Tasks is hidden on the Pi kernel — the sidebar calendar button, the task manager page, and `/schedule-task` no longer appear. The OpenCode kernel still has the feature.
