...
OpenCode-only surfaces (Usage, MCP, Plugins, Session Goals, the OpenCode CLI) are hidden on the Pi kernel. Scheduled Tasks and Multi-run stay available on Pi.
