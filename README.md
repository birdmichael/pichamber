...
This is a new product line on a fork of OpenChamber. Versioning started at **1.0.0** and is independent of OpenChamber. The current release is **1.2.15**. The kernel is in-process Pi (`@earendil-works/pi-coding-agent`), not an OpenCode child process.
...
| Ref | Role |
| --- | --- |
| [`main`](https://github.com/birdmichael/pichamber) | Pi kernel mainline, Pichamber **1.2.15** |
